...
/**
 * CalcPrazoRestricao.java This file was auto-generated from WSDL by the Apache
...
/**
 * CalcPrazoRestricao bean class
 */
@SuppressWarnings({"unchecked", "unused", "serial", "rawtypes"})

public class CalcPrazoRestricao implements org.apache.axis2.databinding.ADBBean
{
		...
		if (serializeType)
		{
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0))
			{
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
						"type", namespacePrefix + ":CalcPrazoRestricao", xmlWriter);
			}
			else
			{
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
						"type", "CalcPrazoRestricao", xmlWriter);
			}
	...
	public static class Factory
	{
		 ...
		 * outer element
		 */
		public static CalcPrazoRestricao parse(
				javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception
		{
			CalcPrazoRestricao object = new CalcPrazoRestricao();
						...
						"http://www.w3.org/2001/XMLSchema-instance", "type") != null)
				{
					...
					if (fullTypeName != null)
					{
						...
						if (!"CalcPrazoRestricao".equals(type))
						{
							...
							return (CalcPrazoRestricao) org.tempuri.ExtensionMapper
