...
/**
 * CalcPrecoPrazoData.java This file was auto-generated from WSDL by the Apache
...
/**
 * CalcPrecoPrazoData bean class
 */
@SuppressWarnings({"unchecked", "unused", "serial", "rawtypes"})

public class CalcPrecoPrazoData implements org.apache.axis2.databinding.ADBBean
{
		...
		if (serializeType)
		{
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0))
			{
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
						"type", namespacePrefix + ":CalcPrecoPrazoData", xmlWriter);
			}
			else
			{
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
						"type", "CalcPrecoPrazoData", xmlWriter);
			}
	...
	public static class Factory
	{
		 ...
		 * outer element
		 */
		public static CalcPrecoPrazoData parse(
				javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception
		{
			CalcPrecoPrazoData object = new CalcPrecoPrazoData();
						...
						"http://www.w3.org/2001/XMLSchema-instance", "type") != null)
				{
					...
					if (fullTypeName != null)
					{
						...
						if (!"CalcPrecoPrazoData".equals(type))
						{
							...
							return (CalcPrecoPrazoData) org.tempuri.ExtensionMapper
