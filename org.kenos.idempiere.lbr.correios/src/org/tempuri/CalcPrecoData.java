...
/**
 * CalcPrecoData.java This file was auto-generated from WSDL by the Apache Axis2
...
/**
 * CalcPrecoData bean class
 */
@SuppressWarnings({"unchecked", "unused", "serial", "rawtypes"})

public class CalcPrecoData implements org.apache.axis2.databinding.ADBBean
{
		...
		if (serializeType)
		{
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0))
			{
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
						"type", namespacePrefix + ":CalcPrecoData", xmlWriter);
			}
			else
			{
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
						"type", "CalcPrecoData", xmlWriter);
			}
	...
	public static class Factory
	{
		 ...
		 * outer element
		 */
		public static CalcPrecoData parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception
		{
			CalcPrecoData object = new CalcPrecoData();
						...
						"http://www.w3.org/2001/XMLSchema-instance", "type") != null)
				{
					...
					if (fullTypeName != null)
					{
						...
						if (!"CalcPrecoData".equals(type))
						{
							...
							return (CalcPrecoData) org.tempuri.ExtensionMapper
