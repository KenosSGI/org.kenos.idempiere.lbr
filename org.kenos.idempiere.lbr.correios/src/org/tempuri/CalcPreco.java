...
/**
 * CalcPreco.java This file was auto-generated from WSDL by the Apache Axis2
...
/**
 * CalcPreco bean class
 */
@SuppressWarnings({"unchecked", "unused", "serial", "rawtypes"})

public class CalcPreco implements org.apache.axis2.databinding.ADBBean
{
		...
		if (serializeType)
		{
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0))
			{
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
						"type", namespacePrefix + ":CalcPreco", xmlWriter);
			}
			else
			{
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
						"type", "CalcPreco", xmlWriter);
			}
	...
	public static class Factory
	{
		 ...
		 * outer element
		 */
		public static CalcPreco parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception
		{
			CalcPreco object = new CalcPreco();
						...
						"http://www.w3.org/2001/XMLSchema-instance", "type") != null)
				{
					...
					if (fullTypeName != null)
					{
						...
						if (!"CalcPreco".equals(type))
						{
							...
							return (CalcPreco) org.tempuri.ExtensionMapper
