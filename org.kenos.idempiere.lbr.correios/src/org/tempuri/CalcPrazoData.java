...
/**
 * CalcPrazoData.java This file was auto-generated from WSDL by the Apache Axis2
...
/**
 * CalcPrazoData bean class
 */
@SuppressWarnings({"unchecked", "unused", "serial", "rawtypes"})

public class CalcPrazoData implements org.apache.axis2.databinding.ADBBean
{
		...
		if (serializeType)
		{
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0))
			{
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
						"type", namespacePrefix + ":CalcPrazoData", xmlWriter);
			}
			else
			{
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
						"type", "CalcPrazoData", xmlWriter);
			}
	...
	public static class Factory
	{
		 ...
		 * outer element
		 */
		public static CalcPrazoData parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception
		{
			CalcPrazoData object = new CalcPrazoData();
						...
						"http://www.w3.org/2001/XMLSchema-instance", "type") != null)
				{
					...
					if (fullTypeName != null)
					{
						...
						if (!"CalcPrazoData".equals(type))
						{
							...
							return (CalcPrazoData) org.tempuri.ExtensionMapper
