...
/**
 * CalcPrazoObjeto.java This file was auto-generated from WSDL by the Apache
...
/**
 * CalcPrazoObjeto bean class
 */
@SuppressWarnings({"unchecked", "unused", "serial", "rawtypes"})

public class CalcPrazoObjeto implements org.apache.axis2.databinding.ADBBean
{
		...
		if (serializeType)
		{
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0))
			{
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
						"type", namespacePrefix + ":CalcPrazoObjeto", xmlWriter);
			}
			else
			{
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
						"type", "CalcPrazoObjeto", xmlWriter);
			}
		...
		if (localCodigoObjetoTracker)
		{
			...
			if (localCodigoObjeto != null)
			{
				elementList.add(org.apache.axis2.databinding.utils.ConverterUtil
						.convertToString(localCodigoObjeto));
			}
			else
			{
				throw new org.apache.axis2.databinding.ADBException(
	...
	public static class Factory
	{
		 ...
		 * outer element
		 */
		public static CalcPrazoObjeto parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception
		{
			CalcPrazoObjeto object = new CalcPrazoObjeto();
			...
			try
			{
						...
						"http://www.w3.org/2001/XMLSchema-instance", "type") != null)
				{
					...
					if (fullTypeName != null)
					{
						...
						if (!"CalcPrazoObjeto".equals(type))
						{
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext()
									.getNamespaceURI(nsPrefix);
							return (CalcPrazoObjeto) org.tempuri.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://tempuri.org/",
								"codigoObjeto").equals(reader.getName()))
				{
