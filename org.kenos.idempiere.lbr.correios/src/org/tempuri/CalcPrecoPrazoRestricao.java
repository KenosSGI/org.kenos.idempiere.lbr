...
/**
 * CalcPrecoPrazoRestricao.java This file was auto-generated from WSDL by the
...
/**
 * CalcPrecoPrazoRestricao bean class
 */
@SuppressWarnings({"unchecked", "unused", "serial", "rawtypes"})

public class CalcPrecoPrazoRestricao implements org.apache.axis2.databinding.ADBBean
{
		...
		if (serializeType)
		{
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0))
			{
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
						"type", namespacePrefix + ":CalcPrecoPrazoRestricao",
						xmlWriter);
			}
			else
			{
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
						"type", "CalcPrecoPrazoRestricao", xmlWriter);
			}
			...
			throws org.apache.axis2.databinding.ADBException
	{
		...
		if (localSDtCalculoTracker)
		{
			...
			{
				elementList.add(org.apache.axis2.databinding.utils.ConverterUtil
						.convertToString(localSDtCalculo));
			}
			else
			{
				throw new org.apache.axis2.databinding.ADBException(
	...
	public static class Factory
	{
		 ...
		 * outer element
		 */
		public static CalcPrecoPrazoRestricao parse(
				javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception
		{
			CalcPrecoPrazoRestricao object = new CalcPrecoPrazoRestricao();
			...
			try
			{
						...
						"http://www.w3.org/2001/XMLSchema-instance", "type") != null)
				{
					...
					if (fullTypeName != null)
					{
						...
						if (!"CalcPrecoPrazoRestricao".equals(type))
						{
							...
							return (CalcPrecoPrazoRestricao) org.tempuri.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://tempuri.org/",
								"sDtCalculo").equals(reader.getName()))
				{
					...
					{
						throw new org.apache.axis2.databinding.ADBException(
								"The element: " + "sDtCalculo" + "  cannot be null");
					}
