...
/**
 * CalcPrecoFAC.java This file was auto-generated from WSDL by the Apache Axis2
...
/**
 * CalcPrecoFAC bean class
 */
@SuppressWarnings({"unchecked", "unused", "serial", "rawtypes"})

public class CalcPrecoFAC implements org.apache.axis2.databinding.ADBBean
{
		...
		if (serializeType)
		{
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0))
			{
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
						"type", namespacePrefix + ":CalcPrecoFAC", xmlWriter);
			}
			else
			{
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
						"type", "CalcPrecoFAC", xmlWriter);
			}
			...
			throws org.apache.axis2.databinding.ADBException
	{
		...
		if (localStrDataCalculoTracker)
		{
			...
			{
				elementList.add(org.apache.axis2.databinding.utils.ConverterUtil
						.convertToString(localStrDataCalculo));
			}
			else
			{
				throw new org.apache.axis2.databinding.ADBException(
	...
	public static class Factory
	{
		 ...
		 * outer element
		 */
		public static CalcPrecoFAC parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception
		{
			CalcPrecoFAC object = new CalcPrecoFAC();
			...
			try
			{
						...
						"http://www.w3.org/2001/XMLSchema-instance", "type") != null)
				{
					...
					if (fullTypeName != null)
					{
						...
						if (!"CalcPrecoFAC".equals(type))
						{
							...
							return (CalcPrecoFAC) org.tempuri.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://tempuri.org/",
								"strDataCalculo").equals(reader.getName()))
				{
