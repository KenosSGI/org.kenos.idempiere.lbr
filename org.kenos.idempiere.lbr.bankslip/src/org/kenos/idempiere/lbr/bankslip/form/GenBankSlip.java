 ...
 */
public class GenBankSlip
{
	/**	Forms				*/
	public static final String GEN_BANKSLIP_SWING 	= "org.adempierelbr.apps.form.VGenBilling";
	public static final String GEN_BANKSLIP_ZK 		= "org.adempierelbr.apps.form.WGenBilling";
	...
	/**	Logger					*/
	public static CLogger log = CLogger.getCLogger(GenBankSlip.class);
