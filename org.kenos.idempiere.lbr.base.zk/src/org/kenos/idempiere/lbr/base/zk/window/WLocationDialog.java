...
public class WLocationDialog extends Window implements EventListener<Event>
{
	...
	private void initComponents()
	{
		...
		btnGetAddress = new Button("Pesquisar CEP");
		LayoutUtils.addSclass("txt-btn", btnGetAddress);
	...
	private void init()
	{
		...
		pnlLinks.appendChild(btnGetAddress);
	...
	private void initLocation()
	{
		...
		if (m_location.getC_Country_ID() == 139)
			btnGetAddress.setVisible(true);
		else
			btnGetAddress.setVisible(false);
	}
