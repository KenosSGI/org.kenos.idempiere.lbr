...
public class InfoGeneralPanel extends InfoPanel implements EventListener<Event>
{
	...
	private void init()
	{
		...
		txt1.addEventListener(Events.ON_CTRL_KEY,this);
		txt2.addEventListener(Events.ON_CTRL_KEY,this);
		txt3.addEventListener(Events.ON_CTRL_KEY,this);
		txt4.addEventListener(Events.ON_CTRL_KEY,this);
