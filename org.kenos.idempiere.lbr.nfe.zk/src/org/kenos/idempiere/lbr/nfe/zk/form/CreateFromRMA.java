...
public abstract class CreateFromRMA extends CreateFrom {
	...
	protected Vector<Vector<Object>> getRMAData()
	{
        ...
        sqlStmt.append("iol.Description, p.Value " );
        ...
        try
        {
            ...
            while (rs.next())
            {
                ...
                line.add(lineKNPair);
                line.add(rs.getString(8)); // 7 - Product Value
	...
	protected void configureMiniTable (IMiniTable miniTable)
	{
		...
		miniTable.setColumnClass(2, String.class, true);        //  7-Product Value
		miniTable.setColumnClass(3, String.class, true);        //  2-Product 
		miniTable.setColumnClass(4, String.class, true);        //  3-ASI
		miniTable.setColumnClass(5, BigDecimal.class, true);        //  4-Qty
		miniTable.setColumnClass(6, BigDecimal.class, false);        //  5-Delivered Qty
