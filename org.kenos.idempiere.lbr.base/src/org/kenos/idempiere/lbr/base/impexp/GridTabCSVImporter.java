 ...
 *****************************************************************************/
package org.kenos.idempiere.lbr.base.impexp;
...
public class GridTabCSVImporter implements IGridTabImporter
{
	...
	private CsvPreference csvpref = CsvPreference.EXCEL_NORTH_EUROPE_PREFERENCE;
...
//				}		
	...
	public String getFileExtensionLabel() {
		return "Arquivo Excel de Valores Separados por Ponto-e-Vírgula";
	}
