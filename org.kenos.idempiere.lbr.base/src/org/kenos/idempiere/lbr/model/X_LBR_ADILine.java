...
// @SQL=SELECT COALESCE(MAX(SeqNo),0)+1 AS DefaultValue FROM LBR_ADILine WHERE LBR_ADI_ID=@LBR_ADI_ID@
	...
	public org.kenos.idempiere.lbr.model.I_LBR_ADI getLBR_ADI() throws RuntimeException
    {
		return (org.kenos.idempiere.lbr.model.I_LBR_ADI)MTable.get(getCtx(), org.kenos.idempiere.lbr.model.I_LBR_ADI.Table_Name)
