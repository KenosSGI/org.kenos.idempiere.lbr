...
public class X_LBR_BankInfo extends PO implements I_LBR_BankInfo, I_Persistent 
{
	...
	public org.kenos.idempiere.lbr.model.I_LBR_Bank getLBR_Bank() throws RuntimeException
    {
		return (org.kenos.idempiere.lbr.model.I_LBR_Bank)MTable.get(getCtx(), org.kenos.idempiere.lbr.model.I_LBR_Bank.Table_Name)
