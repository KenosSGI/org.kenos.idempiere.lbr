...
public class X_LBR_TaxAssessmentLine extends PO implements I_LBR_TaxAssessmentLine, I_Persistent 
{
	...
	public org.kenos.idempiere.lbr.model.I_LBR_TaxAssessment getLBR_TaxAssessment() throws RuntimeException
    {
		return (org.kenos.idempiere.lbr.model.I_LBR_TaxAssessment)MTable.get(getCtx(), org.kenos.idempiere.lbr.model.I_LBR_TaxAssessment.Table_Name)
