...
public class X_LBR_NFLineTax extends PO implements I_LBR_NFLineTax, I_Persistent 
{
	...
	public org.kenos.idempiere.lbr.model.I_LBR_LegalMessage getLBR_LegalMessage() throws RuntimeException
    {
		return (org.kenos.idempiere.lbr.model.I_LBR_LegalMessage)MTable.get(getCtx(), org.kenos.idempiere.lbr.model.I_LBR_LegalMessage.Table_Name)
    ...
    {
		return (org.kenos.idempiere.lbr.model.I_LBR_NotaFiscalLine)MTable.get(getCtx(), org.kenos.idempiere.lbr.model.I_LBR_NotaFiscalLine.Table_Name)
	...
	public org.kenos.idempiere.lbr.model.I_LBR_TaxBaseType getLBR_TaxBaseType() throws RuntimeException
    {
		return (org.kenos.idempiere.lbr.model.I_LBR_TaxBaseType)MTable.get(getCtx(), org.kenos.idempiere.lbr.model.I_LBR_TaxBaseType.Table_Name)
	...
	public org.kenos.idempiere.lbr.model.I_LBR_TaxLegalFW getLBR_TaxLegalFW() throws RuntimeException
    {
		return (org.kenos.idempiere.lbr.model.I_LBR_TaxLegalFW)MTable.get(getCtx(), org.kenos.idempiere.lbr.model.I_LBR_TaxLegalFW.Table_Name)
	...
	public org.kenos.idempiere.lbr.model.I_LBR_TaxStatus getLBR_TaxStatus() throws RuntimeException
    {
		return (org.kenos.idempiere.lbr.model.I_LBR_TaxStatus)MTable.get(getCtx(), org.kenos.idempiere.lbr.model.I_LBR_TaxStatus.Table_Name)
