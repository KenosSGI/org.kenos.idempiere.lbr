...
/** Generated Model for LBR_CTeICMS
 *  @author iDempiere (generated) 
 *  @version Release 6.2 - $Id$ */
public class X_LBR_CTeICMS extends PO implements I_LBR_CTeICMS, I_Persistent 
{
    ...
    public X_LBR_CTeICMS (Properties ctx, int LBR_CTeICMS_ID, String trxName)
    {
      super (ctx, LBR_CTeICMS_ID, trxName);
      /** if (LBR_CTeICMS_ID == 0)
        {
			setLBR_CTeICMS_ID (0);
			setLBR_CTe_ID (0);
    ...
    /** Load Constructor */
    public X_LBR_CTeICMS (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_LBR_CTeICMS[")
        .append(get_ID()).append("]");
      return sb.toString();
    }

	/** Set ICMS CST.
		@param ICMS_TaxStatus ICMS CST	  */
	...
	/** Set CT-e ICMS.
		@param LBR_CTeICMS_ID CT-e ICMS	  */
	public void setLBR_CTeICMS_ID (int LBR_CTeICMS_ID)
	{
		if (LBR_CTeICMS_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_LBR_CTeICMS_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_LBR_CTeICMS_ID, Integer.valueOf(LBR_CTeICMS_ID));
	}

	/** Get CT-e ICMS.
		@return CT-e ICMS	  */
	public int getLBR_CTeICMS_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_LBR_CTeICMS_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set LBR_CTeICMS_UU.
		@param LBR_CTeICMS_UU LBR_CTeICMS_UU	  */
	public void setLBR_CTeICMS_UU (String LBR_CTeICMS_UU)
	{
		set_ValueNoCheck (COLUMNNAME_LBR_CTeICMS_UU, LBR_CTeICMS_UU);
	}

	/** Get LBR_CTeICMS_UU.
		@return LBR_CTeICMS_UU	  */
	public String getLBR_CTeICMS_UU () 
	{
		return (String)get_Value(COLUMNNAME_LBR_CTeICMS_UU);
	}
