...
public class X_LBR_ProductionGroup extends PO implements I_LBR_ProductionGroup, I_Persistent 
{
    ...
    public X_LBR_ProductionGroup (Properties ctx, int LBR_ProductionGroup_ID, String trxName)
    {
      super (ctx, LBR_ProductionGroup_ID, trxName);
      /** if (LBR_ProductionGroup_ID == 0)
        {
			setC_BPartner_ID (0);
...
// DR
    ...
    /** Load Constructor */
    public X_LBR_ProductionGroup (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_LBR_ProductionGroup[")
	...
	/** Set Production Group.
		@param LBR_ProductionGroup_ID Production Group	  */
	public void setLBR_ProductionGroup_ID (int LBR_ProductionGroup_ID)
	{
		if (LBR_ProductionGroup_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_LBR_ProductionGroup_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_LBR_ProductionGroup_ID, Integer.valueOf(LBR_ProductionGroup_ID));
	}
	...
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_LBR_ProductionGroup_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}

	/** Set LBR_ProductionGroup_UU.
		@param LBR_ProductionGroup_UU LBR_ProductionGroup_UU	  */
	public void setLBR_ProductionGroup_UU (String LBR_ProductionGroup_UU)
	{
		set_ValueNoCheck (COLUMNNAME_LBR_ProductionGroup_UU, LBR_ProductionGroup_UU);
	}

	/** Get LBR_ProductionGroup_UU.
		@return LBR_ProductionGroup_UU	  */
	public String getLBR_ProductionGroup_UU () 
	{
		return (String)get_Value(COLUMNNAME_LBR_ProductionGroup_UU);
	}
