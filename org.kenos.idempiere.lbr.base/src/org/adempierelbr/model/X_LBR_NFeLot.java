...
// @SQL=SELECT lbr_NFeEnv FROM LBR_NFConfig WHERE lbr_NFModel='@lbr_NFModel@' AND AD_Org_ID=@AD_Org_ID@
	...
	/** Set LBR_NFeLot_UU.
		@param LBR_NFeLot_UU LBR_NFeLot_UU	  */
	public void setLBR_NFeLot_UU (String LBR_NFeLot_UU)
	{
		set_Value (COLUMNNAME_LBR_NFeLot_UU, LBR_NFeLot_UU);
	}

	/** Get LBR_NFeLot_UU.
		@return LBR_NFeLot_UU	  */
	public String getLBR_NFeLot_UU () 
	{
		return (String)get_Value(COLUMNNAME_LBR_NFeLot_UU);
	}
	...
	public static final String LBR_NFEANSWERSTATUS_213_RejeiçãoCNPJ_BaseDoAutorDifereDoCNPJ_BaseDoCertificadoDigital = "213";
	...
	public static final String LBR_NFEANSWERSTATUS_220_RejeiçãoDestinatárioComIdentificaçãoIgualÀIdentificaçãoDoEmitente = "220";
	...
	public static final String LBR_NFEANSWERSTATUS_270_RejeiçãoCódigoMunicípioDoFatoGeradorDeICMSInexistente = "270";
	...
	public static final String LBR_NFEANSWERSTATUS_316_RejeiçãoChaveDeAcessoReferenciadaComAMesmaChaveDeAcessoDaNotaFiscalAtual = "316";
	...
	public static final String LBR_NFEANSWERSTATUS_328_RejeiçãoCFOPDeDevoluçãoDeMercadoriaParaNFEQueNãoTemFinalidadeDeDevoluçãoDeMercadoria = "328";
	...
	public static final String LBR_NFEANSWERSTATUS_336_RejeiçãoInformadoOGrupoDeExportaçãoNoItemEmOperaçãoQueNãoÉComExterior = "336";
	...
	public static final String LBR_NFEANSWERSTATUS_347_RejeiçãoInformadaIEDoSubstitutoTributárioEmOperaçãoComExterior = "347";
	...
	public static final String LBR_NFEANSWERSTATUS_375_RejeiçãoNF_EComLançamentoRelativoACupomFiscalReferenciaUmaNFC_E = "375";
	...
	public static final String LBR_NFEANSWERSTATUS_385_RejeiçãoGrupoDeTributaçãoICMSSN900InformandoDadosDoICMS_ST = "385";
	...
	public static final String LBR_NFEANSWERSTATUS_396_RejeiçãoParâmetroDoQR_CodeInexistente = "396";
	/** 397-Rejeição: Parâmetro do QR-Code divergente da Nota Fiscal = 397 */
	public static final String LBR_NFEANSWERSTATUS_397_RejeiçãoParâmetroDoQR_CodeDivergenteDaNotaFiscal = "397";
	...
	public static final String LBR_NFEANSWERSTATUS_400_RejeiçãoParâmetroDoQR_CodeNãoEstáNoFormatoHexadecimal = "400";
	...
	public static final String LBR_NFEANSWERSTATUS_461_RejeiçãoInformadoCamposDePercentualDeGLPEOuGLGNnEOuGLGNiParaProdutoDiferenteDeGLP = "461";
	...
	public static final String LBR_NFEANSWERSTATUS_486_RejeiçãoNãoInformadoOGrupoDeAutorizaçãoParaUFQueExigeAIdentificaçãoDoEscritórioDeContabilidadeNaNotaFisc = "486";
	...
	public static final String LBR_NFEANSWERSTATUS_521_RejeiçãoOperaçãoInternaEUFDoEmitenteDifereDaUFDoDestinatárioRemetenteContribuinteDoICMS = "521";
	/** 522-Rejeição: Chave de Acesso referenciada com UF inválida = 522 */
	public static final String LBR_NFEANSWERSTATUS_522_RejeiçãoChaveDeAcessoReferenciadaComUFInválida = "522";
	...
	public static final String LBR_NFEANSWERSTATUS_524_RejeiçãoChaveDeAcessoReferenciadaComAno_MêsInválido = "524";
	...
	public static final String LBR_NFEANSWERSTATUS_526_RejeiçãoAno_MêsDaChaveDeAcessoComAtrasoSuperiorA6MesesEmRelaçãoAoAno_MêsAtual = "526";
	...
	public static final String LBR_NFEANSWERSTATUS_539_DuplicidadeDeNF_EComDiferençaNaChaveDeAcesso = "539";
	...
	public static final String LBR_NFEANSWERSTATUS_547_RejeiçãoChaveDeAcessoReferenciadaComDígitoVerificadorInválido = "547";
	...
	public static final String LBR_NFEANSWERSTATUS_552_RejeiçãoChaveDeAcessoReferenciadaComCNPJInválido = "552";
	...
	public static final String LBR_NFEANSWERSTATUS_596_RejeiçãoEventoApresentadoForaDoPrazoPrazoVigente = "596";
	...
	public static final String LBR_NFEANSWERSTATUS_679_RejeiçãoModeloDaNF_EReferenciadaDiferenteDe5565 = "679";
	/** 680-Rejeição: Chave de Acesso referenciada em duplicidade na NF-e  = 680 */
	public static final String LBR_NFEANSWERSTATUS_680_RejeiçãoChaveDeAcessoReferenciadaEmDuplicidadeNaNF_E = "680";
	/** 681-Rejeição: Duplicidade de NF referenciada (CNPJ, Modelo, Série e Número) = 681 */
	public static final String LBR_NFEANSWERSTATUS_681_RejeiçãoDuplicidadeDeNFReferenciadaCNPJModeloSérieENúmero = "681";
	...
	public static final String LBR_NFEANSWERSTATUS_683_RejeiçãoChaveDeAcessoReferenciadaComNúmeroInválido = "683";
	...
	public static final String LBR_NFEANSWERSTATUS_701_RejeiçãoNãoInformadoNotaFiscalReferenciadaLançamentoRelativoACupomFiscal = "701";
	...
	public static final String LBR_NFEANSWERSTATUS_721_RejeiçãoInformadoIdEstrangeiroEOperaçãoNãoÉComConsumidorFinal = "721";
	...
	public static final String LBR_NFEANSWERSTATUS_737_RejeiçãoPagamentoComCartãoDeCréditoEmSistemaDeAutomaçãoNãoIntegrado = "737";
	...
	public static final String LBR_NFEANSWERSTATUS_761_RejeiçãoCódigoDeProdutoANPInexistente = "761";
	...
	public static final String LBR_NFEANSWERSTATUS_770_RejeiçãoCFOPInexistente = "770";
	/** 771-Rejeição: Informado idEstrangeiro em operação interestadual = 771 */
	public static final String LBR_NFEANSWERSTATUS_771_RejeiçãoInformadoIdEstrangeiroEmOperaçãoInterestadual = "771";
	/** 772-Rejeição: Operação Interestadual e UF de destino igual à UF de origem = 772 */
	public static final String LBR_NFEANSWERSTATUS_772_RejeiçãoOperaçãoInterestadualEUFDeDestinoIgualÀUFDeOrigem = "772";
	...
	public static final String LBR_NFEANSWERSTATUS_798_RejeiçãoValorTotalDoICMSRelativoFundoDeCombateÀPobrezaFCPDaUFDeDestinoDifereDoSomatórioDoValorDosIt = "798";
	...
	public static final String LBR_NFEANSWERSTATUS_805_RejeiçãoASEFAZDoDestinatárioNãoPermiteContribuinteIsentoDeInscriçãoEstadualEmOperaçõesInterestaduais = "805";
	...
	public static final String LBR_NFEANSWERSTATUS_722_RejeiçãoCFOPDeTransporteInexistente = "722";
	/** 363-Rejeição: IE do substituto tributário idêntica à IE do emitente ou do destinatário = 363 */
	public static final String LBR_NFEANSWERSTATUS_363_RejeiçãoIEDoSubstitutoTributárioIdênticaÀIEDoEmitenteOuDoDestinatário = "363";
	/** 377-Rejeição: Código de País do destinatário Inexistente  = 377 */
	public static final String LBR_NFEANSWERSTATUS_377_RejeiçãoCódigoDePaísDoDestinatárioInexistente = "377";
	/** 416-Rejeição: Falha na descompactação da área de dados = 416 */
	public static final String LBR_NFEANSWERSTATUS_416_RejeiçãoFalhaNaDescompactaçãoDaÁreaDeDados = "416";
	/** 696-Rejeição: Operação com não contribuinte deve indicar operação com consumidor final = 696 */
	public static final String LBR_NFEANSWERSTATUS_696_RejeiçãoOperaçãoComNãoContribuinteDeveIndicarOperaçãoComConsumidorFinal = "696";
	/** 739-Rejeição: Código de País do ISSQN Inexistente = 739 */
	public static final String LBR_NFEANSWERSTATUS_739_RejeiçãoCódigoDePaísDoISSQNInexistente = "739";
	/** 812-Rejeição: Regime Tributário SN, com excesso de sublimite não é permitido para Emitentes desta UF = 812 */
	public static final String LBR_NFEANSWERSTATUS_812_RejeiçãoRegimeTributárioSNComExcessoDeSublimiteNãoÉPermitidoParaEmitentesDestaUF = "812";
	/** 813-Rejeição: QR-Code com sequência de escape para o e-comercial. Usar CDATA = 813 */
	public static final String LBR_NFEANSWERSTATUS_813_RejeiçãoQR_CodeComSequênciaDeEscapeParaOE_ComercialUsarCDATA = "813";
	/** 814-Rejeição: Nota Fiscal com grupo de comércio exterior = 814 */
	public static final String LBR_NFEANSWERSTATUS_814_RejeiçãoNotaFiscalComGrupoDeComércioExterior = "814";
	/** 817-Rejeição: Unidade Tributável incompatível com o NCM informado na operação com Comércio Exterior = 817 */
	public static final String LBR_NFEANSWERSTATUS_817_RejeiçãoUnidadeTributávelIncompatívelComONCMInformadoNaOperaçãoComComércioExterior = "817";
	/** 854-Rejeição: Unidade Tributável incompatível com produto informado  = 854 */
	public static final String LBR_NFEANSWERSTATUS_854_RejeiçãoUnidadeTributávelIncompatívelComProdutoInformado = "854";
	/** 855-Rejeição: Somatório percentuais de GLP derivado do petróleo, GLGNn e GLGNi diferente de 1 = 855 */
	public static final String LBR_NFEANSWERSTATUS_855_RejeiçãoSomatórioPercentuaisDeGLPDerivadoDoPetróleoGLGNnEGLGNiDiferenteDe1 = "855";
	/** 856-Rejeição: Campo valor de partida não preenchido para produto GLP = 856 */
	public static final String LBR_NFEANSWERSTATUS_856_RejeiçãoCampoValorDePartidaNãoPreenchidoParaProdutoGLP = "856";
	/** 857-Rejeição: Informado Duplicata Mercantil como Forma de Pagamento  = 857 */
	public static final String LBR_NFEANSWERSTATUS_857_RejeiçãoInformadoDuplicataMercantilComoFormaDePagamento = "857";
	/** 858-Rejeição: Grupo de Tributação informado indevidamente = 858 */
	public static final String LBR_NFEANSWERSTATUS_858_RejeiçãoGrupoDeTributaçãoInformadoIndevidamente = "858";
	/** 859-Rejeição: Total do FCP retido anteriormente por Substituição Tributária difere do somatório dos itens  = 859 */
	public static final String LBR_NFEANSWERSTATUS_859_RejeiçãoTotalDoFCPRetidoAnteriormentePorSubstituiçãoTributáriaDifereDoSomatórioDosItens = "859";
	/** 860-Rejeição: Valor do FCP informado difere de base de cálculo*alíquota  = 860 */
	public static final String LBR_NFEANSWERSTATUS_860_RejeiçãoValorDoFCPInformadoDifereDeBaseDeCálculoAlíquota = "860";
	/** 861-Rejeição: Total do FCP difere do somatório dos itens  = 861 */
	public static final String LBR_NFEANSWERSTATUS_861_RejeiçãoTotalDoFCPDifereDoSomatórioDosItens = "861";
	/** 862-Rejeição: Total do FCP ST difere do somatório dos itens  = 862 */
	public static final String LBR_NFEANSWERSTATUS_862_RejeiçãoTotalDoFCPSTDifereDoSomatórioDosItens = "862";
	/** 863-Rejeição: Total do IPI devolvido difere do somatório dos itens  = 863 */
	public static final String LBR_NFEANSWERSTATUS_863_RejeiçãoTotalDoIPIDevolvidoDifereDoSomatórioDosItens = "863";
	/** 864-Rejeição: NF-e com indicativo de Operação presencial, fora do estabelecimento e não informada NF referenciada = 864 */
	public static final String LBR_NFEANSWERSTATUS_864_RejeiçãoNF_EComIndicativoDeOperaçãoPresencialForaDoEstabelecimentoENãoInformadaNFReferenciada = "864";
	/** 865-Rejeição: Total dos pagamentos menor que o total da nota  = 865 */
	public static final String LBR_NFEANSWERSTATUS_865_RejeiçãoTotalDosPagamentosMenorQueOTotalDaNota = "865";
	/** 866-Rejeição: Ausência de troco quando o valor dos pagamentos informados for maior que o total da nota  = 866 */
	public static final String LBR_NFEANSWERSTATUS_866_RejeiçãoAusênciaDeTrocoQuandoOValorDosPagamentosInformadosForMaiorQueOTotalDaNota = "866";
	/** 867-Rejeição: Grupo Duplicata não deve ser preenchido  = 867 */
	public static final String LBR_NFEANSWERSTATUS_867_RejeiçãoGrupoDuplicataNãoDeveSerPreenchido = "867";
	/** 868-Rejeição: Grupos Veiculo Transporte e Reboque não devem ser informados  = 868 */
	public static final String LBR_NFEANSWERSTATUS_868_RejeiçãoGruposVeiculoTransporteEReboqueNãoDevemSerInformados = "868";
	/** 869-Rejeição: Valor do troco incorreto  = 869 */
	public static final String LBR_NFEANSWERSTATUS_869_RejeiçãoValorDoTrocoIncorreto = "869";
	/** 870-Rejeição: Data de validade incompatível com data de fabricação  = 870 */
	public static final String LBR_NFEANSWERSTATUS_870_RejeiçãoDataDeValidadeIncompatívelComDataDeFabricação = "870";
	/** 871-Rejeição: O campo Forma de Pagamento deve ser preenchido com a opção “Sem Pagamento”  = 871 */
	public static final String LBR_NFEANSWERSTATUS_871_RejeiçãoOCampoFormaDePagamentoDeveSerPreenchidoComAOpçãoSemPagamento = "871";
	/** 872-Rejeição: Informado Duplicata Mercantil como Forma de Pagamento e não preenchido o Grupo Duplicata  = 872 */
	public static final String LBR_NFEANSWERSTATUS_872_RejeiçãoInformadoDuplicataMercantilComoFormaDePagamentoENãoPreenchidoOGrupoDuplicata = "872";
	/** 873-Rejeição: Rejeição: Operação com medicamentos não informado os campos de rastreabilidade  = 873 */
	public static final String LBR_NFEANSWERSTATUS_873_RejeiçãoRejeiçãoOperaçãoComMedicamentosNãoInformadoOsCamposDeRastreabilidade = "873";
	/** 874-Rejeição: Percentual de FCP inválido  = 874 */
	public static final String LBR_NFEANSWERSTATUS_874_RejeiçãoPercentualDeFCPInválido = "874";
	/** 875-Rejeição: Percentual de FCP ST inválido  = 875 */
	public static final String LBR_NFEANSWERSTATUS_875_RejeiçãoPercentualDeFCPSTInválido = "875";
	...
	public static final String LBR_NFEANSWERSTATUS_876_RejeiçãoOperaçãoInterestadualParaConsumidorFinalEValorDoFCPInformadoEmCampoDiferenteDeVFCPUFDestIdNA13 = "876";
	/** 877-Rejeição: Nota Fiscal sem a informação da URL de consulta por chave de acesso  = 877 */
	public static final String LBR_NFEANSWERSTATUS_877_RejeiçãoNotaFiscalSemAInformaçãoDaURLDeConsultaPorChaveDeAcesso = "877";
	/** 878-Rejeição: Endereço do site da UF da Consulta por chave de acesso diverge do previsto  = 878 */
	public static final String LBR_NFEANSWERSTATUS_878_RejeiçãoEndereçoDoSiteDaUFDaConsultaPorChaveDeAcessoDivergeDoPrevisto = "878";
	/** 879-Rejeição: Informado item “Produzido em Escala NÃO Relevante” e não informado CNPJ do Fabricante  = 879 */
	public static final String LBR_NFEANSWERSTATUS_879_RejeiçãoInformadoItemProduzidoEmEscalaNÃORelevanteENãoInformadoCNPJDoFabricante = "879";
	/** 850-Rejeição: Data de vencimento da parcela não informada ou menor que a Data de vencimento da parcela anterior = 850 */
	public static final String LBR_NFEANSWERSTATUS_850_RejeiçãoDataDeVencimentoDaParcelaNãoInformadaOuMenorQueADataDeVencimentoDaParcelaAnterior = "850";
	/** 851-Rejeição: Soma do valor das parcelas difere do Valor Líquido da Fatura = 851 */
	public static final String LBR_NFEANSWERSTATUS_851_RejeiçãoSomaDoValorDasParcelasDifereDoValorLíquidoDaFatura = "851";
	/** 852-Rejeição: Número da parcela inválido ou não informado = 852 */
	public static final String LBR_NFEANSWERSTATUS_852_RejeiçãoNúmeroDaParcelaInválidoOuNãoInformado = "852";
	/** 880-Rejeição: Percentual de FCP igual a zero = 880 */
	public static final String LBR_NFEANSWERSTATUS_880_RejeiçãoPercentualDeFCPIgualAZero = "880";
	/** 881-Rejeição: Percentual de FCP ST igual a zero = 881 */
	public static final String LBR_NFEANSWERSTATUS_881_RejeiçãoPercentualDeFCPSTIgualAZero = "881";
	/** 897-Rejeição: Valor Fatura maior que Valor Total da NF-e = 897 */
	public static final String LBR_NFEANSWERSTATUS_897_RejeiçãoValorFaturaMaiorQueValorTotalDaNF_E = "897";
	/** 898-Rejeição: Data de vencimento da parcela não informada ou menor que Data de Autorização = 898 */
	public static final String LBR_NFEANSWERSTATUS_898_RejeiçãoDataDeVencimentoDaParcelaNãoInformadaOuMenorQueDataDeAutorização = "898";
	/** 899-Rejeição: Informado incorretamente o campo meio de pagamento = 899 */
	public static final String LBR_NFEANSWERSTATUS_899_RejeiçãoInformadoIncorretamenteOCampoMeioDePagamento = "899";
	/** 900-Rejeição: Data de vencimento da parcela não informada ou menor que Data de Emissão = 900 */
	public static final String LBR_NFEANSWERSTATUS_900_RejeiçãoDataDeVencimentoDaParcelaNãoInformadaOuMenorQueDataDeEmissão = "900";
	/** 901-Rejeição: Valor do Desconto da Fatura maior que o Valor Original da Fatura = 901 */
	public static final String LBR_NFEANSWERSTATUS_901_RejeiçãoValorDoDescontoDaFaturaMaiorQueOValorOriginalDaFatura = "901";
	/** 902-Rejeição: Valor Liquido da Fatura difere do Valor Original menos o Valor do Desconto = 902 */
	public static final String LBR_NFEANSWERSTATUS_902_RejeiçãoValorLiquidoDaFaturaDifereDoValorOriginalMenosOValorDoDesconto = "902";
	/** 903-Rejeição: Versão informada no QR-Code (“100”) não é mais válida para a data de emissão = 903 */
	public static final String LBR_NFEANSWERSTATUS_903_RejeiçãoVersãoInformadaNoQR_Code100NãoÉMaisVálidaParaADataDeEmissão = "903";
	/** 904-Rejeição: Informado indevidamente campo valor de pagamento = 904 */
	public static final String LBR_NFEANSWERSTATUS_904_RejeiçãoInformadoIndevidamenteCampoValorDePagamento = "904";
	/** 905-Rejeição: Campos do grupo Fatura não informados = 905 */
	public static final String LBR_NFEANSWERSTATUS_905_RejeiçãoCamposDoGrupoFaturaNãoInformados = "905";
	/** 906 - Rejeição: Não informados os campos para informações do ICMS Efetivo = 906 */
	public static final String LBR_NFEANSWERSTATUS_906_RejeiçãoNãoInformadosOsCamposParaInformaçõesDoICMSEfetivo = "906";
	/** 907-Rejeição: Não informado campo obrigatório quando CST = 60 ou CSOSN=500 e operação com consumidor final = 907 */
	public static final String LBR_NFEANSWERSTATUS_907_RejeiçãoNãoInformadoCampoObrigatórioQuandoCSTEq60OuCSOSNEq500EOperaçãoComConsumidorFinal = "907";
	/** 908-Rejeição: Não informado campo obrigatório quando CST = 60 ou CSOSN=500 e operação com consumidor final = 908 */
	public static final String LBR_NFEANSWERSTATUS_908_RejeiçãoNãoInformadoCampoObrigatórioQuandoCSTEq60OuCSOSNEq500EOperaçãoComConsumidorFinal = "908";
	/** 909-Rejeição: Não informado campo obrigatório quando CST = 60 ou CSOSN=500 e operação com consumidor final = 909 */
	public static final String LBR_NFEANSWERSTATUS_909_RejeiçãoNãoInformadoCampoObrigatórioQuandoCSTEq60OuCSOSNEq500EOperaçãoComConsumidorFinal = "909";
	/** 906-Rejeição: Não informada vBCSTRet, pST, vICMSSubstituto e vICMSSTRet = 938 */
	public static final String LBR_NFEANSWERSTATUS_906_RejeiçãoNãoInformadaVBCSTRetPSTVICMSSubstitutoEVICMSSTRet = "938";
	/** 970-Rejeição: Código de País inexistente [local de retirada/entrega] = 970 */
	public static final String LBR_NFEANSWERSTATUS_970_RejeiçãoCódigoDePaísInexistenteLocalDeRetiradaEntrega = "970";
	/** 971-Rejeição: IE inválida [local de retirada/entrega] = 971 */
	public static final String LBR_NFEANSWERSTATUS_971_RejeiçãoIEInválidaLocalDeRetiradaEntrega = "971";
	/** 972-Rejeição: Obrigatória as informações do responsável técnico = 972 */
	public static final String LBR_NFEANSWERSTATUS_972_RejeiçãoObrigatóriaAsInformaçõesDoResponsávelTécnico = "972";
	/** 973-Rejeição: CNPJ do responsável técnico inválido = 973 */
	public static final String LBR_NFEANSWERSTATUS_973_RejeiçãoCNPJDoResponsávelTécnicoInválido = "973";
	/** 974-Rejeição: CNPJ do responsável técnico diverge do cadastrado = 974 */
	public static final String LBR_NFEANSWERSTATUS_974_RejeiçãoCNPJDoResponsávelTécnicoDivergeDoCadastrado = "974";
	/** 975-Rejeição: Obrigatória a informação do identificador do CSRT e do Hash do CSRT = 975 */
	public static final String LBR_NFEANSWERSTATUS_975_RejeiçãoObrigatóriaAInformaçãoDoIdentificadorDoCSRTEDoHashDoCSRT = "975";
	/** 976-Rejeição: Identificador do CSRT não cadastrado na SEFAZ = 976 */
	public static final String LBR_NFEANSWERSTATUS_976_RejeiçãoIdentificadorDoCSRTNãoCadastradoNaSEFAZ = "976";
	/** 977-Rejeição: Identificador do CSRT revogado = 977 */
	public static final String LBR_NFEANSWERSTATUS_977_RejeiçãoIdentificadorDoCSRTRevogado = "977";
	/** 978-Rejeição: Hash do CSRT diverge do calculado = 978 */
	public static final String LBR_NFEANSWERSTATUS_978_RejeiçãoHashDoCSRTDivergeDoCalculado = "978";
	/** 306-Rejeição: IE do destinatário não está ativa na UF = 306 */
	public static final String LBR_NFEANSWERSTATUS_306_RejeiçãoIEDoDestinatárioNãoEstáAtivaNaUF = "306";
	/** 305-Rejeição: Destinatário bloqueado na UF = 305 */
	public static final String LBR_NFEANSWERSTATUS_305_RejeiçãoDestinatárioBloqueadoNaUF = "305";
