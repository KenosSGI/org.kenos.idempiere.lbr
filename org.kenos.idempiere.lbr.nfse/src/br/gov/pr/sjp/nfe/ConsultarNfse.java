...
/**
 *  ConsultarNfse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ConsultarNfse implements org.apache.axis2.databinding.ADBBean {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ConsultarNfse".equals(type)) {
                            ...
                            return (ConsultarNfse) br.gov.pr.sjp.nfe.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
