...
/**
 *  ConsultarNfseV3 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ConsultarNfseV3 implements org.apache.axis2.databinding.ADBBean {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ConsultarNfseV3".equals(type)) {
                            ...
                            return (ConsultarNfseV3) br.gov.pr.sjp.nfe.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
