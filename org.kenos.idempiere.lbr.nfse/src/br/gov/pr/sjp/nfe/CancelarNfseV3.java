...
/**
 *  CancelarNfseV3 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class CancelarNfseV3 implements org.apache.axis2.databinding.ADBBean {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"CancelarNfseV3".equals(type)) {
                            ...
                            return (CancelarNfseV3) br.gov.pr.sjp.nfe.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
