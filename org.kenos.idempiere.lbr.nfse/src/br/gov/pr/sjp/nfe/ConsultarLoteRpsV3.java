...
/**
 *  ConsultarLoteRpsV3 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ConsultarLoteRpsV3 implements org.apache.axis2.databinding.ADBBean {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ConsultarLoteRpsV3".equals(type)) {
                            ...
                            return (ConsultarLoteRpsV3) br.gov.pr.sjp.nfe.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
