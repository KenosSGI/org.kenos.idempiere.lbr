...
/**
 *  RecepcionarLoteRpsV3 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class RecepcionarLoteRpsV3 implements org.apache.axis2.databinding.ADBBean {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"RecepcionarLoteRpsV3".equals(type)) {
                            ...
                            return (RecepcionarLoteRpsV3) br.gov.pr.sjp.nfe.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
