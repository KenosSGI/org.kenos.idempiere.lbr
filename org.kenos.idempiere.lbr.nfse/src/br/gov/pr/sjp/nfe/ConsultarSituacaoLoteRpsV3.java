/**
 * ConsultarSituacaoLoteRpsV3.java
 *
...
/**
 *  ConsultarSituacaoLoteRpsV3 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ConsultarSituacaoLoteRpsV3 implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ConsultarSituacaoLoteRpsV3", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ConsultarSituacaoLoteRpsV3".equals(type)) {
                            ...
                            return (ConsultarSituacaoLoteRpsV3) br.gov.pr.sjp.nfe.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
