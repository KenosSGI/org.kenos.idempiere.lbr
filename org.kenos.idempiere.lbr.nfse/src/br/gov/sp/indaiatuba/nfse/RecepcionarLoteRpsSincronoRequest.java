...
public class RecepcionarLoteRpsSincronoRequest implements org.apache.axis2.databinding.ADBBean {
     ...
     */
    protected br.gov.sp.indaiatuba.nfse.Input localRecepcionarLoteRpsSincronoRequest;

    /**
     * Auto generated getter method
     * @return br.gov.sp.indaiatuba.nfse.Input
     */
    public br.gov.sp.indaiatuba.nfse.Input getRecepcionarLoteRpsSincronoRequest() {
                    ...
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    ...
                                    reader.getName())) {
                            object.setRecepcionarLoteRpsSincronoRequest(br.gov.sp.indaiatuba.nfse.Input.Factory.parse(
                                    reader));
