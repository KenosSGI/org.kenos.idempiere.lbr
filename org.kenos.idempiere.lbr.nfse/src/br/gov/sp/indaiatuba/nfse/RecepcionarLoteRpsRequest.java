...
public class RecepcionarLoteRpsRequest implements org.apache.axis2.databinding.ADBBean {
     ...
     */
    protected br.gov.sp.indaiatuba.nfse.Input localRecepcionarLoteRpsRequest;

    /**
     * Auto generated getter method
     * @return br.gov.sp.indaiatuba.nfse.Input
     */
    public br.gov.sp.indaiatuba.nfse.Input getRecepcionarLoteRpsRequest() {
     ...
     */
    public void setRecepcionarLoteRpsRequest(
                    ...
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    ...
                                    reader.getName())) {
                            object.setRecepcionarLoteRpsRequest(br.gov.sp.indaiatuba.nfse.Input.Factory.parse(
                                    reader));
