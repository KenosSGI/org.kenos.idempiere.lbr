...
public class GerarNfseRequest implements org.apache.axis2.databinding.ADBBean {
     ...
     */
    protected br.gov.sp.indaiatuba.nfse.Input localGerarNfseRequest;

    /**
     * Auto generated getter method
     * @return br.gov.sp.indaiatuba.nfse.Input
     */
    public br.gov.sp.indaiatuba.nfse.Input getGerarNfseRequest() {
     ...
     */
    public void setGerarNfseRequest(br.gov.sp.indaiatuba.nfse.Input param) {
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                            ...
                            object.setGerarNfseRequest(br.gov.sp.indaiatuba.nfse.Input.Factory.parse(
                                    reader));
