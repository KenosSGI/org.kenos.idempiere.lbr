...
public class ConsultarNfsePorRpsRequest implements org.apache.axis2.databinding.ADBBean {
     ...
     */
    protected br.gov.sp.indaiatuba.nfse.Input localConsultarNfsePorRpsRequest;

    /**
     * Auto generated getter method
     * @return br.gov.sp.indaiatuba.nfse.Input
     */
    public br.gov.sp.indaiatuba.nfse.Input getConsultarNfsePorRpsRequest() {
     ...
     */
    public void setConsultarNfsePorRpsRequest(
                    ...
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    ...
                                    reader.getName())) {
                            object.setConsultarNfsePorRpsRequest(br.gov.sp.indaiatuba.nfse.Input.Factory.parse(
                                    reader));
