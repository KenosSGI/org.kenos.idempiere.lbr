...
public class SubstituirNfseRequest implements org.apache.axis2.databinding.ADBBean {
     ...
     */
    protected br.gov.sp.indaiatuba.nfse.Input localSubstituirNfseRequest;

    /**
     * Auto generated getter method
     * @return br.gov.sp.indaiatuba.nfse.Input
     */
    public br.gov.sp.indaiatuba.nfse.Input getSubstituirNfseRequest() {
     ...
     */
    public void setSubstituirNfseRequest(br.gov.sp.indaiatuba.nfse.Input param) {
                    ...
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    ...
                                    reader.getName())) {
                            object.setSubstituirNfseRequest(br.gov.sp.indaiatuba.nfse.Input.Factory.parse(
                                    reader));
