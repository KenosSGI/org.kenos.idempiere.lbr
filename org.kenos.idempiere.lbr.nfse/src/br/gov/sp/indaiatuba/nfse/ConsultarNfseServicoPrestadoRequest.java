...
public class ConsultarNfseServicoPrestadoRequest implements org.apache.axis2.databinding.ADBBean {
     ...
     */
    protected br.gov.sp.indaiatuba.nfse.Input localConsultarNfseServicoPrestadoRequest;

    /**
     * Auto generated getter method
     * @return br.gov.sp.indaiatuba.nfse.Input
     */
    public br.gov.sp.indaiatuba.nfse.Input getConsultarNfseServicoPrestadoRequest() {
                    ...
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    ...
                                    reader.getName())) {
                            object.setConsultarNfseServicoPrestadoRequest(br.gov.sp.indaiatuba.nfse.Input.Factory.parse(
                                    reader));
