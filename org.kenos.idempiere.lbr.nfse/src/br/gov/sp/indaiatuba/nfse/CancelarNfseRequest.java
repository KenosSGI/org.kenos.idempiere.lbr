...
public class CancelarNfseRequest implements org.apache.axis2.databinding.ADBBean {
     ...
     */
    protected br.gov.sp.indaiatuba.nfse.Input localCancelarNfseRequest;

    /**
     * Auto generated getter method
     * @return br.gov.sp.indaiatuba.nfse.Input
     */
    public br.gov.sp.indaiatuba.nfse.Input getCancelarNfseRequest() {
     ...
     */
    public void setCancelarNfseRequest(br.gov.sp.indaiatuba.nfse.Input param) {
                    ...
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    ...
                                    reader.getName())) {
                            object.setCancelarNfseRequest(br.gov.sp.indaiatuba.nfse.Input.Factory.parse(
                                    reader));
