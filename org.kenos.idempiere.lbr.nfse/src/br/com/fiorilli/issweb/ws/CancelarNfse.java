...
public class CancelarNfse implements org.apache.axis2.databinding.ADBBean {
     ...
     */
    protected br.org.abrasf.www.nfse_xsd.CancelarNfseEnvio_type0 localCancelarNfseEnvio;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localCancelarNfseEnvioTracker = false;
    ...
    public boolean isCancelarNfseEnvioSpecified() {
        return localCancelarNfseEnvioTracker;
    }

    /**
     * Auto generated getter method
     * @return br.org.abrasf.www.nfse_xsd.CancelarNfseEnvio_type0
     */
    public br.org.abrasf.www.nfse_xsd.CancelarNfseEnvio_type0 getCancelarNfseEnvio() {
     ...
     */
    public void setCancelarNfseEnvio(
        br.org.abrasf.www.nfse_xsd.CancelarNfseEnvio_type0 param) {
        localCancelarNfseEnvioTracker = param != null;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (localCancelarNfseEnvioTracker) {
            if (localCancelarNfseEnvio == null) {
                throw new org.apache.axis2.databinding.ADBException(
                    "CancelarNfseEnvio cannot be null!!");
            }

            localCancelarNfseEnvio.serialize(new javax.xml.namespace.QName(
                    "http://www.abrasf.org.br/nfse.xsd", "CancelarNfseEnvio"),
                xmlWriter);
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localCancelarNfseEnvioTracker) {
            ...
            elementList.add(localCancelarNfseEnvio);
        }
        ...
        public static CancelarNfse parse(
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"cancelarNfse".equals(type)) {
                            ...
                            return (CancelarNfse) org.w3.www._2000._09.xmldsig.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                    ...
                    object.setCancelarNfseEnvio(br.org.abrasf.www.nfse_xsd.CancelarNfseEnvio_type0.Factory.parse(
                            reader));
