...
/**
 *  TcMensagemRetornoLote bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class TcMensagemRetornoLote implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":tcMensagemRetornoLote", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "tcMensagemRetornoLote", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static TcMensagemRetornoLote parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            TcMensagemRetornoLote object = new TcMensagemRetornoLote();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"tcMensagemRetornoLote".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (TcMensagemRetornoLote) org.w3.www._2000._09.xmldsig.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
