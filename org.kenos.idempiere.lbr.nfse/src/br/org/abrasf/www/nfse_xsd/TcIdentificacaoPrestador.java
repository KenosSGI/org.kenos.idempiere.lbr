...
/**
 *  TcIdentificacaoPrestador bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class TcIdentificacaoPrestador implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":tcIdentificacaoPrestador", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "tcIdentificacaoPrestador", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static TcIdentificacaoPrestador parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            TcIdentificacaoPrestador object = new TcIdentificacaoPrestador();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"tcIdentificacaoPrestador".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (TcIdentificacaoPrestador) org.w3.www._2000._09.xmldsig.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
