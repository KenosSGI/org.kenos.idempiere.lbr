/**
 * TcIdentificacaoIntermediario.java
 *
...
/**
 *  TcIdentificacaoIntermediario bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class TcIdentificacaoIntermediario implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":tcIdentificacaoIntermediario", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "tcIdentificacaoIntermediario", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static TcIdentificacaoIntermediario parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            TcIdentificacaoIntermediario object = new TcIdentificacaoIntermediario();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"tcIdentificacaoIntermediario".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (TcIdentificacaoIntermediario) org.w3.www._2000._09.xmldsig.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
