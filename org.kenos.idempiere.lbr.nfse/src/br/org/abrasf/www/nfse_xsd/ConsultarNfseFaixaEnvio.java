...
/**
 *  ConsultarNfseFaixaEnvio bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ConsultarNfseFaixaEnvio implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ConsultarNfseFaixaEnvio", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
    ...
    public static class Factory {
         ...
         */
        public static ConsultarNfseFaixaEnvio parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ConsultarNfseFaixaEnvio object = new ConsultarNfseFaixaEnvio();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ConsultarNfseFaixaEnvio".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ConsultarNfseFaixaEnvio) org.w3.www._2000._09.xmldsig.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
