...
/**
 *  ConsultarNfseRpsResposta bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ConsultarNfseRpsResposta implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ConsultarNfseRpsResposta", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
    ...
    public static class Factory {
         ...
         */
        public static ConsultarNfseRpsResposta parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ConsultarNfseRpsResposta object = new ConsultarNfseRpsResposta();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ConsultarNfseRpsResposta".equals(type)) {
                            ...
                            return (ConsultarNfseRpsResposta) org.w3.www._2000._09.xmldsig.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
