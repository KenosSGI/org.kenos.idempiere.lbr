...
/**
 *  TcDadosPrestador bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class TcDadosPrestador implements org.apache.axis2.databinding.ADBBean {
    ...
    /**
     * field for IdentificacaoPrestador
     */
    protected br.org.abrasf.www.nfse_xsd.TcIdentificacaoPrestador localIdentificacaoPrestador;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localIdentificacaoPrestadorTracker = false;
    ...
    public boolean isIdentificacaoPrestadorSpecified() {
        return localIdentificacaoPrestadorTracker;
    }
     ...
     */
    public br.org.abrasf.www.nfse_xsd.TcIdentificacaoPrestador getIdentificacaoPrestador() {
        return localIdentificacaoPrestador;
    }

    /**
     * Auto generated setter method
     * @param param IdentificacaoPrestador
     */
    public void setIdentificacaoPrestador(
        br.org.abrasf.www.nfse_xsd.TcIdentificacaoPrestador param) {
        localIdentificacaoPrestadorTracker = param != null;

        this.localIdentificacaoPrestador = param;
    }
    ...
    public boolean isNomeFantasiaSpecified() {
        return localNomeFantasiaTracker;
    }
    ...
    public void setNomeFantasia(java.lang.String param) {
        localNomeFantasiaTracker = param != null;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":tcDadosPrestador", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "tcDadosPrestador", xmlWriter);
            }
        }

        if (localIdentificacaoPrestadorTracker) {
            if (localIdentificacaoPrestador == null) {
                throw new org.apache.axis2.databinding.ADBException(
                    "IdentificacaoPrestador cannot be null!!");
            }

            localIdentificacaoPrestador.serialize(new javax.xml.namespace.QName(
                    "http://www.abrasf.org.br/nfse.xsd",
                    "IdentificacaoPrestador"), xmlWriter);
        }
        ...
        if (localNomeFantasiaTracker) {
            namespace = "http://www.abrasf.org.br/nfse.xsd";
            writeStartElement(null, namespace, "NomeFantasia", xmlWriter);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localIdentificacaoPrestadorTracker) {
            ...
            elementList.add(localIdentificacaoPrestador);
        }
        ...
        if (localNomeFantasiaTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://www.abrasf.org.br/nfse.xsd", "NomeFantasia"));
    ...
    public static class Factory {
         ...
         */
        public static TcDadosPrestador parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            TcDadosPrestador object = new TcDadosPrestador();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"tcDadosPrestador".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (TcDadosPrestador) org.w3.www._2000._09.xmldsig.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://www.abrasf.org.br/nfse.xsd",
                            "IdentificacaoPrestador").equals(reader.getName())) {
                    object.setIdentificacaoPrestador(br.org.abrasf.www.nfse_xsd.TcIdentificacaoPrestador.Factory.parse(
                            reader));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://www.abrasf.org.br/nfse.xsd", "NomeFantasia").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "NomeFantasia" +
                            "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setNomeFantasia(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
