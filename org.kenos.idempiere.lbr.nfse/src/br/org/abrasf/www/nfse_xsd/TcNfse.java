...
public class TcNfse implements org.apache.axis2.databinding.ADBBean {
     ...
     * field for InfNfse
     */
    protected br.org.abrasf.www.nfse_xsd.TcInfNfse localInfNfse;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localInfNfseTracker = false;
    ...
    public boolean isInfNfseSpecified() {
        return localInfNfseTracker;
    }

    /**
     * Auto generated getter method
     * @return br.org.abrasf.www.nfse_xsd.TcInfNfse
     */
    public br.org.abrasf.www.nfse_xsd.TcInfNfse getInfNfse() {
        return localInfNfse;
    }
     ...
     * @param param InfNfse
     */
    public void setInfNfse(br.org.abrasf.www.nfse_xsd.TcInfNfse param) {
        localInfNfseTracker = param != null;

        this.localInfNfse = param;
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":tcNfse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "tcNfse", xmlWriter);
        ...
        if (localInfNfseTracker) {
            if (localInfNfse == null) {
                throw new org.apache.axis2.databinding.ADBException(
                    "InfNfse cannot be null!!");
            }

            localInfNfse.serialize(new javax.xml.namespace.QName(
                    "http://www.abrasf.org.br/nfse.xsd", "InfNfse"), xmlWriter);
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localInfNfseTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://www.abrasf.org.br/nfse.xsd", "InfNfse"));
    ...
    public static class Factory {
         ...
         */
        public static TcNfse parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            TcNfse object = new TcNfse();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"tcNfse".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (TcNfse) org.w3.www._2000._09.xmldsig.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://www.abrasf.org.br/nfse.xsd", "InfNfse").equals(
                            reader.getName())) {
                    object.setInfNfse(br.org.abrasf.www.nfse_xsd.TcInfNfse.Factory.parse(
                            reader));
