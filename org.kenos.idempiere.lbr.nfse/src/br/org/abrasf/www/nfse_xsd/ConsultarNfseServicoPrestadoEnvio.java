/**
 * ConsultarNfseServicoPrestadoEnvio.java
 *
...
/**
 *  ConsultarNfseServicoPrestadoEnvio bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ConsultarNfseServicoPrestadoEnvio implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ConsultarNfseServicoPrestadoEnvio",
                    xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
    ...
    public static class Factory {
         ...
         */
        public static ConsultarNfseServicoPrestadoEnvio parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ConsultarNfseServicoPrestadoEnvio object = new ConsultarNfseServicoPrestadoEnvio();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ConsultarNfseServicoPrestadoEnvio".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ConsultarNfseServicoPrestadoEnvio) org.w3.www._2000._09.xmldsig.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
