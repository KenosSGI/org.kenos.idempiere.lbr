...
/**
 *  GerarNfseEnvio bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GerarNfseEnvio implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":GerarNfseEnvio", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "GerarNfseEnvio", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GerarNfseEnvio parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GerarNfseEnvio object = new GerarNfseEnvio();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GerarNfseEnvio".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GerarNfseEnvio) org.w3.www._2000._09.xmldsig.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
