...
/**
 *  Cabecalho bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class Cabecalho implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":cabecalho", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "cabecalho", xmlWriter);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localVersaoDadosTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://www.abrasf.org.br/nfse.xsd", "versaoDados"));
    ...
    public static class Factory {
         ...
         */
        public static Cabecalho parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            Cabecalho object = new Cabecalho();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"cabecalho".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (Cabecalho) org.w3.www._2000._09.xmldsig.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://www.abrasf.org.br/nfse.xsd", "versaoDados").equals(
                            reader.getName())) {
