...
/**
 *  TcIdentificacaoRps bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class TcIdentificacaoRps implements org.apache.axis2.databinding.ADBBean {
     ...
     * @param param Tipo
     */
    public void setTipo(byte param) {
        // setting primitive attribute tracker to true
        localTipoTracker = param != java.lang.Byte.MIN_VALUE;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":tcIdentificacaoRps", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "tcIdentificacaoRps", xmlWriter);
            }
        }
        ...
        if (localTipoTracker) {
            ...
            if (localTipo == java.lang.Byte.MIN_VALUE) {
                throw new org.apache.axis2.databinding.ADBException(
                    "Tipo cannot be null!!");
            } else {
                xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localSerieTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://www.abrasf.org.br/nfse.xsd", "Serie"));
        ...
        if (localTipoTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://www.abrasf.org.br/nfse.xsd", "Tipo"));
    ...
    public static class Factory {
         ...
         */
        public static TcIdentificacaoRps parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            TcIdentificacaoRps object = new TcIdentificacaoRps();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"tcIdentificacaoRps".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (TcIdentificacaoRps) org.w3.www._2000._09.xmldsig.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://www.abrasf.org.br/nfse.xsd", "Serie").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "Serie" + "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setSerie(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://www.abrasf.org.br/nfse.xsd", "Tipo").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    object.setTipo(org.apache.axis2.databinding.utils.ConverterUtil.convertToByte(
                            content));
                    ...
                    object.setTipo(java.lang.Byte.MIN_VALUE);
                }
