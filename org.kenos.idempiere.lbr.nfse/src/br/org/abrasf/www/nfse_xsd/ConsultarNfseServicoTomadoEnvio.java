/**
 * ConsultarNfseServicoTomadoEnvio.java
 *
...
/**
 *  ConsultarNfseServicoTomadoEnvio bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ConsultarNfseServicoTomadoEnvio implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ConsultarNfseServicoTomadoEnvio",
                    xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ConsultarNfseServicoTomadoEnvio", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ConsultarNfseServicoTomadoEnvio parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ConsultarNfseServicoTomadoEnvio object = new ConsultarNfseServicoTomadoEnvio();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ConsultarNfseServicoTomadoEnvio".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ConsultarNfseServicoTomadoEnvio) org.w3.www._2000._09.xmldsig.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
