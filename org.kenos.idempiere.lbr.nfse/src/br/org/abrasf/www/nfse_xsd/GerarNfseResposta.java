...
/**
 *  GerarNfseResposta bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GerarNfseResposta implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":GerarNfseResposta", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "GerarNfseResposta", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GerarNfseResposta parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GerarNfseResposta object = new GerarNfseResposta();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GerarNfseResposta".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GerarNfseResposta) org.w3.www._2000._09.xmldsig.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
