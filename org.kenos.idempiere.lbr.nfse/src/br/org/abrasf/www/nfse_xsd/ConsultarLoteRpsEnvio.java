...
/**
 *  ConsultarLoteRpsEnvio bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ConsultarLoteRpsEnvio implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ConsultarLoteRpsEnvio", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ConsultarLoteRpsEnvio", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ConsultarLoteRpsEnvio parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ConsultarLoteRpsEnvio object = new ConsultarLoteRpsEnvio();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ConsultarLoteRpsEnvio".equals(type)) {
                            ...
                            return (ConsultarLoteRpsEnvio) org.w3.www._2000._09.xmldsig.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
