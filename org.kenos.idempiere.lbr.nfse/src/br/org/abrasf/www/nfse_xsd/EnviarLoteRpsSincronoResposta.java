/**
 * EnviarLoteRpsSincronoResposta.java
 *
...
/**
 *  EnviarLoteRpsSincronoResposta bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class EnviarLoteRpsSincronoResposta implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":EnviarLoteRpsSincronoResposta",
                    xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "EnviarLoteRpsSincronoResposta", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static EnviarLoteRpsSincronoResposta parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            EnviarLoteRpsSincronoResposta object = new EnviarLoteRpsSincronoResposta();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"EnviarLoteRpsSincronoResposta".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (EnviarLoteRpsSincronoResposta) org.w3.www._2000._09.xmldsig.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
