/**
 * TcIdentificacaoOrgaoGerador.java
 *
...
/**
 *  TcIdentificacaoOrgaoGerador bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class TcIdentificacaoOrgaoGerador implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":tcIdentificacaoOrgaoGerador", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "tcIdentificacaoOrgaoGerador", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static TcIdentificacaoOrgaoGerador parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            TcIdentificacaoOrgaoGerador object = new TcIdentificacaoOrgaoGerador();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"tcIdentificacaoOrgaoGerador".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (TcIdentificacaoOrgaoGerador) org.w3.www._2000._09.xmldsig.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
