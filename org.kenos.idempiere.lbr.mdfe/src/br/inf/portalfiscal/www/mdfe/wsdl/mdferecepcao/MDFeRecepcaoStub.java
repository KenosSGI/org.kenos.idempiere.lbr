/**
 * MDFeRecepcaoStub.java This file was auto-generated from WSDL by the Apache
...
public class MDFeRecepcaoStub extends org.apache.axis2.client.Stub
{
	...
	private void populateAxisService() throws org.apache.axis2.AxisFault
	{
		...
		_service = new org.apache.axis2.description.AxisService("MDFeRecepcao"
				+ getUniqueSuffix());
	 ...
	 */
	public MDFeRecepcaoStub(java.lang.String targetEndpoint)
			throws org.apache.axis2.AxisFault
	{
	...
	public br.inf.portalfiscal.www.mdfe.wsdl.mdferecepcao.MDFeRecepcaoStub.MdfeRecepcaoLoteResult mdfeRecepcaoLote(
			...
			br.inf.portalfiscal.www.mdfe.wsdl.mdferecepcao.MDFeRecepcaoStub.MdfeDadosMsg mdfeDadosMsg0,
			br.inf.portalfiscal.www.mdfe.wsdl.mdferecepcao.MDFeRecepcaoStub.MdfeCabecMsgE mdfeCabecMsg1)
...

	{
		...
		try
		{
			...
			_operationClient
					.getOptions()
					.setAction(
							"http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeRecepcao/mdfeRecepcaoLote");
			...
			env = toEnvelope(getFactory(_operationClient.getOptions()
					...
					optimizeContent(new javax.xml.namespace.QName(
							"http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeRecepcao",
							"mdfeRecepcaoLote")), new javax.xml.namespace.QName(
							"http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeRecepcao",
							"mdfeRecepcaoLote"));
			...
			if (faultElt != null)
			{
				if (faultExceptionNameMap
						.containsKey(new org.apache.axis2.client.FaultMapKey(
								faultElt.getQName(), "mdfeRecepcaoLote")))
				{
	...
	throws java.rmi.RemoteException
	{
		...
		if (mdfeCabecMsg1 != null)
		{
			...
			org.apache.axiom.om.OMElement omElementmdfeCabecMsg1 = toOM(
					mdfeCabecMsg1, optimizeContent(new javax.xml.namespace.QName(
							"http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeRecepcao",
							"mdfeRecepcaoLote")));
			addHeader(omElementmdfeCabecMsg1, env);
				...
				.setCallback(new org.apache.axis2.client.async.AxisCallback()
				{
							...
							org.apache.axis2.context.MessageContext resultContext)
					{
						try
						{
							...
							callback.receiveResultmdfeRecepcaoLote((br.inf.portalfiscal.www.mdfe.wsdl.mdferecepcao.MDFeRecepcaoStub.MdfeRecepcaoLoteResult) object);
							...
							if (faultElt != null)
							{
												...
												"mdfeRecepcaoLote")))
								{
									...
									try
									{
										...
										callback.receiveErrormdfeRecepcaoLote(new java.rmi.RemoteException(
												ex.getMessage(), ex));
									}
									catch (java.lang.ClassCastException e)
									{
	...
	// https://mdfe-hml.sefaz.rs.gov.br/WS/mdferecepcao/MDFerecepcao.asmx
			...
			org.apache.axis2.databinding.ADBBean
	{
		...
		{
			if (namespace
					.equals("http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeRecepcao"))
			{
				return "ns1";
			}
	...
	public static class ExtensionMapper
	{
				...
				throws java.lang.Exception
		{
			...
			if ("http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeRecepcao"
	...
	public static class MdfeCabecMsg implements org.apache.axis2.databinding.ADBBean
	{
		 ...
		 * http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeRecepcao Namespace
		 * Prefix = ns1
		 */
	...
	public static class MdfeRecepcaoLoteResult implements
			org.apache.axis2.databinding.ADBBean
	{

		public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
				"http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeRecepcao",
				"mdfeRecepcaoLoteResult", "ns1");
				...
				org.apache.axis2.databinding.ADBException
		{
			...
			if (serializeType)
			{
						...
						&& (namespacePrefix.trim().length() > 0))
				{
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance", "type",
							namespacePrefix + ":mdfeRecepcaoLoteResult", xmlWriter);
				}
				else
				{
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance", "type",
							"mdfeRecepcaoLoteResult", xmlWriter);
				}
		...
		public static class Factory
		{
			 ...
			 * positioned at the end element of its outer element
			 */
			public static MdfeRecepcaoLoteResult parse(
						...
						if (fullTypeName != null)
						{
							...
							if (!"mdfeRecepcaoLoteResult".equals(type))
							{
								...
								java.lang.String nsUri = reader
										.getNamespaceContext().getNamespaceURI(
												nsPrefix);
								return (MdfeRecepcaoLoteResult) ExtensionMapper
	...
	private org.apache.axiom.om.OMElement toOM(
			br.inf.portalfiscal.www.mdfe.wsdl.mdferecepcao.MDFeRecepcaoStub.MdfeDadosMsg param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault
	{
		...
		try
		{
			return param
					.getOMElement(
							br.inf.portalfiscal.www.mdfe.wsdl.mdferecepcao.MDFeRecepcaoStub.MdfeDadosMsg.MY_QNAME,
	...
	private org.apache.axiom.om.OMElement toOM(
			br.inf.portalfiscal.www.mdfe.wsdl.mdferecepcao.MDFeRecepcaoStub.MdfeRecepcaoLoteResult param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault
	{
		...
		try
		{
			return param
					.getOMElement(
							br.inf.portalfiscal.www.mdfe.wsdl.mdferecepcao.MDFeRecepcaoStub.MdfeRecepcaoLoteResult.MY_QNAME,
							org.apache.axiom.om.OMAbstractFactory.getOMFactory());
		}
		catch (org.apache.axis2.databinding.ADBException e)
		{
	...
	private org.apache.axiom.om.OMElement toOM(
			br.inf.portalfiscal.www.mdfe.wsdl.mdferecepcao.MDFeRecepcaoStub.MdfeCabecMsgE param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault
	{
		...
		try
		{
			return param
					.getOMElement(
							br.inf.portalfiscal.www.mdfe.wsdl.mdferecepcao.MDFeRecepcaoStub.MdfeCabecMsgE.MY_QNAME,
							org.apache.axiom.om.OMAbstractFactory.getOMFactory());
		}
		catch (org.apache.axis2.databinding.ADBException e)
		{
			...
			throws org.apache.axis2.AxisFault
	{
		...
		try
		{
			...
			if (br.inf.portalfiscal.www.mdfe.wsdl.mdferecepcao.MDFeRecepcaoStub.MdfeDadosMsg.class
					.equals(type))
			{

				return br.inf.portalfiscal.www.mdfe.wsdl.mdferecepcao.MDFeRecepcaoStub.MdfeDadosMsg.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());

			}

			if (br.inf.portalfiscal.www.mdfe.wsdl.mdferecepcao.MDFeRecepcaoStub.MdfeRecepcaoLoteResult.class
					.equals(type))
			{

				return br.inf.portalfiscal.www.mdfe.wsdl.mdferecepcao.MDFeRecepcaoStub.MdfeRecepcaoLoteResult.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());

			}

			if (br.inf.portalfiscal.www.mdfe.wsdl.mdferecepcao.MDFeRecepcaoStub.MdfeCabecMsgE.class
					.equals(type))
			{

				return br.inf.portalfiscal.www.mdfe.wsdl.mdferecepcao.MDFeRecepcaoStub.MdfeCabecMsgE.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());
