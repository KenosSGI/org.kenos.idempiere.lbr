/**
 * MDFeRecepcaoEventoStub.java This file was auto-generated from WSDL by the
...
public class MDFeRecepcaoEventoStub extends org.apache.axis2.client.Stub
{
	...
	private void populateAxisService() throws org.apache.axis2.AxisFault
	{
		...
		_service = new org.apache.axis2.description.AxisService("MDFeRecepcaoEvento"
				+ getUniqueSuffix());
	 ...
	 */
	public MDFeRecepcaoEventoStub(java.lang.String targetEndpoint)
			throws org.apache.axis2.AxisFault
	{
	...
	public br.inf.portalfiscal.www.mdfe.wsdl.mdferecepcaoevento.MDFeRecepcaoEventoStub.MdfeRecepcaoEventoResult mdfeRecepcaoEvento(
			...
			br.inf.portalfiscal.www.mdfe.wsdl.mdferecepcaoevento.MDFeRecepcaoEventoStub.MdfeDadosMsg mdfeDadosMsg0,
			br.inf.portalfiscal.www.mdfe.wsdl.mdferecepcaoevento.MDFeRecepcaoEventoStub.MdfeCabecMsgE mdfeCabecMsg1)
			...
			if (faultElt != null)
			{
				if (faultExceptionNameMap
						.containsKey(new org.apache.axis2.client.FaultMapKey(
								faultElt.getQName(), "mdfeRecepcaoEvento")))
				{
				...
				.setCallback(new org.apache.axis2.client.async.AxisCallback()
				{
							...
							org.apache.axis2.context.MessageContext resultContext)
					{
						try
						{
							...
							callback.receiveResultmdfeRecepcaoEvento((br.inf.portalfiscal.www.mdfe.wsdl.mdferecepcaoevento.MDFeRecepcaoEventoStub.MdfeRecepcaoEventoResult) object);
							...
							if (faultElt != null)
							{
												...
												"mdfeRecepcaoEvento")))
								{
									...
									try
									{
										...
										callback.receiveErrormdfeRecepcaoEvento(new java.rmi.RemoteException(
												ex.getMessage(), ex));
									}
									catch (java.lang.ClassCastException e)
									{
	...
	// https://mdfe-hml.sefaz.rs.gov.br/WS/mdferecepcaoevento/MDFerecepcaoevento.asmx
			...
			org.apache.axis2.databinding.ADBBean
	{
		...
		{
			if (namespace
					.equals("http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeRecepcaoEvento"))
			{
				return "ns1";
			}
	...
	public static class MdfeCabecMsg implements org.apache.axis2.databinding.ADBBean
	{
		 ...
		 * http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeRecepcaoEvento Namespace
		 * Prefix = ns1
		 */
	...
	public static class ExtensionMapper
	{
				...
				throws java.lang.Exception
		{
			...
			if ("http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeRecepcaoEvento"
	...
	public static class MdfeRecepcaoEventoResult implements
			org.apache.axis2.databinding.ADBBean
	{

		public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
				"http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeRecepcaoEvento",
				"mdfeRecepcaoEventoResult", "ns1");
				...
				org.apache.axis2.databinding.ADBException
		{
			...
			if (serializeType)
			{
						...
						&& (namespacePrefix.trim().length() > 0))
				{
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance", "type",
							namespacePrefix + ":mdfeRecepcaoEventoResult", xmlWriter);
				}
				else
				{
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance", "type",
							"mdfeRecepcaoEventoResult", xmlWriter);
				}
		...
		public static class Factory
		{
			 ...
			 * positioned at the end element of its outer element
			 */
			public static MdfeRecepcaoEventoResult parse(
						...
						if (fullTypeName != null)
						{
							...
							if (!"mdfeRecepcaoEventoResult".equals(type))
							{
								...
								java.lang.String nsUri = reader
										.getNamespaceContext().getNamespaceURI(
												nsPrefix);
								return (MdfeRecepcaoEventoResult) ExtensionMapper
	...
	private org.apache.axiom.om.OMElement toOM(
			br.inf.portalfiscal.www.mdfe.wsdl.mdferecepcaoevento.MDFeRecepcaoEventoStub.MdfeDadosMsg param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault
	{
		...
		try
		{
			return param
					.getOMElement(
							br.inf.portalfiscal.www.mdfe.wsdl.mdferecepcaoevento.MDFeRecepcaoEventoStub.MdfeDadosMsg.MY_QNAME,
	...
	private org.apache.axiom.om.OMElement toOM(
			br.inf.portalfiscal.www.mdfe.wsdl.mdferecepcaoevento.MDFeRecepcaoEventoStub.MdfeRecepcaoEventoResult param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault
	{
		...
		try
		{
			return param
					.getOMElement(
							br.inf.portalfiscal.www.mdfe.wsdl.mdferecepcaoevento.MDFeRecepcaoEventoStub.MdfeRecepcaoEventoResult.MY_QNAME,
							org.apache.axiom.om.OMAbstractFactory.getOMFactory());
		}
		catch (org.apache.axis2.databinding.ADBException e)
		{
	...
	private org.apache.axiom.om.OMElement toOM(
			br.inf.portalfiscal.www.mdfe.wsdl.mdferecepcaoevento.MDFeRecepcaoEventoStub.MdfeCabecMsgE param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault
	{
		...
		try
		{
			return param
					.getOMElement(
							br.inf.portalfiscal.www.mdfe.wsdl.mdferecepcaoevento.MDFeRecepcaoEventoStub.MdfeCabecMsgE.MY_QNAME,
							org.apache.axiom.om.OMAbstractFactory.getOMFactory());
		}
		catch (org.apache.axis2.databinding.ADBException e)
		{
			...
			throws org.apache.axis2.AxisFault
	{
		...
		try
		{
			...
			if (br.inf.portalfiscal.www.mdfe.wsdl.mdferecepcaoevento.MDFeRecepcaoEventoStub.MdfeDadosMsg.class
					.equals(type))
			{

				return br.inf.portalfiscal.www.mdfe.wsdl.mdferecepcaoevento.MDFeRecepcaoEventoStub.MdfeDadosMsg.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());

			}

			if (br.inf.portalfiscal.www.mdfe.wsdl.mdferecepcaoevento.MDFeRecepcaoEventoStub.MdfeRecepcaoEventoResult.class
					.equals(type))
			{

				return br.inf.portalfiscal.www.mdfe.wsdl.mdferecepcaoevento.MDFeRecepcaoEventoStub.MdfeRecepcaoEventoResult.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());

			}

			if (br.inf.portalfiscal.www.mdfe.wsdl.mdferecepcaoevento.MDFeRecepcaoEventoStub.MdfeCabecMsgE.class
					.equals(type))
			{

				return br.inf.portalfiscal.www.mdfe.wsdl.mdferecepcaoevento.MDFeRecepcaoEventoStub.MdfeCabecMsgE.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());
