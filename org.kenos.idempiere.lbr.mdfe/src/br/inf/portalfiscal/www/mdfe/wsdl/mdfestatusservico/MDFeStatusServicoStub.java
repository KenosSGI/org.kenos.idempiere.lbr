/**
 * MDFeStatusServicoStub.java This file was auto-generated from WSDL by the
...
public class MDFeStatusServicoStub extends org.apache.axis2.client.Stub
{
	...
	private void populateAxisService() throws org.apache.axis2.AxisFault
	{
		...
		_service = new org.apache.axis2.description.AxisService("MDFeStatusServico"
				+ getUniqueSuffix());
	 ...
	 */
	public MDFeStatusServicoStub(java.lang.String targetEndpoint)
			throws org.apache.axis2.AxisFault
	{
	...
	public br.inf.portalfiscal.www.mdfe.wsdl.mdfestatusservico.MDFeStatusServicoStub.MdfeStatusServicoMDFResult mdfeStatusServicoMDF(
			...
			br.inf.portalfiscal.www.mdfe.wsdl.mdfestatusservico.MDFeStatusServicoStub.MdfeDadosMsg mdfeDadosMsg0,
			br.inf.portalfiscal.www.mdfe.wsdl.mdfestatusservico.MDFeStatusServicoStub.MdfeCabecMsgE mdfeCabecMsg1)
			...
			if (faultElt != null)
			{
				if (faultExceptionNameMap
						.containsKey(new org.apache.axis2.client.FaultMapKey(
								faultElt.getQName(), "mdfeStatusServicoMDF")))
				{
				...
				.setCallback(new org.apache.axis2.client.async.AxisCallback()
				{
							...
							org.apache.axis2.context.MessageContext resultContext)
					{
						try
						{
							...
							callback.receiveResultmdfeStatusServicoMDF((br.inf.portalfiscal.www.mdfe.wsdl.mdfestatusservico.MDFeStatusServicoStub.MdfeStatusServicoMDFResult) object);
							...
							if (faultElt != null)
							{
												...
												"mdfeStatusServicoMDF")))
								{
									...
									try
									{
										...
										callback.receiveErrormdfeStatusServicoMDF(new java.rmi.RemoteException(
												ex.getMessage(), ex));
									}
									catch (java.lang.ClassCastException e)
									{
	...
	// https://mdfe-hml.sefaz.rs.gov.br/WS/mdfestatusservico/MDFeStatusServico.asmx
	public static class MdfeDadosMsg implements org.apache.axis2.databinding.ADBBean
	{
		...
		{
			if (namespace
					.equals("http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeStatusServico"))
			{
				return "ns1";
			}
	...
	public static class ExtensionMapper
	{
				...
				throws java.lang.Exception
		{
			...
			if ("http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeStatusServico"
	...
	public static class MdfeCabecMsg implements org.apache.axis2.databinding.ADBBean
	{
		 ...
		 * http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeStatusServico Namespace
		 * Prefix = ns1
		 */
	...
	public static class MdfeStatusServicoMDFResult implements
			org.apache.axis2.databinding.ADBBean
	{

		public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
				"http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeStatusServico",
				"mdfeStatusServicoMDFResult", "ns1");
				...
				org.apache.axis2.databinding.ADBException
		{
			...
			if (serializeType)
			{
				...
				else
				{
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance", "type",
							"mdfeStatusServicoMDFResult", xmlWriter);
				}
		...
		public static class Factory
		{
			 ...
			 * positioned at the end element of its outer element
			 */
			public static MdfeStatusServicoMDFResult parse(
					javax.xml.stream.XMLStreamReader reader)
					throws java.lang.Exception
			{
				MdfeStatusServicoMDFResult object = new MdfeStatusServicoMDFResult();
						...
						if (fullTypeName != null)
						{
							...
							if (!"mdfeStatusServicoMDFResult".equals(type))
							{
								...
								java.lang.String nsUri = reader
										.getNamespaceContext().getNamespaceURI(
												nsPrefix);
								return (MdfeStatusServicoMDFResult) ExtensionMapper
	...
	private org.apache.axiom.om.OMElement toOM(
			br.inf.portalfiscal.www.mdfe.wsdl.mdfestatusservico.MDFeStatusServicoStub.MdfeDadosMsg param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault
	{
		...
		try
		{
			return param
					.getOMElement(
							br.inf.portalfiscal.www.mdfe.wsdl.mdfestatusservico.MDFeStatusServicoStub.MdfeDadosMsg.MY_QNAME,
	...
	private org.apache.axiom.om.OMElement toOM(
			br.inf.portalfiscal.www.mdfe.wsdl.mdfestatusservico.MDFeStatusServicoStub.MdfeStatusServicoMDFResult param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault
	{
		...
		try
		{
			return param
					.getOMElement(
							br.inf.portalfiscal.www.mdfe.wsdl.mdfestatusservico.MDFeStatusServicoStub.MdfeStatusServicoMDFResult.MY_QNAME,
							org.apache.axiom.om.OMAbstractFactory.getOMFactory());
		}
		catch (org.apache.axis2.databinding.ADBException e)
		{
	...
	private org.apache.axiom.om.OMElement toOM(
			br.inf.portalfiscal.www.mdfe.wsdl.mdfestatusservico.MDFeStatusServicoStub.MdfeCabecMsgE param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault
	{
		...
		try
		{
			return param
					.getOMElement(
							br.inf.portalfiscal.www.mdfe.wsdl.mdfestatusservico.MDFeStatusServicoStub.MdfeCabecMsgE.MY_QNAME,
							org.apache.axiom.om.OMAbstractFactory.getOMFactory());
		}
		catch (org.apache.axis2.databinding.ADBException e)
		{
			...
			throws org.apache.axis2.AxisFault
	{
		...
		try
		{
			...
			if (br.inf.portalfiscal.www.mdfe.wsdl.mdfestatusservico.MDFeStatusServicoStub.MdfeDadosMsg.class
					.equals(type))
			{

				return br.inf.portalfiscal.www.mdfe.wsdl.mdfestatusservico.MDFeStatusServicoStub.MdfeDadosMsg.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());

			}

			if (br.inf.portalfiscal.www.mdfe.wsdl.mdfestatusservico.MDFeStatusServicoStub.MdfeStatusServicoMDFResult.class
					.equals(type))
			{

				return br.inf.portalfiscal.www.mdfe.wsdl.mdfestatusservico.MDFeStatusServicoStub.MdfeStatusServicoMDFResult.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());

			}

			if (br.inf.portalfiscal.www.mdfe.wsdl.mdfestatusservico.MDFeStatusServicoStub.MdfeCabecMsgE.class
					.equals(type))
			{

				return br.inf.portalfiscal.www.mdfe.wsdl.mdfestatusservico.MDFeStatusServicoStub.MdfeCabecMsgE.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());
