			...
			else if (nfl.getICMSTax() != null)
			{
				...
				else if (CST_ICMS_10.equals (taxStatus))
				{
					if (icmsSTTax != null)
					{
						...
						if (fcpTaxST != null)
						{
							icms10.setVBCFCPST(normalize(fcpTaxST.getlbr_TaxBaseAmt()));
							icms10.setPFCPST(normalize2to4(fcpTaxST.getlbr_TaxRate()));
							icms10.setVFCPST(normalize(fcpTaxST.getlbr_TaxAmt()));
						}
					}
				}
				...
				else if (CST_ICMS_30.equals (taxStatus))
				{
					if (icmsSTTax != null)
					{
						...
						if (fcpTaxST != null)
						{
							icms30.setVBCFCPST(normalize4(fcpTaxST.getlbr_TaxBaseAmt()));
							icms30.setPFCPST(normalize2to4(fcpTaxST.getlbr_TaxRate()));
							icms30.setVFCPST(normalize4(fcpTaxST.getlbr_TaxAmt()));
						}
					}
				}
				...
				else if (CST_ICMS_60.equals (taxStatus))
				{
					...
					if (icmsSTTax != null)
					{
						...
						icms60.setVICMSSubstituto(normalize (icmsTax.getlbr_TaxAmt()));
...
//		RetTrib retTrib = total.addNewRetTrib();
		...
		if (!nfce)
		{
			...
			if (FIN_NFE_NORMAL.equals (ide.getFinNFe()) && nf.islbr_IsOwnDocument() && nf.getC_Invoice_ID() > 0 && nf.islbr_HasOpenItems())
			{
