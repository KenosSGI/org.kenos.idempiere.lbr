	...
	implements ActionListener
{
	...
	void jbInit() throws Exception
	{
		...
		getAddress.setText("Pesquisar CEP");
...
//		fCountry.addActionListener(this);
		if (country != null && country.getC_Country_ID() != 139) // BRAZIL
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		else if (e.getSource() == getAddress)
		{
			...
			{
				if (!"".equals(fAddress1.getText())
						|| !"".equals(fAddress2.getText())
						|| !"".equals(fAddress3.getText())
						|| !"".equals(fAddress4.getText())
						|| !"".equals(fCity.getText()))
				{
