...
-- 11/06/2018 9h53min5s BRT
-- NF-e 4.0
UPDATE AD_Ref_List SET Name='Bill (deactivated)',Updated=TO_TIMESTAMP('2018-06-11 09:53:05','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Ref_List_ID=1000063
;

-- 11/06/2018 9h53min9s BRT
-- NF-e 4.0
UPDATE AD_Ref_List SET Name='Check (deactivated)',Updated=TO_TIMESTAMP('2018-06-11 09:53:09','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Ref_List_ID=1000062
;

-- 11/06/2018 9h53min13s BRT
-- NF-e 4.0
UPDATE AD_Ref_List SET Name='Direct Deposit (deactivated)',Updated=TO_TIMESTAMP('2018-06-11 09:53:13','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Ref_List_ID=1000064
;

-- 11/06/2018 9h53min17s BRT
-- NF-e 4.0
UPDATE AD_Ref_List SET Name='Cash (deactivated)',Updated=TO_TIMESTAMP('2018-06-11 09:53:17','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Ref_List_ID=1000061
;
