...
WHERE pg.LBR_ProductionGroup_ID=@LBR_ProductionGroup_ID@)',0,0,'Y',TO_TIMESTAMP('2018-05-21 17:48:08','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2018-05-21 17:48:08','YYYY-MM-DD HH24:MI:SS'),100,'N','LBRA','1c650081-b111-4a19-88db-9b7a78dbb3bb')
;

-- 21/05/2018 17h48min49s BRT
INSERT INTO AD_Reference (AD_Reference_ID,Name,Description,ValidationType,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,EntityType,IsOrderByValue,AD_Reference_UU) VALUES (1120267,'Nota Fiscal (SO) <-> Production Group','Finds Production Group From Nota Fiscal (SO)','T',0,0,'Y',TO_TIMESTAMP('2018-05-21 17:48:49','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2018-05-21 17:48:49','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','N','65e23a7d-aa8b-4455-a8ca-fcad8829516d')
;
...
WHERE nf.LBR_NotaFiscal_ID = @LBR_NotaFiscal_ID@)',0,0,'Y',TO_TIMESTAMP('2018-05-21 17:52:41','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2018-05-21 17:52:41','YYYY-MM-DD HH24:MI:SS'),100,'N','LBRA','c0211ce0-7359-450e-96a9-49ead79da11c')
;

-- 21/05/2018 17h52min53s BRT
INSERT INTO AD_RelationType (AD_Client_ID,AD_Org_ID,AD_RelationType_ID,Created,CreatedBy,IsActive,Name,Updated,UpdatedBy,AD_Reference_Source_ID,AD_Reference_Target_ID,IsDirected,Type,AD_RelationType_UU) VALUES (0,0,1120003,TO_TIMESTAMP('2018-05-21 17:52:52','YYYY-MM-DD HH24:MI:SS'),100,'Y','Production Group <-> Nota Fiscal (SO)',TO_TIMESTAMP('2018-05-21 17:52:52','YYYY-MM-DD HH24:MI:SS'),100,1120266,1120267,'N','I','a826f927-ae1e-4389-ab30-8e68d6f213f6')
;
