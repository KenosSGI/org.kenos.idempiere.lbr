...
INSERT INTO AD_InfoColumn (AD_InfoColumn_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,Name,Description,AD_InfoWindow_ID,EntityType,SelectClause,SeqNo,IsDisplayed,IsQueryCriteria,AD_Element_ID,AD_Reference_ID,AD_InfoColumn_UU,IsCentrallyMaintained,ColumnName,QueryOperator,IsIdentifier,SeqNoSelection,IsMandatory,IsKey) VALUES (1120007,0,0,'Y',TO_TIMESTAMP('2017-09-06 13:10:08','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2017-09-06 13:10:08','YYYY-MM-DD HH24:MI:SS'),100,'NFe ID','Identification of NFe',1120000,'LBRA','nf.lbr_NFeID',50,'Y','N',1100017,10,'844de5ed-1894-47e8-b059-734add3048f0','Y','lbr_NFeID','=','N',0,'N','N')
;

-- 06/09/2017 13h10min22s BRT
INSERT INTO AD_InfoColumn (AD_InfoColumn_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,Name,Description,Help,AD_InfoWindow_ID,EntityType,SelectClause,SeqNo,IsDisplayed,IsQueryCriteria,AD_Element_ID,AD_Reference_ID,AD_InfoColumn_UU,IsCentrallyMaintained,ColumnName,QueryOperator,IsIdentifier,SeqNoSelection,IsMandatory,IsKey) VALUES (1120008,0,0,'Y',TO_TIMESTAMP('2017-09-06 13:10:21','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2017-09-06 13:10:21','YYYY-MM-DD HH24:MI:SS'),100,'Grand Total','Total amount of document','The Grand Total displays the total amount including Tax and Freight in document currency',1120000,'LBRA','nf.GrandTotal',60,'Y','N',316,12,'5b6bfce5-a8ce-4eac-8c76-bfaa286695ae','Y','GrandTotal','=','N',0,'N','N')
;

-- 06/09/2017 13h10min43s BRT
INSERT INTO AD_InfoColumn (AD_InfoColumn_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,Name,Description,Help,AD_InfoWindow_ID,EntityType,SelectClause,SeqNo,IsDisplayed,IsQueryCriteria,AD_Element_ID,AD_Reference_ID,AD_InfoColumn_UU,IsCentrallyMaintained,ColumnName,QueryOperator,IsIdentifier,SeqNoSelection,IsMandatory,IsKey) VALUES (1120009,0,0,'Y',TO_TIMESTAMP('2017-09-06 13:10:43','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2017-09-06 13:10:43','YYYY-MM-DD HH24:MI:SS'),100,'Sales Transaction','This is a Sales Transaction','The Sales Transaction checkbox indicates if this item is a Sales Transaction.',1120000,'LBRA','nf.IsSOTrx',70,'Y','N',1106,20,'8d141d24-7a04-4080-beef-92bd30467bf3','Y','IsSOTrx','=','N',0,'N','N')
;

-- 06/09/2017 13h10min49s BRT
UPDATE AD_InfoColumn SET EntityType='LBRA',Updated=TO_TIMESTAMP('2017-09-06 13:10:49','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_InfoColumn_ID=1120005
;

-- 06/09/2017 13h10min54s BRT
UPDATE AD_InfoColumn SET EntityType='LBRA',Updated=TO_TIMESTAMP('2017-09-06 13:10:54','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_InfoColumn_ID=1120004
;
