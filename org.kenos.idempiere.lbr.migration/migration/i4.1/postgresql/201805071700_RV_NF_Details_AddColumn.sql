...
2 - NFe complementar
3 - NFe de ajuste
4 - Devolução/Retorno de Mercadoria',1120566,'lbr_FinNFe','1',1,'N','N','N','N','N',0,'N',17,1100012,0,0,'Y',TO_TIMESTAMP('2018-05-07 15:12:35','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2018-05-07 15:12:35','YYYY-MM-DD HH24:MI:SS'),100,1100066,'Y','N',NULL,'LBRA','N','N','N','Y','9684d04c-fda3-470c-9f60-d75eaa4d4846','Y',0,'N','N')
;

-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
-- 07/05/2018 15h37min46s BRT
INSERT INTO AD_Column (AD_Column_ID,Version,Name,Description,AD_Table_ID,ColumnName,FieldLength,IsKey,IsParent,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsEncrypted,AD_Reference_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,AD_Element_ID,IsUpdateable,IsSelectionColumn,ReadOnlyLogic,EntityType,IsSyncDatabase,IsAlwaysUpdateable,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsAllowCopy,SeqNoSelection,IsToolbarButton,IsSecure) VALUES (1130245,0,'NFe ID','Identification of NFe',1120566,'lbr_NFeID',255,'N','N','N','N','N',0,'N',10,0,0,'Y',TO_TIMESTAMP('2018-05-07 15:37:45','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2018-05-07 15:37:45','YYYY-MM-DD HH24:MI:SS'),100,1100017,'Y','N',NULL,'LBRA','N','N','N','Y','80a95b3f-40cf-4dca-85ed-c312d221ef94','Y',0,'N','N')
;

-- 07/05/2018 15h38min18s BRT
INSERT INTO AD_Column (AD_Column_ID,Version,Name,Description,Help,AD_Table_ID,ColumnName,FieldLength,IsKey,IsParent,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsEncrypted,AD_Reference_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,AD_Element_ID,IsUpdateable,IsSelectionColumn,ReadOnlyLogic,EntityType,IsSyncDatabase,IsAlwaysUpdateable,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsAllowCopy,SeqNoSelection,IsToolbarButton,IsSecure) VALUES (1130247,0,'CFOP Note','Defines the CFOP Note','Defines the CFOP Note',1120566,'lbr_CFOPNote',300,'N','N','N','N','N',0,'N',10,0,0,'Y',TO_TIMESTAMP('2018-05-07 15:38:17','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2018-05-07 15:38:17','YYYY-MM-DD HH24:MI:SS'),100,1000280,'Y','N',NULL,'LBRA','N','N','Y','Y','26ae44a1-1124-4b92-9df4-721fd7e342fc','Y',0,'N','N')
;

-- 07/05/2018 15h38min50s BRT
INSERT INTO AD_Column (AD_Column_ID,Version,Name,Description,Help,AD_Table_ID,ColumnName,FieldLength,IsKey,IsParent,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsEncrypted,AD_Reference_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,AD_Element_ID,IsUpdateable,IsSelectionColumn,EntityType,IsSyncDatabase,IsAlwaysUpdateable,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsAllowCopy,SeqNoSelection,IsToolbarButton,IsSecure) VALUES (1130248,0,'Order','Order','The Order is a control document.  The  Order is complete when the quantity ordered is the same as the quantity shipped and invoiced.  When you close an order, unshipped (backordered) quantities are cancelled.',1120566,'C_Order_ID',22,'N','N','N','N','N',0,'N',30,0,0,'Y',TO_TIMESTAMP('2018-05-07 15:38:50','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2018-05-07 15:38:50','YYYY-MM-DD HH24:MI:SS'),100,558,'N','N','LBRA','N','N','N','Y','7739da64-5757-4bd9-8f1b-135ec326421a','Y',0,'N','N')
;

-- 07/05/2018 15h39min8s BRT
INSERT INTO AD_Column (AD_Column_ID,Version,Name,Description,Help,AD_Table_ID,ColumnName,FieldLength,IsKey,IsParent,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsEncrypted,AD_Reference_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,AD_Element_ID,IsUpdateable,IsSelectionColumn,EntityType,IsSyncDatabase,IsAlwaysUpdateable,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsAllowCopy,SeqNoSelection,IsToolbarButton,IsSecure) VALUES (1130249,0,'Invoice','Invoice Identifier','The Invoice Document.',1120566,'C_Invoice_ID',22,'N','N','N','N','N',0,'N',30,0,0,'Y',TO_TIMESTAMP('2018-05-07 15:39:08','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2018-05-07 15:39:08','YYYY-MM-DD HH24:MI:SS'),100,1008,'N','N','LBRA','N','N','N','Y','03bf17ba-1165-460a-89b5-39d4022ded86','Y',0,'N','N')
;

-- 07/05/2018 15h39min24s BRT
INSERT INTO AD_Column (AD_Column_ID,Version,Name,Description,Help,AD_Table_ID,ColumnName,FieldLength,IsKey,IsParent,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsEncrypted,AD_Reference_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,AD_Element_ID,IsUpdateable,IsSelectionColumn,EntityType,IsSyncDatabase,IsAlwaysUpdateable,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsAllowCopy,SeqNoSelection,IsToolbarButton,IsSecure) VALUES (1130250,0,'Shipment/Receipt','Material Shipment Document','The Material Shipment / Receipt ',1120566,'M_InOut_ID',22,'N','N','N','N','N',0,'N',30,0,0,'Y',TO_TIMESTAMP('2018-05-07 15:39:24','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2018-05-07 15:39:24','YYYY-MM-DD HH24:MI:SS'),100,1025,'N','N','LBRA','N','N','N','Y','b51a1fb7-37cd-41e5-a5a0-c33725c9a46f','Y',0,'N','N')
;
