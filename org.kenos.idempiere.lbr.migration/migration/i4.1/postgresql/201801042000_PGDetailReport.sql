...
INSERT INTO AD_ReportView (AD_ReportView_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,Name,AD_Table_ID,EntityType,AD_ReportView_UU) VALUES (1120037,0,0,'Y',TO_TIMESTAMP('2018-01-04 18:08:01','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2018-01-04 18:08:01','YYYY-MM-DD HH24:MI:SS'),100,'RV_LBR_PGDetail',1120591,'LBRA','cdd85bc9-661f-4ff2-802d-7090016e8fab')
;

-- 04/01/2018 18h8min17s BRST
UPDATE AD_ReportView SET Description='View Report Production Group and Production',Updated=TO_TIMESTAMP('2018-01-04 18:08:17','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_ReportView_ID=1120037
;

-- 04/01/2018 18h8min34s BRST
INSERT INTO AD_Process (AD_Process_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,Name,Description,IsReport,Value,IsDirectPrint,AD_ReportView_ID,AccessLevel,EntityType,Statistic_Count,Statistic_Seconds,IsBetaFunctionality,IsServerProcess,ShowHelp,CopyFromProcess,AD_Process_UU) VALUES (1120209,0,0,'Y',TO_TIMESTAMP('2018-01-04 18:08:34','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2018-01-04 18:08:34','YYYY-MM-DD HH24:MI:SS'),100,'Production Group Detail','Report Production Group and Production','Y','RV_LBR_PGDetail','N',1120037,'3','LBRA',0,0,'N','N','Y','N','a009bf34-9d0c-4135-b5c4-a0cbc983eeae')
;

-- 04/01/2018 18h10min29s BRST
INSERT INTO AD_Process_Para (AD_Process_Para_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,Name,Description,Help,AD_Process_ID,SeqNo,AD_Reference_ID,IsRange,FieldLength,IsMandatory,ColumnName,IsCentrallyMaintained,EntityType,AD_Element_ID,AD_Process_Para_UU,IsEncrypted) VALUES (1120395,0,0,'Y',TO_TIMESTAMP('2018-01-04 18:10:28','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2018-01-04 18:10:28','YYYY-MM-DD HH24:MI:SS'),100,'Business Partner ','Identifies a Business Partner','A Business Partner is anyone with whom you transact.  This can include Vendor, Customer, Employee or Salesperson',1120209,10,30,'N',0,'N','C_BPartner_ID','Y','LBRA',187,'ce9c05c1-b938-4dfb-bfe7-9987b11a3dc5','N')
;

-- 04/01/2018 18h11min51s BRST
INSERT INTO AD_Process_Para (AD_Process_Para_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,Name,Description,Help,AD_Process_ID,SeqNo,AD_Reference_ID,IsRange,FieldLength,IsMandatory,ColumnName,IsCentrallyMaintained,EntityType,AD_Element_ID,AD_Process_Para_UU,IsEncrypted) VALUES (1120396,0,0,'Y',TO_TIMESTAMP('2018-01-04 18:11:50','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2018-01-04 18:11:50','YYYY-MM-DD HH24:MI:SS'),100,'Product','Product, Service, Item','Identifies an item which is either purchased or sold in this organization.',1120209,20,30,'N',0,'N','M_Product_ID','Y','LBRA',454,'1984c6d1-9f74-4f45-8b11-5de119ab0d5e','N')
;

-- 04/01/2018 18h12min33s BRST
INSERT INTO AD_Process_Para (AD_Process_Para_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,Name,AD_Process_ID,SeqNo,AD_Reference_ID,IsRange,FieldLength,IsMandatory,ColumnName,IsCentrallyMaintained,EntityType,AD_Element_ID,AD_Process_Para_UU,IsEncrypted) VALUES (1120397,0,0,'Y',TO_TIMESTAMP('2018-01-04 18:12:33','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2018-01-04 18:12:33','YYYY-MM-DD HH24:MI:SS'),100,'Production Group',1120209,30,30,'N',0,'N','LBR_ProductionGroup_ID','Y','LBRA',1122423,'10a52696-4996-4476-843d-4eb358c769e3','N')
;

-- 04/01/2018 18h13min8s BRST
INSERT INTO AD_Process_Para (AD_Process_Para_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,Name,Description,Help,AD_Process_ID,SeqNo,AD_Reference_ID,IsRange,FieldLength,IsMandatory,ColumnName,IsCentrallyMaintained,EntityType,AD_Element_ID,AD_Process_Para_UU,IsEncrypted) VALUES (1120398,0,0,'Y',TO_TIMESTAMP('2018-01-04 18:13:07','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2018-01-04 18:13:07','YYYY-MM-DD HH24:MI:SS'),100,'Date Ordered','Date of Order','Indicates the Date an item was ordered.',1120209,40,15,'Y',0,'N','DateOrdered','Y','LBRA',268,'d58c5c49-9840-4af9-baa3-6e9612cca7d0','N')
;

-- 04/01/2018 18h13min32s BRST
INSERT INTO AD_Process_Para (AD_Process_Para_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,Name,Description,Help,AD_Process_ID,SeqNo,AD_Reference_ID,IsRange,FieldLength,IsMandatory,ColumnName,IsCentrallyMaintained,EntityType,AD_Element_ID,AD_Process_Para_UU,IsEncrypted) VALUES (1120399,0,0,'Y',TO_TIMESTAMP('2018-01-04 18:13:31','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2018-01-04 18:13:31','YYYY-MM-DD HH24:MI:SS'),100,'Date Promised','Date Order was promised','The Date Promised indicates the date, if any, that an Order was promised for.',1120209,50,15,'Y',0,'N','DatePromised','Y','LBRA',269,'2bfecb85-7960-4b17-9783-1b6660290529','N')
;

-- 04/01/2018 18h14min12s BRST
INSERT INTO AD_Process_Para (AD_Process_Para_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,Name,Description,Help,AD_Process_ID,SeqNo,AD_Reference_ID,AD_Reference_Value_ID,IsRange,FieldLength,IsMandatory,ColumnName,IsCentrallyMaintained,EntityType,AD_Element_ID,AD_Process_Para_UU,IsEncrypted) VALUES (1120400,0,0,'Y',TO_TIMESTAMP('2018-01-04 18:14:12','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2018-01-04 18:14:12','YYYY-MM-DD HH24:MI:SS'),100,'Document Status','The current status of the document','The Document Status indicates the status of a document at this time.  If you want to change the document status, use the Document Action field',1120209,60,17,131,'N',0,'N','DocStatus','Y','LBRA',289,'0b1c8d2b-a740-47ac-b751-0fff6c901c5c','N')
;

-- 04/01/2018 18h17min9s BRST
INSERT INTO AD_Menu (AD_Menu_ID,Name,"action",AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,IsSummary,AD_Process_ID,IsSOTrx,IsReadOnly,EntityType,IsCentrallyMaintained,AD_Menu_UU) VALUES (1120306,'Production Group Detail','R',0,0,'Y',TO_TIMESTAMP('2018-01-04 18:17:08','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2018-01-04 18:17:08','YYYY-MM-DD HH24:MI:SS'),100,'N',1120209,'Y','N','LBRA','Y','987503f9-e4f3-4d76-bbc2-153135b970ca')
;

-- 04/01/2018 18h17min9s BRST
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo, AD_TreeNodeMM_UU) SELECT t.AD_Client_ID, 0, 'Y', statement_timestamp(), 100, statement_timestamp(), 100,t.AD_Tree_ID, 1120306, 0, 999, Generate_UUID() FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=1120306)
;
...
-- 04/01/2018 18h17min56s BRST
UPDATE AD_TreeNodeMM SET Parent_ID=1000035, SeqNo=5, Updated=statement_timestamp() WHERE AD_Tree_ID=10 AND Node_ID=1120306
;

-- 04/01/2018 18h17min56s BRST
UPDATE AD_TreeNodeMM SET Parent_ID=1000035, SeqNo=6, Updated=statement_timestamp() WHERE AD_Tree_ID=10 AND Node_ID=1120300
;

-- 04/01/2018 18h17min56s BRST
UPDATE AD_TreeNodeMM SET Parent_ID=1000035, SeqNo=7, Updated=statement_timestamp() WHERE AD_Tree_ID=10 AND Node_ID=1120301
;

-- 04/01/2018 18h17min56s BRST
UPDATE AD_TreeNodeMM SET Parent_ID=1000035, SeqNo=8, Updated=statement_timestamp() WHERE AD_Tree_ID=10 AND Node_ID=1000034
;
