...
LEFT OUTER JOIN C_Location a ON (l.C_Location_ID=a.C_Location_ID)', IsValid='Y',Updated=TO_TIMESTAMP('2017-09-06 10:37:50','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_InfoWindow_ID=200001
;

-- 06/09/2017 11h22min17s BRT
UPDATE AD_InfoWindow SET WhereClause='(CASE WHEN ''@#LBR_SHOW_EMPLOYEE_BP_INFO@''=''N'' THEN bp.IsEmployee=''N'' ELSE 1=1 END)', IsValid='Y',Updated=TO_TIMESTAMP('2017-09-06 11:22:17','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_InfoWindow_ID=200001
;
