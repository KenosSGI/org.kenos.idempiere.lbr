...
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120264,'2fa55f6c-25cf-4690-a41f-ee2f72e2a15a',TO_TIMESTAMP('2018-06-28 14:01:01','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_TIMESTAMP('2018-06-28 14:01:01','YYYY-MM-DD HH24:MI:SS'),100,1120003,'M_Inventory_ID','i.M_Inventory_ID',10)
;

-- 28/06/2018 14h1min2s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120265,'2197ed4d-a06a-4875-89e3-4e935dd7b3d8',TO_TIMESTAMP('2018-06-28 14:01:02','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_TIMESTAMP('2018-06-28 14:01:02','YYYY-MM-DD HH24:MI:SS'),100,1120003,'AD_Client_ID','i.AD_Client_ID',20)
;

-- 28/06/2018 14h1min2s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120266,'b36d3b91-af71-4183-9239-227b3c445138',TO_TIMESTAMP('2018-06-28 14:01:02','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_TIMESTAMP('2018-06-28 14:01:02','YYYY-MM-DD HH24:MI:SS'),100,1120003,'AD_Org_ID','i.AD_Org_ID',30)
;

-- 28/06/2018 14h1min3s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120267,'b5ecfe6b-e537-4717-9769-f35a0c828e70',TO_TIMESTAMP('2018-06-28 14:01:02','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_TIMESTAMP('2018-06-28 14:01:02','YYYY-MM-DD HH24:MI:SS'),100,1120003,'IsActive','i.IsActive',40)
;

-- 28/06/2018 14h1min4s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120268,'3cae7bd8-5d36-49c3-afc5-630c9aeb9cc7',TO_TIMESTAMP('2018-06-28 14:01:03','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_TIMESTAMP('2018-06-28 14:01:03','YYYY-MM-DD HH24:MI:SS'),100,1120003,'Created','SYSDATE',50)
;

-- 28/06/2018 14h1min4s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120269,'d7a1a1db-66db-4d67-ab9b-f7506ee4ce31',TO_TIMESTAMP('2018-06-28 14:01:04','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_TIMESTAMP('2018-06-28 14:01:04','YYYY-MM-DD HH24:MI:SS'),100,1120003,'CreatedBy','i.CreatedBy',60)
;

-- 28/06/2018 14h1min4s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120270,'4e091963-ce0b-4ea3-92e0-14fd82fe7bf1',TO_TIMESTAMP('2018-06-28 14:01:04','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_TIMESTAMP('2018-06-28 14:01:04','YYYY-MM-DD HH24:MI:SS'),100,1120003,'Updated','SYSDATE',70)
;

-- 28/06/2018 14h1min5s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120271,'c90cc212-5f9f-43e1-8447-b14665563b74',TO_TIMESTAMP('2018-06-28 14:01:05','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_TIMESTAMP('2018-06-28 14:01:05','YYYY-MM-DD HH24:MI:SS'),100,1120003,'UpdatedBy','i.UpdatedBy',80)
;

-- 28/06/2018 14h1min6s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120272,'b10649c5-fa43-455d-963f-293513b37974',TO_TIMESTAMP('2018-06-28 14:01:05','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_TIMESTAMP('2018-06-28 14:01:05','YYYY-MM-DD HH24:MI:SS'),100,1120003,'DocumentNo','i.DocumentNo',90)
;

-- 28/06/2018 14h1min6s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120273,'1264dcd7-07f7-4ef5-985b-21e9f8b6cfab',TO_TIMESTAMP('2018-06-28 14:01:06','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_TIMESTAMP('2018-06-28 14:01:06','YYYY-MM-DD HH24:MI:SS'),100,1120003,'DocStatus','i.DocStatus',100)
;

-- 28/06/2018 14h1min7s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120274,'6842984b-c77b-4b7e-9213-a0ad7efa356c',TO_TIMESTAMP('2018-06-28 14:01:06','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_TIMESTAMP('2018-06-28 14:01:06','YYYY-MM-DD HH24:MI:SS'),100,1120003,'DocSubTypeInv','dt.DocSubTypeInv',110)
;

-- 28/06/2018 14h1min8s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120275,'f835d044-0a78-4979-9664-eb4ec1c328cb',TO_TIMESTAMP('2018-06-28 14:01:07','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_TIMESTAMP('2018-06-28 14:01:07','YYYY-MM-DD HH24:MI:SS'),100,1120003,'C_DocType_ID','i.C_DocType_ID',120)
;

-- 28/06/2018 14h1min8s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120276,'b73cc33e-a19c-40b7-a5b4-ba6ffbb0b7f3',TO_TIMESTAMP('2018-06-28 14:01:08','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_TIMESTAMP('2018-06-28 14:01:08','YYYY-MM-DD HH24:MI:SS'),100,1120003,'InventoryType','il.InventoryType',130)
;

-- 28/06/2018 14h1min9s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120277,'f15880fa-1e90-4cb9-ae25-93780d565db5',TO_TIMESTAMP('2018-06-28 14:01:08','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_TIMESTAMP('2018-06-28 14:01:08','YYYY-MM-DD HH24:MI:SS'),100,1120003,'MovementDate','i.MovementDate',140)
;

-- 28/06/2018 14h1min9s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120278,'362fe28e-c5f2-4bd4-9c0e-03a48bbfcc4b',TO_TIMESTAMP('2018-06-28 14:01:09','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_TIMESTAMP('2018-06-28 14:01:09','YYYY-MM-DD HH24:MI:SS'),100,1120003,'M_Product_ID','il.M_Product_ID',150)
;

-- 28/06/2018 14h1min9s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120279,'cdac0d2e-b375-48c6-a547-7356e3c5e165',TO_TIMESTAMP('2018-06-28 14:01:09','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_TIMESTAMP('2018-06-28 14:01:09','YYYY-MM-DD HH24:MI:SS'),100,1120003,'M_Warehouse_ID','i.M_Warehouse_ID',160)
;

-- 28/06/2018 14h1min10s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120280,'378a557b-f5df-47f9-9bfa-511eaeda21e9',TO_TIMESTAMP('2018-06-28 14:01:10','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_TIMESTAMP('2018-06-28 14:01:10','YYYY-MM-DD HH24:MI:SS'),100,1120003,'M_Locator_ID','il.M_Locator_ID',170)
;

-- 28/06/2018 14h1min10s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120281,'c7c21804-6ec1-49b8-a07a-c4aa818476eb',TO_TIMESTAMP('2018-06-28 14:01:10','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_TIMESTAMP('2018-06-28 14:01:10','YYYY-MM-DD HH24:MI:SS'),100,1120003,'M_AttributeSetInstance_ID','il.M_AttributeSetInstance_ID',180)
;

-- 28/06/2018 14h1min18s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120282,'7c58676f-8f7d-44a9-bb78-bf7b2df17bf6',TO_TIMESTAMP('2018-06-28 14:01:10','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_TIMESTAMP('2018-06-28 14:01:10','YYYY-MM-DD HH24:MI:SS'),100,1120003,'QtyCount','il.QtyCount',190)
;

-- 28/06/2018 14h1min18s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120283,'7e883810-537f-4b1f-ac5d-30178a9bc24c',TO_TIMESTAMP('2018-06-28 14:01:18','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_TIMESTAMP('2018-06-28 14:01:18','YYYY-MM-DD HH24:MI:SS'),100,1120003,'QtyBook','il.QtyBook',200)
;

-- 28/06/2018 14h1min21s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120284,'4411a415-a341-4f94-b34d-bb19a5adca27',TO_TIMESTAMP('2018-06-28 14:01:18','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_TIMESTAMP('2018-06-28 14:01:18','YYYY-MM-DD HH24:MI:SS'),100,1120003,'QtyInternalUse','il.QtyInternalUse',210)
;

-- 28/06/2018 14h1min21s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120285,'e6e1087d-b3c4-4fac-9808-9c914beac4b9',TO_TIMESTAMP('2018-06-28 14:01:21','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_TIMESTAMP('2018-06-28 14:01:21','YYYY-MM-DD HH24:MI:SS'),100,1120003,'Description','i.Description',220)
;

-- 28/06/2018 14h1min23s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120286,'5b527e41-7290-4e0a-aa2c-91e194f6d876',TO_TIMESTAMP('2018-06-28 14:01:21','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_TIMESTAMP('2018-06-28 14:01:21','YYYY-MM-DD HH24:MI:SS'),100,1120003,'LineDescription','il.Description',230)
;

-- 28/06/2018 14h1min23s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120287,'e0006cbc-8a72-4e0b-85aa-0b0a21b92384',TO_TIMESTAMP('2018-06-28 14:01:23','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_TIMESTAMP('2018-06-28 14:01:23','YYYY-MM-DD HH24:MI:SS'),100,1120003,'C_Charge_ID','il.C_Charge_ID',240)
;

-- 28/06/2018 14h2min12s BRT
CREATE OR REPLACE VIEW RV_LBR_InventoryDetails(M_Inventory_ID, AD_Client_ID, AD_Org_ID, IsActive, Created, CreatedBy, Updated, UpdatedBy, DocumentNo, DocStatus, DocSubTypeInv, C_DocType_ID, InventoryType, MovementDate, M_Product_ID, M_Warehouse_ID, M_Locator_ID, M_AttributeSetInstance_ID, QtyCount, QtyBook, QtyInternalUse, Description, LineDescription, C_Charge_ID) AS SELECT i.M_Inventory_ID AS M_Inventory_ID, i.AD_Client_ID AS AD_Client_ID, i.AD_Org_ID AS AD_Org_ID, i.IsActive AS IsActive, i.Created AS Created, i.CreatedBy AS CreatedBy, i.Updated AS Updated, i.UpdatedBy AS UpdatedBy, i.DocumentNo AS DocumentNo, i.DocStatus AS DocStatus, dt.DocSubTypeInv AS DocSubTypeInv, i.C_DocType_ID AS C_DocType_ID, il.InventoryType AS InventoryType, i.MovementDate AS MovementDate, il.M_Product_ID AS M_Product_ID, i.M_Warehouse_ID AS M_Warehouse_ID, il.M_Locator_ID AS M_Locator_ID, il.M_AttributeSetInstance_ID AS M_AttributeSetInstance_ID, il.QtyCount AS QtyCount, il.QtyBook AS QtyBook, il.QtyInternalUse AS QtyInternalUse, i.Description AS Description, il.Description AS LineDescription, il.C_Charge_ID AS C_Charge_ID FROM M_Inventory i LEFT JOIN M_InventoryLine il ON il.M_Inventory_ID = i.M_Inventory_ID LEFT JOIN C_DocType dt ON dt.C_DocType_ID = i.C_DocType_ID
;

-- 28/06/2018 14h2min26s BRT
INSERT INTO AD_Column (AD_Column_ID,Version,Name,Description,Help,AD_Table_ID,ColumnName,FieldLength,IsKey,IsParent,IsMandatory,IsTranslated,IsIdentifier,IsEncrypted,AD_Reference_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,AD_Element_ID,IsUpdateable,IsSelectionColumn,EntityType,IsAlwaysUpdateable,AD_Column_UU,IsToolbarButton) VALUES (1130375,0.0,'Phys.Inventory','Parameters for a Physical Inventory','The Physical Inventory indicates a unique parameters for a physical inventory.',1120601,'M_Inventory_ID',10,'N','N','N','N','N','N',30,0,0,'Y',TO_TIMESTAMP('2018-06-28 14:02:26','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2018-06-28 14:02:26','YYYY-MM-DD HH24:MI:SS'),100,1027,'N','N','LBRA','N','2368eb20-0df0-4d13-96f8-a84445fd5240','N')
;

-- 28/06/2018 14h2min26s BRT
INSERT INTO AD_Column (AD_Column_ID,Version,Name,Description,Help,AD_Table_ID,AD_Val_Rule_ID,ColumnName,DefaultValue,FieldLength,IsKey,IsParent,IsMandatory,IsTranslated,IsIdentifier,IsEncrypted,AD_Reference_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,AD_Element_ID,IsUpdateable,IsSelectionColumn,EntityType,IsAlwaysUpdateable,AD_Column_UU,IsToolbarButton,FKConstraintType) VALUES (1130376,0.0,'Client','Client/Tenant for this installation.','A Client is a company or a legal entity. You cannot share data between Clients. Tenant is a synonym for Client.',1120601,129,'AD_Client_ID','@#AD_Client_ID@',10,'N','N','N','N','N','N',19,0,0,'Y',TO_TIMESTAMP('2018-06-28 14:02:26','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2018-06-28 14:02:26','YYYY-MM-DD HH24:MI:SS'),100,102,'N','N','LBRA','N','2e37b6c4-f440-43d4-a52b-b8e0f4d4d786','N','D')
;

-- 28/06/2018 14h2min27s BRT
INSERT INTO AD_Column (AD_Column_ID,Version,Name,Description,Help,AD_Table_ID,AD_Val_Rule_ID,ColumnName,DefaultValue,FieldLength,IsKey,IsParent,IsMandatory,IsTranslated,IsIdentifier,IsEncrypted,AD_Reference_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,AD_Element_ID,IsUpdateable,IsSelectionColumn,EntityType,IsAlwaysUpdateable,AD_Column_UU,IsToolbarButton,FKConstraintType) VALUES (1130377,0.0,'Organization','Organizational entity within client','An organization is a unit of your client or legal entity - examples are store, department. You can share data between organizations.',1120601,104,'AD_Org_ID','@#AD_Org_ID@',10,'N','N','N','N','N','N',19,0,0,'Y',TO_TIMESTAMP('2018-06-28 14:02:26','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2018-06-28 14:02:26','YYYY-MM-DD HH24:MI:SS'),100,113,'N','N','LBRA','N','d6c45317-ba17-4f1f-9e02-3d822521d244','N','D')
;
...
INSERT INTO AD_Column (AD_Column_ID,Version,Name,Description,Help,AD_Table_ID,ColumnName,FieldLength,IsKey,IsParent,IsMandatory,IsTranslated,IsIdentifier,IsEncrypted,AD_Reference_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,AD_Element_ID,IsUpdateable,IsSelectionColumn,EntityType,IsAlwaysUpdateable,AD_Column_UU,IsToolbarButton) VALUES (1130396,0.0,'Description','Optional short description of the record','A description is limited to 255 characters.',1120601,'Description',255,'N','N','N','N','N','N',10,0,0,'Y',TO_TIMESTAMP('2018-06-28 14:02:36','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2018-06-28 14:02:36','YYYY-MM-DD HH24:MI:SS'),100,275,'N','Y','LBRA','N','24d07d09-1fd9-446f-9ac9-358e42ec66b3','N')
;

-- 28/06/2018 14h2min40s BRT
INSERT INTO AD_Column (AD_Column_ID,Version,Name,Description,AD_Table_ID,ColumnName,FieldLength,IsKey,IsParent,IsMandatory,IsTranslated,IsIdentifier,IsEncrypted,AD_Reference_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,AD_Element_ID,IsUpdateable,IsSelectionColumn,EntityType,IsAlwaysUpdateable,AD_Column_UU,IsToolbarButton) VALUES (1130397,0.0,'Line Description','Description of the Line',1120601,'LineDescription',255,'N','N','N','N','N','N',10,0,0,'Y',TO_TIMESTAMP('2018-06-28 14:02:39','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2018-06-28 14:02:39','YYYY-MM-DD HH24:MI:SS'),100,2108,'N','N','LBRA','N','e1809473-e7e9-4420-86f1-898a800988c3','N')
;

-- 28/06/2018 14h2min40s BRT
INSERT INTO AD_Column (AD_Column_ID,Version,Name,Description,Help,AD_Table_ID,ColumnName,FieldLength,IsKey,IsParent,IsMandatory,IsTranslated,IsIdentifier,IsEncrypted,AD_Reference_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,AD_Element_ID,IsUpdateable,IsSelectionColumn,EntityType,IsAlwaysUpdateable,AD_Column_UU,IsToolbarButton) VALUES (1130398,0.0,'Charge','Additional document charges','The Charge indicates a type of Charge (Handling, Shipping, Restocking)',1120601,'C_Charge_ID',10,'N','N','N','N','N','N',19,0,0,'Y',TO_TIMESTAMP('2018-06-28 14:02:40','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2018-06-28 14:02:40','YYYY-MM-DD HH24:MI:SS'),100,968,'N','N','LBRA','N','72ab01c6-56a8-47a6-891f-7ef079c0607e','N')
;

-- 28/06/2018 14h5min48s BRT
INSERT INTO AD_Process (AD_Process_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,Name,Description,Help,IsReport,Value,IsDirectPrint,AccessLevel,EntityType,Statistic_Count,Statistic_Seconds,IsBetaFunctionality,IsServerProcess,ShowHelp,CopyFromProcess,AD_Process_UU) VALUES (1120218,0,0,'Y',TO_TIMESTAMP('2018-06-28 14:05:48','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2018-06-28 14:05:48','YYYY-MM-DD HH24:MI:SS'),100,'Inventory Details','Physical and Internal Use Detail','With this report you can have details about your physical and internal use inventory.','Y','RV_LBR_InventoryDetails','N','3','LBRA',0,0,'N','N','Y','N','b3426bb9-1c70-4ace-8d5d-33b084816bad')
;

-- 28/06/2018 14h6min9s BRT
INSERT INTO AD_ReportView (AD_ReportView_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,Name,AD_Table_ID,EntityType,AD_ReportView_UU) VALUES (1120038,0,0,'Y',TO_TIMESTAMP('2018-06-28 14:06:08','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2018-06-28 14:06:08','YYYY-MM-DD HH24:MI:SS'),100,'RV_LBR_InventoryDetails',1120601,'LBRA','ca9a4ce5-649f-401b-a3b9-0fa9c425b4bf')
;

-- 28/06/2018 14h6min54s BRT
UPDATE AD_Process SET AD_ReportView_ID=1120038,Updated=TO_TIMESTAMP('2018-06-28 14:06:54','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=1120218
;

-- 28/06/2018 14h7min49s BRT
INSERT INTO AD_Process_Para (AD_Process_Para_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,Name,Description,Help,AD_Process_ID,SeqNo,AD_Reference_ID,AD_Reference_Value_ID,IsRange,FieldLength,IsMandatory,ColumnName,IsCentrallyMaintained,EntityType,AD_Element_ID,AD_Process_Para_UU,IsEncrypted) VALUES (1120423,0,0,'Y',TO_TIMESTAMP('2018-06-28 14:07:48','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2018-06-28 14:07:48','YYYY-MM-DD HH24:MI:SS'),100,'Inv Sub Type','Inventory Sub Type','The Inventory Sub Type indicates the type of inventory this document refers to.  This field only appears when the Document Base Type is Material Physical Inventory.  The selection made here will determine which window must be used and which data in the lines is relevant for the document.  Internal Use inventory (based on Internal Used Quantity) or Physical Inventory (based on difference between Qty Counted vs Qty Book)',1120218,10,17,200068,'N',0,'N','DocSubTypeInv','Y','LBRA',202506,'ed6596a5-9327-4aae-9768-f6d0e3ccfcf4','N')
;

-- 28/06/2018 14h7min49s BRT
INSERT INTO AD_Process_Para (AD_Process_Para_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,Name,Description,Help,AD_Process_ID,SeqNo,AD_Reference_ID,AD_Reference_Value_ID,IsRange,FieldLength,IsMandatory,ColumnName,IsCentrallyMaintained,EntityType,AD_Element_ID,AD_Process_Para_UU,IsEncrypted) VALUES (1120424,0,0,'Y',TO_TIMESTAMP('2018-06-28 14:07:49','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2018-06-28 14:07:49','YYYY-MM-DD HH24:MI:SS'),100,'Product','Product, Service, Item','Identifies an item which is either purchased or sold in this organization.',1120218,20,30,162,'N',0,'N','M_Product_ID','Y','LBRA',454,'a0804bc2-79f1-480c-8519-0fc5de3ec5ec','N')
;
...
-- 28/06/2018 14h7min51s BRT
INSERT INTO AD_Process_Para (AD_Process_Para_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,Name,Description,Help,AD_Process_ID,SeqNo,AD_Reference_ID,AD_Reference_Value_ID,IsRange,FieldLength,IsMandatory,ColumnName,IsCentrallyMaintained,EntityType,AD_Element_ID,AD_Process_Para_UU,IsEncrypted) VALUES (1120426,0,0,'Y',TO_TIMESTAMP('2018-06-28 14:07:51','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2018-06-28 14:07:51','YYYY-MM-DD HH24:MI:SS'),100,'Locator','Warehouse Locator','The Locator indicates where in a Warehouse a product is located.',1120218,40,30,191,'N',0,'N','M_Locator_ID','Y','LBRA',448,'4d96a204-aa91-4a6f-9d4b-795e852bf030','N')
;

-- 28/06/2018 14h7min52s BRT
INSERT INTO AD_Process_Para (AD_Process_Para_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,Name,Description,Help,AD_Process_ID,SeqNo,AD_Reference_ID,IsRange,FieldLength,IsMandatory,ColumnName,IsCentrallyMaintained,EntityType,AD_Element_ID,AD_Process_Para_UU,IsEncrypted) VALUES (1120427,0,0,'Y',TO_TIMESTAMP('2018-06-28 14:07:51','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2018-06-28 14:07:51','YYYY-MM-DD HH24:MI:SS'),100,'Warehouse','Storage Warehouse and Service Point','The Warehouse identifies a unique Warehouse where products are stored or Services are provided.',1120218,50,19,'N',0,'N','M_Warehouse_ID','Y','LBRA',459,'47eab32a-9fb6-40f0-b4f1-5cf51fca0883','N')
;

-- 28/06/2018 14h7min52s BRT
INSERT INTO AD_Process_Para (AD_Process_Para_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,Name,Description,Help,AD_Process_ID,SeqNo,AD_Reference_ID,IsRange,FieldLength,IsMandatory,ColumnName,IsCentrallyMaintained,EntityType,AD_Element_ID,AD_Process_Para_UU,IsEncrypted) VALUES (1120428,0,0,'Y',TO_TIMESTAMP('2018-06-28 14:07:52','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2018-06-28 14:07:52','YYYY-MM-DD HH24:MI:SS'),100,'Charge','Additional document charges','The Charge indicates a type of Charge (Handling, Shipping, Restocking)',1120218,60,19,'N',0,'N','C_Charge_ID','Y','LBRA',968,'9be9aeff-0452-4db0-b6ad-358ba72a45a0','N')
;
...
INSERT INTO AD_Menu (AD_Menu_ID,Name,Description,"action",AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,IsSummary,AD_Process_ID,IsSOTrx,IsReadOnly,EntityType,IsCentrallyMaintained,AD_Menu_UU) VALUES (1120311,'RV_LBR_InventoryDetails','Physical and Internal Use Detail','R',0,0,'Y',TO_TIMESTAMP('2018-06-28 14:16:24','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2018-06-28 14:16:24','YYYY-MM-DD HH24:MI:SS'),100,'N',1120218,'N','N','LBRA','Y','7cd15a6a-1309-4054-9ec8-1fdc0266c039')
;

-- 28/06/2018 14h16min25s BRT
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo, AD_TreeNodeMM_UU) SELECT t.AD_Client_ID, 0, 'Y', statement_timestamp(), 100, statement_timestamp(), 100,t.AD_Tree_ID, 1120311, 0, 999, Generate_UUID() FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=1120311)
;
...
-- 28/06/2018 14h18min51s BRT
UPDATE AD_TreeNodeMM SET Parent_ID=183, SeqNo=18, Updated=statement_timestamp() WHERE AD_Tree_ID=10 AND Node_ID=1120311
;
...
-- 28/06/2018 14h18min51s BRT
UPDATE AD_TreeNodeMM SET Parent_ID=183, SeqNo=23, Updated=statement_timestamp() WHERE AD_Tree_ID=10 AND Node_ID=545
;
...
-- 28/06/2018 14h18min53s BRT
UPDATE AD_TreeNodeMM SET Parent_ID=183, SeqNo=17, Updated=statement_timestamp() WHERE AD_Tree_ID=10 AND Node_ID=1120311
;
