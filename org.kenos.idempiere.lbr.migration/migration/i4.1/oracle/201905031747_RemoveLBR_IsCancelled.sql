...
UPDATE AD_Column SET AD_Element_ID=2531, ColumnName='IsCancelled', DefaultValue='N', Description='The transaction was cancelled', Help=NULL, Name='Cancelled',Updated=TO_DATE('2019-05-03 19:07:23','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1000062
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
ALTER TABLE LBR_Boleto ADD IsCancelled CHAR(1) DEFAULT 'N' CHECK (IsCancelled IN ('Y','N')) NOT NULL
;

-- 03/05/2019 19h8min4s BRT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Column SET AD_Element_ID=2531, ColumnName='IsCancelled', DefaultValue='N', Description='The transaction was cancelled', Help=NULL, Name='Cancelled',Updated=TO_DATE('2019-05-03 19:08:04','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1000072
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
ALTER TABLE LBR_CNAB ADD IsCancelled CHAR(1) DEFAULT 'N' CHECK (IsCancelled IN ('Y','N')) NOT NULL
;

-- 03/05/2019 19h8min51s BRT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Column SET AD_Element_ID=2531, ColumnName='IsCancelled', Description='The transaction was cancelled', Help=NULL, Name='Cancelled',Updated=TO_DATE('2019-05-03 19:08:51','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1129790
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Process_Para SET AD_Element_ID=2531, ColumnName='IsCancelled',Updated=TO_DATE('2019-05-06 11:45:05','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=1120338
;

-- 06/05/2019 11h45min36s BRT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Process_Para SET AD_Element_ID=2531, ColumnName='IsCancelled',Updated=TO_DATE('2019-05-06 11:45:36','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=1120346
;
...
UPDATE AD_Process_Para SET AD_Element_ID=2531, ColumnName='IsCancelled',Updated=TO_DATE('2019-05-06 11:45:36','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=1000027
;
