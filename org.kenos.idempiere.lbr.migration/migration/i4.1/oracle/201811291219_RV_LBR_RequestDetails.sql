...
INSERT INTO AD_Process_Para (AD_Process_Para_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,Name,Description,Help,AD_Process_ID,SeqNo,AD_Reference_ID,IsRange,FieldLength,IsMandatory,ColumnName,IsCentrallyMaintained,EntityType,AD_Element_ID,AD_Process_Para_UU,IsEncrypted) VALUES (1120440,0,0,'Y',TO_DATE('2018-11-29 11:51:30','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2018-11-29 11:51:30','YYYY-MM-DD HH24:MI:SS'),100,'Created','Date this record was created','The Created field indicates the date that this record was created.',1120226,10,15,'Y',0,'N','Created','Y','LBRA',245,'25d4c601-3d88-4552-920a-4f901fe15137','N')
;
...
INSERT INTO AD_Menu (AD_Menu_ID,Name,Description,Action,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,IsSummary,AD_Process_ID,IsSOTrx,IsReadOnly,EntityType,IsCentrallyMaintained,AD_Menu_UU) VALUES (1120317,'Request Details change','Request Details','R',0,0,'Y',TO_DATE('2018-11-29 12:02:03','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2018-11-29 12:02:03','YYYY-MM-DD HH24:MI:SS'),100,'N',1120226,'N','N','LBRA','Y','40fe5833-e1d7-40f5-82e8-bd7961cc7617')
;

-- 29/11/2018 12h2min4s BRST
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo, AD_TreeNodeMM_UU) SELECT t.AD_Client_ID, 0, 'Y', SysDate, 100, SysDate, 100,t.AD_Tree_ID, 1120317, 0, 999, Generate_UUID() FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=1120317)
;
...
-- 29/11/2018 12h3min50s BRST
UPDATE AD_TreeNodeMM SET Parent_ID=528, SeqNo=0, Updated=SysDate WHERE AD_Tree_ID=10 AND Node_ID=309
;

-- 29/11/2018 12h3min50s BRST
UPDATE AD_TreeNodeMM SET Parent_ID=528, SeqNo=1, Updated=SysDate WHERE AD_Tree_ID=10 AND Node_ID=332
;

-- 29/11/2018 12h3min50s BRST
UPDATE AD_TreeNodeMM SET Parent_ID=528, SeqNo=2, Updated=SysDate WHERE AD_Tree_ID=10 AND Node_ID=526
;

-- 29/11/2018 12h3min50s BRST
UPDATE AD_TreeNodeMM SET Parent_ID=528, SeqNo=3, Updated=SysDate WHERE AD_Tree_ID=10 AND Node_ID=527
;

-- 29/11/2018 12h3min50s BRST
UPDATE AD_TreeNodeMM SET Parent_ID=528, SeqNo=4, Updated=SysDate WHERE AD_Tree_ID=10 AND Node_ID=525
;

-- 29/11/2018 12h3min50s BRST
UPDATE AD_TreeNodeMM SET Parent_ID=528, SeqNo=5, Updated=SysDate WHERE AD_Tree_ID=10 AND Node_ID=523
;

-- 29/11/2018 12h3min50s BRST
UPDATE AD_TreeNodeMM SET Parent_ID=528, SeqNo=6, Updated=SysDate WHERE AD_Tree_ID=10 AND Node_ID=524
;

-- 29/11/2018 12h3min50s BRST
UPDATE AD_TreeNodeMM SET Parent_ID=528, SeqNo=7, Updated=SysDate WHERE AD_Tree_ID=10 AND Node_ID=308
;

-- 29/11/2018 12h3min50s BRST
UPDATE AD_TreeNodeMM SET Parent_ID=528, SeqNo=8, Updated=SysDate WHERE AD_Tree_ID=10 AND Node_ID=535
;

-- 29/11/2018 12h3min50s BRST
UPDATE AD_TreeNodeMM SET Parent_ID=528, SeqNo=9, Updated=SysDate WHERE AD_Tree_ID=10 AND Node_ID=337
;

-- 29/11/2018 12h3min50s BRST
UPDATE AD_TreeNodeMM SET Parent_ID=528, SeqNo=10, Updated=SysDate WHERE AD_Tree_ID=10 AND Node_ID=1120317
;

-- 29/11/2018 12h3min50s BRST
UPDATE AD_TreeNodeMM SET Parent_ID=528, SeqNo=11, Updated=SysDate WHERE AD_Tree_ID=10 AND Node_ID=333
;

-- 29/11/2018 12h3min50s BRST
UPDATE AD_TreeNodeMM SET Parent_ID=528, SeqNo=12, Updated=SysDate WHERE AD_Tree_ID=10 AND Node_ID=560
;

-- 29/11/2018 12h3min50s BRST
UPDATE AD_TreeNodeMM SET Parent_ID=528, SeqNo=13, Updated=SysDate WHERE AD_Tree_ID=10 AND Node_ID=559
;

-- 29/11/2018 12h3min50s BRST
UPDATE AD_TreeNodeMM SET Parent_ID=528, SeqNo=14, Updated=SysDate WHERE AD_Tree_ID=10 AND Node_ID=562
;

-- 29/11/2018 12h3min50s BRST
UPDATE AD_TreeNodeMM SET Parent_ID=528, SeqNo=15, Updated=SysDate WHERE AD_Tree_ID=10 AND Node_ID=564
;

-- 29/11/2018 12h3min50s BRST
UPDATE AD_TreeNodeMM SET Parent_ID=528, SeqNo=16, Updated=SysDate WHERE AD_Tree_ID=10 AND Node_ID=563
;

-- 29/11/2018 12h3min50s BRST
UPDATE AD_TreeNodeMM SET Parent_ID=528, SeqNo=17, Updated=SysDate WHERE AD_Tree_ID=10 AND Node_ID=561
;
