...
INSERT INTO AD_Table (AD_Table_ID,Name,Description,TableName,LoadSeq,AccessLevel,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,IsSecurityEnabled,IsDeleteable,IsHighVolume,IsView,EntityType,IsChangeLog,ReplicationType,IsCentrallyMaintained,AD_Table_UU,Processing,IsSystemLanguage) VALUES (1120604,'Production Report','Plan for producing a product','RV_LBR_Production',125,'1',0,0,'Y',TO_DATE('2018-09-19 18:04:28','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2018-09-19 18:04:28','YYYY-MM-DD HH24:MI:SS'),100,'N','N','N','Y','LBRA','N','L','Y','6675ba1f-414d-4db6-a7bd-ecd71698956d','N','N')
;

-- 19/09/2018 18h4min29s BRT
INSERT INTO AD_Sequence (Name,CurrentNext,IsAudited,StartNewYear,Description,IsActive,IsTableID,AD_Client_ID,AD_Org_ID,Created,CreatedBy,Updated,UpdatedBy,AD_Sequence_ID,IsAutoSequence,StartNo,IncrementNo,CurrentNextSys,AD_Sequence_UU) VALUES ('RV_LBR_Production',1000000,'N','N','Table RV_LBR_Production','Y','Y',0,0,TO_DATE('2018-09-19 18:04:29','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2018-09-19 18:04:29','YYYY-MM-DD HH24:MI:SS'),100,1153604,'Y',1000000,1,200000,'ebe5b738-f46d-44d9-8fd6-c8ed6903e9fe')
;

-- 19/09/2018 18h6min48s BRT
INSERT INTO AD_ViewComponent (AD_Client_ID,AD_Org_ID,AD_ViewComponent_ID,AD_ViewComponent_UU,Created,CreatedBy,EntityType,IsActive,Name,Updated,UpdatedBy,AD_Table_ID,SeqNo,FromClause) VALUES (0,0,1120005,'7a8f6c2f-8aa0-4469-8ab1-4e1209cc50fa',TO_DATE('2018-09-19 18:06:47','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y','Production Report',TO_DATE('2018-09-19 18:06:47','YYYY-MM-DD HH24:MI:SS'),100,1120604,10,'FROM M_Production p')
;

-- 19/09/2018 18h7min57s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120313,'bcf38b19-ff07-45c5-bf36-3f9171199a16',TO_DATE('2018-09-19 18:07:56','YYYY-MM-DD HH24:MI:SS'),100,'U','Y',TO_DATE('2018-09-19 18:07:56','YYYY-MM-DD HH24:MI:SS'),100,1120005,'M_Production_ID','p.M_Production_ID',10)
;

-- 19/09/2018 18h8min1s BRT
UPDATE AD_ViewColumn SET EntityType='LBRA',Updated=TO_DATE('2018-09-19 18:08:01','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_ViewColumn_ID=1120313
;

-- 19/09/2018 18h8min24s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120314,'bd05c430-767a-40c1-8bc3-54ae9a566f0b',TO_DATE('2018-09-19 18:08:24','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_DATE('2018-09-19 18:08:24','YYYY-MM-DD HH24:MI:SS'),100,1120005,'AD_Client_ID','p.AD_Client_ID',10)
;

-- 19/09/2018 18h8min38s BRT
UPDATE AD_ViewColumn SET SeqNo=20,Updated=TO_DATE('2018-09-19 18:08:38','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_ViewColumn_ID=1120314
;

-- 19/09/2018 18h8min53s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120315,'4c99bb2e-02b4-4d6e-ada0-9d2bf08c14fd',TO_DATE('2018-09-19 18:08:53','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_DATE('2018-09-19 18:08:53','YYYY-MM-DD HH24:MI:SS'),100,1120005,'AD_Org_ID','p.AD_Org_ID',30)
;

-- 19/09/2018 18h9min11s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120316,'1022a6e1-f663-4d26-8c91-c6f4c61da264',TO_DATE('2018-09-19 18:09:10','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_DATE('2018-09-19 18:09:10','YYYY-MM-DD HH24:MI:SS'),100,1120005,'IsActive','p.IsActive',40)
;

-- 19/09/2018 18h9min25s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120317,'92bf23dd-730a-403b-8893-6738431cd2f3',TO_DATE('2018-09-19 18:09:25','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_DATE('2018-09-19 18:09:25','YYYY-MM-DD HH24:MI:SS'),100,1120005,'Created','p.Created',50)
;

-- 19/09/2018 18h9min42s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120318,'1da1ed1c-8ff6-4fde-b35d-9df735766931',TO_DATE('2018-09-19 18:09:42','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_DATE('2018-09-19 18:09:42','YYYY-MM-DD HH24:MI:SS'),100,1120005,'CreatedBy','p.CreatedBy',60)
;

-- 19/09/2018 18h9min52s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120319,'384ddb39-ac80-456d-921b-8175772a39bf',TO_DATE('2018-09-19 18:09:52','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_DATE('2018-09-19 18:09:52','YYYY-MM-DD HH24:MI:SS'),100,1120005,'Updated','p.Updated',70)
;

-- 19/09/2018 18h10min9s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120320,'88d745c4-6550-4959-a1cd-593a3b1f68ae',TO_DATE('2018-09-19 18:10:09','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_DATE('2018-09-19 18:10:09','YYYY-MM-DD HH24:MI:SS'),100,1120005,'UpdatedBy','p.UpdatedBy',80)
;

-- 19/09/2018 18h11min55s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120321,'0aed5dac-71aa-46c7-bb1a-0233070a1e80',TO_DATE('2018-09-19 18:11:55','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_DATE('2018-09-19 18:11:55','YYYY-MM-DD HH24:MI:SS'),100,1120005,'M_Product_ID','p.M_Product_ID',90)
;

-- 19/09/2018 18h12min22s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120322,'738b6328-0820-4c0a-bf71-a89c0dacf903',TO_DATE('2018-09-19 18:12:21','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_DATE('2018-09-19 18:12:21','YYYY-MM-DD HH24:MI:SS'),100,1120005,'ProductionQty','p.ProductionQty',100)
;

-- 19/09/2018 18h12min41s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120323,'2cf59a46-6467-469a-ae69-1f82a339c2a7',TO_DATE('2018-09-19 18:12:41','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_DATE('2018-09-19 18:12:41','YYYY-MM-DD HH24:MI:SS'),100,1120005,'PriceEntered','p.PriceEntered',110)
;

-- 19/09/2018 18h14min16s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120324,'099a0391-811e-48ba-87f2-c8c45c2da850',TO_DATE('2018-09-19 18:14:15','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_DATE('2018-09-19 18:14:15','YYYY-MM-DD HH24:MI:SS'),100,1120005,'MovementDate','p.MovementDate',120)
;

-- 19/09/2018 18h14min47s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120325,'34e23b7d-e5cb-4b77-900d-f6233fbee02c',TO_DATE('2018-09-19 18:14:46','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_DATE('2018-09-19 18:14:46','YYYY-MM-DD HH24:MI:SS'),100,1120005,'DocumentNo','p.DocumentNo',130)
;

-- 19/09/2018 18h15min38s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120326,'098c110b-2576-4a2e-93ea-73329a5068a9',TO_DATE('2018-09-19 18:15:38','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_DATE('2018-09-19 18:15:38','YYYY-MM-DD HH24:MI:SS'),100,1120005,'LBR_ProductionGroup_ID','p.LBR_ProductionGroup_ID',140)
;

-- 19/09/2018 18h16min4s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120327,'1e2ef185-53f9-4561-b8fc-6d7d2ce8aab7',TO_DATE('2018-09-19 18:16:04','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_DATE('2018-09-19 18:16:04','YYYY-MM-DD HH24:MI:SS'),100,1120005,'GrandTotal','()',150)
;

-- 19/09/2018 18h16min18s BRT
UPDATE AD_ViewColumn SET ColumnSQL='(p.PriceEntered*)',Updated=TO_DATE('2018-09-19 18:16:18','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_ViewColumn_ID=1120327
;

-- 19/09/2018 18h16min37s BRT
UPDATE AD_ViewColumn SET ColumnSQL='(p.PriceEntered*p.ProductionQty)',Updated=TO_DATE('2018-09-19 18:16:37','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_ViewColumn_ID=1120327
;

-- 19/09/2018 18h19min4s BRT
UPDATE AD_ViewColumn SET ColumnSQL='ROUND((p.PriceEntered*p.ProductionQty),2)',Updated=TO_DATE('2018-09-19 18:19:04','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_ViewColumn_ID=1120327
;
