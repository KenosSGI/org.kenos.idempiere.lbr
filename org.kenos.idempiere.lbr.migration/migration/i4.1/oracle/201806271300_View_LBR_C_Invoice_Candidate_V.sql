...
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120251,'0b48f5d8-2b50-4a0b-8b9d-b314be6fac65',TO_DATE('2018-06-27 11:53:35','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_DATE('2018-06-27 11:53:35','YYYY-MM-DD HH24:MI:SS'),100,1120002,'AD_Client_ID','o.AD_Client_ID',10)
;

-- 27/06/2018 11h54min13s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120252,'5ff04eb0-e656-44c2-8429-3dd4104ec137',TO_DATE('2018-06-27 11:54:13','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_DATE('2018-06-27 11:54:13','YYYY-MM-DD HH24:MI:SS'),100,1120002,'AD_Org_ID','o.AD_Org_ID',20)
;

-- 27/06/2018 11h55min1s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120253,'fc12d961-c029-43c7-9779-c6c46a9ad8e7',TO_DATE('2018-06-27 11:55:01','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_DATE('2018-06-27 11:55:01','YYYY-MM-DD HH24:MI:SS'),100,1120002,'Created','o.Created',30)
;

-- 27/06/2018 11h55min13s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120254,'4081bd8e-e8fb-46fb-820c-22d65a51a8c3',TO_DATE('2018-06-27 11:55:12','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_DATE('2018-06-27 11:55:12','YYYY-MM-DD HH24:MI:SS'),100,1120002,'CreatedBy','o.CreatedBy',40)
;

-- 27/06/2018 11h55min23s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120255,'cf3f1ea2-5ab9-4d03-bb5f-3f875e7aca0b',TO_DATE('2018-06-27 11:55:22','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_DATE('2018-06-27 11:55:22','YYYY-MM-DD HH24:MI:SS'),100,1120002,'Updated','o.Updated',50)
;

-- 27/06/2018 11h55min34s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120256,'e0a2033c-7800-472c-95b3-fffceb68d506',TO_DATE('2018-06-27 11:55:33','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_DATE('2018-06-27 11:55:33','YYYY-MM-DD HH24:MI:SS'),100,1120002,'UpdatedBy','o.UpdatedBy',60)
;

-- 27/06/2018 11h55min57s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120257,'f6b85d23-a56c-410f-a3be-855c8ebf9624',TO_DATE('2018-06-27 11:55:56','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_DATE('2018-06-27 11:55:56','YYYY-MM-DD HH24:MI:SS'),100,1120002,'IsActive','o.IsActive',70)
;

-- 27/06/2018 11h56min21s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120258,'8c679ace-8d58-4d59-b915-b3dfb1c15348',TO_DATE('2018-06-27 11:56:21','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_DATE('2018-06-27 11:56:21','YYYY-MM-DD HH24:MI:SS'),100,1120002,'C_BPartner_ID','o.C_BPartner_ID',80)
;

-- 27/06/2018 11h56min48s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120259,'a40e3ca6-34f7-4d5a-a84f-21118104cc83',TO_DATE('2018-06-27 11:56:48','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_DATE('2018-06-27 11:56:48','YYYY-MM-DD HH24:MI:SS'),100,1120002,'C_Order_ID','o.C_Order_ID',90)
;

-- 27/06/2018 11h57min8s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120260,'d500a1e8-7f04-4aef-b61f-f71f9e2cd3f9',TO_DATE('2018-06-27 11:57:08','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_DATE('2018-06-27 11:57:08','YYYY-MM-DD HH24:MI:SS'),100,1120002,'DocumentNo','o.DocumentNo',100)
;

-- 27/06/2018 11h57min25s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120261,'7806eb1e-c46e-4448-896e-0d07ae4e0f04',TO_DATE('2018-06-27 11:57:25','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_DATE('2018-06-27 11:57:25','YYYY-MM-DD HH24:MI:SS'),100,1120002,'DateOrdered','o.DateOrdered',110)
;

-- 27/06/2018 11h57min50s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120262,'399d276f-f4cf-4e90-b50e-a88433643341',TO_DATE('2018-06-27 11:57:49','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_DATE('2018-06-27 11:57:49','YYYY-MM-DD HH24:MI:SS'),100,1120002,'C_DocType_ID','o.C_DocType_ID',120)
;

-- 27/06/2018 11h58min49s BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120263,'ba06e6e3-d948-4934-9a57-04c6cec5490d',TO_DATE('2018-06-27 11:58:48','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_DATE('2018-06-27 11:58:48','YYYY-MM-DD HH24:MI:SS'),100,1120002,'TotalLines','sum((l.QtyOrdered - l.QtyInvoiced) * l.PriceActual) AS TotalLines',130)
;
...
(firstof(o.dateordered::timestamp with time zone, ''MM''::character varying)::timestamp with time zone + si.invoiceday - 1)))',Updated=TO_DATE('2018-06-27 12:08:57','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_ViewComponent_ID=1120002
;

-- 27/06/2018 12h10min3s BRT
UPDATE AD_ViewColumn SET ColumnSQL='sum((l.QtyOrdered - l.QtyInvoiced) * l.PriceActual)',Updated=TO_DATE('2018-06-27 12:10:03','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_ViewColumn_ID=1120263
;
