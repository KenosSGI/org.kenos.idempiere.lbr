...
-- 26/11/2018 13h53min11s BRST
UPDATE AD_TreeNodeMM SET Parent_ID=53242, SeqNo=6, Updated=SysDate WHERE AD_Tree_ID=10 AND Node_ID=1120316
;

-- 26/11/2018 13h57min25s BRST
UPDATE AD_ReportView SET OrderByClause='Qty < COALESCE(QtyDelivered,0) OR Qty < COALESCE(QtyInvoiced,0)',Updated=TO_DATE('2018-11-26 13:57:25','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_ReportView_ID=1120040
;
