...
UPDATE AD_ReportView SET whereClause='Qty > COALESCE(QtyDelivered,0) OR Qty > COALESCE(QtyInvoiced,0)',Updated=TO_DATE('2018-11-26 13:57:25','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_ReportView_ID=1120040
;
