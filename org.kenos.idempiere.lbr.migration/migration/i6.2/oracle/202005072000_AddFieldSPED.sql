...
INSERT INTO AD_Reference (AD_Reference_ID,Name,ValidationType,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,EntityType,IsOrderByValue,AD_Reference_UU) VALUES (1120336,'LBR_IndPerfil - AD_Org','L',0,0,'Y',TO_DATE('2020-05-07 23:47:46','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2020-05-07 23:47:46','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','N','c587f79e-652e-405b-a604-a248b60f78ee')
;

-- 7 de mai de 2020 23:49:09 BRT
INSERT INTO AD_Ref_List (AD_Ref_List_ID,Name,AD_Reference_ID,Value,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,EntityType,AD_Ref_List_UU) VALUES (1122320,'Perfil A',1120336,'A',0,0,'Y',TO_DATE('2020-05-07 23:49:08','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2020-05-07 23:49:08','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','3efa2938-9491-490d-a9e8-a0e572a512c6')
;

-- 7 de mai de 2020 23:49:22 BRT
INSERT INTO AD_Ref_List (AD_Ref_List_ID,Name,AD_Reference_ID,Value,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,EntityType,AD_Ref_List_UU) VALUES (1122321,'Perfil B',1120336,'B',0,0,'Y',TO_DATE('2020-05-07 23:49:21','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2020-05-07 23:49:21','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','820201e0-bc15-4847-a579-04edb6e76515')
;

-- 7 de mai de 2020 23:49:35 BRT
INSERT INTO AD_Ref_List (AD_Ref_List_ID,Name,AD_Reference_ID,Value,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,EntityType,AD_Ref_List_UU) VALUES (1122322,'Perfil C',1120336,'C',0,0,'Y',TO_DATE('2020-05-07 23:49:35','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2020-05-07 23:49:35','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','08f4b220-a44b-4cd0-93fb-c1d1868aeeba')
;

-- 7 de mai de 2020 23:51:13 BRT
INSERT INTO AD_Element (AD_Element_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,ColumnName,Name,Description,PrintName,EntityType,AD_Element_UU) VALUES (1122995,0,0,'Y',TO_DATE('2020-05-07 23:51:13','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2020-05-07 23:51:13','YYYY-MM-DD HH24:MI:SS'),100,'LBR_IndPerfil','Perfil de Apresentacao','Perfil de Apresentacao do arquivo fiscal','Perfil de Apresentacao do arquivo fiscal','LBRA','88c83818-1163-41a8-b8eb-486c6a91396e')
;

-- 7 de mai de 2020 23:51:32 BRT
UPDATE AD_Element SET Name='Perfil de Apresentação', Description='Perfil de Apresentação do arquivo fiscal', PrintName='Perfil de Apresentação do arquivo fiscal',Updated=TO_DATE('2020-05-07 23:51:32','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=1122995
;
