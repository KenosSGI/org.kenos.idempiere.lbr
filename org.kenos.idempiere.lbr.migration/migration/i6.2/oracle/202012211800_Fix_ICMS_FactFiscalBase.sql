...
CREATE OR REPLACE VIEW adempiere.lbr_factfiscalbase
 ...
 SELECT nf.ad_client_id,
   ...
   FROM adempiere.lbr_notafiscalline nfl
     ...
     JOIN adempiere.c_invoice i ON nf.c_invoice_id = i.c_invoice_id
     LEFT JOIN adempiere.c_doctype dt ON nf.c_doctypetarget_id = dt.c_doctype_id
     JOIN adempiere.c_doctype dti ON i.c_doctypetarget_id = dti.c_doctype_id
...
-- 21 de dez de 2020 17:22:56 BRT
SELECT Register_Migration_Script ('202012211800_Fix_ICMS_FactFiscalBase.sql') FROM DUAL
;