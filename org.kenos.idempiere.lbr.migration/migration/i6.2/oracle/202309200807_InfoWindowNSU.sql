...
UPDATE AD_ViewComponent SET FromClause='FROM (SELECT dfe.AD_Client_ID, dfe.AD_Org_ID, GENERATE_SERIES (MIN(CAST (nsu.LBR_NSU AS INT)), MAX(CAST (nsu.LBR_NSU AS INT))) 
      ...
      GROUP BY dfe.AD_Client_ID, dfe.AD_Org_ID, cfg.Value) s (AD_Client_ID, AD_Org_ID, ID)',Updated=TO_DATE('2023-09-20 07:51:19','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_ViewComponent_ID=1120010
;
...
INSERT INTO AD_Element (AD_Element_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,ColumnName,Name,PrintName,EntityType,AD_Element_UU) VALUES (1123402,0,0,'Y',TO_DATE('2023-09-20 07:57:27','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2023-09-20 07:57:27','YYYY-MM-DD HH24:MI:SS'),100,'LBR_MissingNSU_ID','Check Missing NSU','Check Missing NSU','LBRA','251cd5af-3ffb-4f65-833a-cb2393a4f58b')
;

-- 20 de set de 2023 07:57:28 BRT
INSERT INTO AD_Column (AD_Column_ID,Version,Name,AD_Table_ID,ColumnName,FieldLength,IsKey,IsParent,IsMandatory,IsTranslated,IsIdentifier,IsEncrypted,AD_Reference_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,AD_Element_ID,IsUpdateable,IsSelectionColumn,EntityType,IsAlwaysUpdateable,AD_Column_UU,IsToolbarButton) VALUES (1133848,0.0,'Check Missing NSU',1120691,'LBR_MissingNSU_ID',19,'Y','N','N','N','N','N',13,0,0,'Y',TO_DATE('2023-09-20 07:57:27','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2023-09-20 07:57:27','YYYY-MM-DD HH24:MI:SS'),100,1123402,'N','N','LBRA','N','9950e4ce-acd8-4e7d-b601-2009f3cffea3','N')
;

-- 20 de set de 2023 07:57:56 BRT
UPDATE AD_InfoWindow SET IsShowInDashboard='N',Updated=TO_DATE('2023-09-20 07:57:56','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_InfoWindow_ID=1120003
;

-- 20 de set de 2023 07:59:27 BRT
INSERT INTO AD_InfoProcess (AD_InfoProcess_ID,AD_InfoProcess_UU,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,ImageURL,SeqNo,AD_Process_ID,AD_InfoWindow_ID,LayoutType) VALUES (1120000,'89dcf460-a1e7-44ed-b7f3-cf4f08c29e0a',0,0,'Y',TO_DATE('2023-09-20 07:59:26','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2023-09-20 07:59:26','YYYY-MM-DD HH24:MI:SS'),100,'ProcessMenu24.png',10,1120251,1120003,'B')
;

-- 20 de set de 2023 08:00:15 BRT
INSERT INTO AD_Menu (AD_Menu_ID,Name,Action,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,IsSummary,IsSOTrx,IsReadOnly,EntityType,IsCentrallyMaintained,AD_Menu_UU,AD_InfoWindow_ID) VALUES (1120425,'Check Missing NSU','I',0,0,'Y',TO_DATE('2023-09-20 08:00:15','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2023-09-20 08:00:15','YYYY-MM-DD HH24:MI:SS'),100,'N','Y','N','LBRA','Y','5ca8d9bf-21e0-4a72-8463-6f18ed4a54f5',1120003)
;

-- 20 de set de 2023 08:00:15 BRT
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo, AD_TreeNodeMM_UU) SELECT t.AD_Client_ID, 0, 'Y', SysDate, 100, SysDate, 100,t.AD_Tree_ID, 1120425, 0, 999, Generate_UUID() FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=1120425)
;
...
-- 20 de set de 2023 08:00:42 BRT
UPDATE AD_TreeNodeMM SET Parent_ID=1120423, SeqNo=6, Updated=SysDate WHERE AD_Tree_ID=10 AND Node_ID=1120425
;

-- 20 de set de 2023 08:00:42 BRT
UPDATE AD_TreeNodeMM SET Parent_ID=1120423, SeqNo=7, Updated=SysDate WHERE AD_Tree_ID=10 AND Node_ID=1120393
;

-- 20 de set de 2023 08:01:18 BRT
UPDATE AD_Process SET IsReport='N', AD_ReportView_ID=NULL,Updated=TO_DATE('2023-09-20 08:01:18','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=1120251
;

-- 20 de set de 2023 08:01:38 BRT
UPDATE AD_Process SET Name='Fix Missing NSU', Description='Fix the missing NSU',Updated=TO_DATE('2023-09-20 08:01:38','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=1120251
;

-- 20 de set de 2023 08:01:38 BRT
UPDATE AD_Menu SET Name='Fix Missing NSU', Description='Fix the missing NSU', IsActive='Y',Updated=TO_DATE('2023-09-20 08:01:38','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Menu_ID=1120364
;

-- 20 de set de 2023 09:22:05 BRT
UPDATE AD_Menu SET Action='P',Updated=TO_DATE('2023-09-20 09:22:05','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Menu_ID=1120364
;

-- 20 de set de 2023 09:22:38 BRT
UPDATE AD_InfoColumn SET AD_Val_Rule_ID=202,Updated=TO_DATE('2023-09-20 09:22:38','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_InfoColumn_ID=1120037
;
