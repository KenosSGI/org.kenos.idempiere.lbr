...
( 
	LBR_PresumedTaxCredit_ID              NUMBER (10) NOT NULL,
	LBR_PresumedTaxCredit_UU              NVARCHAR2 (36) DEFAULT NULL,
	...
	CONSTRAINT LBR_PresumedTaxCredit_Key PRIMARY KEY (LBR_PresumedTaxCredit_ID)
)
;

CREATE TABLE LBR_NFLinePTaxCredit
( 
	LBR_NFLinePTaxCredit_ID              NUMBER (10) NOT NULL,
	AD_Client_ID            NUMBER (10) NOT NULL,
	AD_Org_ID       	NUMBER (10) NOT NULL,
	IsActive        	CHAR(1) CHECK (IsActive IN ('Y','N')) NOT NULL,
	Created         	DATE NOT NULL,
...
-- 6 de fev de 2025 08:24:50 BRT
INSERT INTO AD_Column (AD_Column_ID,Version,Name,Description,Help,AD_Table_ID,ColumnName,FieldLength,IsKey,IsParent,IsMandatory,IsTranslated,IsIdentifier,IsEncrypted,AD_Reference_ID,AD_Reference_Value_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,AD_Element_ID,IsUpdateable,IsSelectionColumn,EntityType,IsAlwaysUpdateable,AD_Column_UU,IsToolbarButton,FKConstraintType) VALUES (1134319,0.0,'Updated By','User who updated this records','The Updated By field indicates the user who updated this record.',1120786,'UpdatedBy',10,'N','N','Y','N','N','N',18,110,0,0,'Y',TO_DATE('2025-02-06 08:24:50','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2025-02-06 08:24:50','YYYY-MM-DD HH24:MI:SS'),100,608,'N','N','LBRA','N','9c56c57f-47cb-420f-82db-79714cc57e82','N','D')
;

-- 6 de fev de 2025 08:25:02 BRT
INSERT INTO AD_Column (AD_Column_ID,Version,Name,Description,Help,AD_Table_ID,ColumnName,FieldLength,IsKey,IsParent,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsEncrypted,AD_Reference_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,AD_Element_ID,IsUpdateable,IsSelectionColumn,EntityType,IsSyncDatabase,IsAlwaysUpdateable,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsAllowCopy,SeqNoSelection,IsToolbarButton,IsSecure,IsHtml) VALUES (1134320,0,'NCM','Primary key table LBR_NCM','Primary key table LBR_NCM',1120786,'LBR_NCM_ID',10,'N','N','N','N','N',0,'N',30,0,0,'Y',TO_DATE('2025-02-06 08:25:02','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2025-02-06 08:25:02','YYYY-MM-DD HH24:MI:SS'),100,1000134,'Y','N','LBRA','N','N','N','Y','20b86463-1e42-46df-b83f-e5587927550e','Y',0,'N','N','N')
;

-- 6 de fev de 2025 08:25:06 BRT
UPDATE AD_Column SET IsParent='Y', IsUpdateable='N',Updated=TO_DATE('2025-02-06 08:25:06','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1134320
;

-- 6 de fev de 2025 08:25:07 BRT
UPDATE AD_Column SET IsUpdateable='N', FKConstraintName='LBRNCM_LBRPresumedTaxCredit', FKConstraintType='N',Updated=TO_DATE('2025-02-06 08:25:07','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1134320
;

-- 6 de fev de 2025 08:25:07 BRT
ALTER TABLE LBR_PresumedTaxCredit ADD LBR_NCM_ID NUMBER(10) DEFAULT NULL 
;
...
INSERT INTO AD_Column (AD_Column_ID,Version,Name,Description,Help,AD_Table_ID,AD_Val_Rule_ID,ColumnName,FieldLength,IsKey,IsParent,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsEncrypted,AD_Reference_ID,AD_Reference_Value_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,AD_Element_ID,IsUpdateable,IsSelectionColumn,EntityType,IsSyncDatabase,IsAlwaysUpdateable,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsAllowCopy,SeqNoSelection,IsToolbarButton,IsSecure,FKConstraintType,IsHtml) VALUES (1134321,0,'Region','Identifies a geographical Region','The Region identifies a unique Region for this Country.',1120786,1000003,'C_Region_ID',10,'N','N','N','N','N',0,'N',18,157,0,0,'Y',TO_DATE('2025-02-06 08:25:30','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2025-02-06 08:25:30','YYYY-MM-DD HH24:MI:SS'),100,209,'Y','N','LBRA','N','N','N','Y','e212eb98-62a0-4d60-a585-f6bc5f627924','Y',0,'N','N','N','N')
;

-- 6 de fev de 2025 08:25:33 BRT
UPDATE AD_Column SET FKConstraintName='CRegion_LBRPresumedTaxCredit', FKConstraintType='N',Updated=TO_DATE('2025-02-06 08:25:33','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1134321
;

-- 6 de fev de 2025 08:25:33 BRT
ALTER TABLE LBR_PresumedTaxCredit ADD C_Region_ID NUMBER(10) DEFAULT NULL 
;
...
There are two reasons for de-activating and not deleting records:
(1) The system requires the record for audit purposes.
(2) The record is referenced by other records. E.g., you cannot delete a Business Partner, if there are invoices for this partner record existing. You de-activate the Business Partner and prevent that this record is used for future entries.',1120538,1134333,'Y',1,50,'N','N','N','N',0,0,'Y',TO_DATE('2025-02-06 09:59:46','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2025-02-06 09:59:46','YYYY-MM-DD HH24:MI:SS'),100,'N','Y','LBRA','d1514f27-aea1-43ac-9cb1-52082a37088f','Y',40,2,2)
;

-- 6 de fev de 2025 10:00:00 BRT
INSERT INTO AD_Column (AD_Column_ID,Version,Name,Description,Help,AD_Table_ID,ColumnName,FieldLength,IsKey,IsParent,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsEncrypted,AD_Reference_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,AD_Element_ID,IsUpdateable,IsSelectionColumn,EntityType,IsSyncDatabase,IsAlwaysUpdateable,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsAllowCopy,SeqNoSelection,IsToolbarButton,IsSecure,IsHtml) VALUES (1134342,0,'Description','Optional short description of the record','A description is limited to 255 characters.',1120787,'Description',255,'N','N','N','N','N',0,'N',10,0,0,'Y',TO_DATE('2025-02-06 09:59:59','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2025-02-06 09:59:59','YYYY-MM-DD HH24:MI:SS'),100,275,'Y','Y','U','N','N','N','Y','cd05b1d6-882a-452f-a6a6-9c191b4920cf','Y',10,'N','N','N')
;

-- 6 de fev de 2025 10:00:02 BRT
ALTER TABLE LBR_NFLinePTaxCredit ADD Description VARCHAR2(255) DEFAULT NULL 
;

-- 6 de fev de 2025 10:00:17 BRT
UPDATE AD_Column SET EntityType='LBRA',Updated=TO_DATE('2025-02-06 10:00:17','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1134342
;

-- 6 de fev de 2025 10:00:26 BRT
INSERT INTO AD_Field (AD_Field_ID,Name,Description,Help,AD_Tab_ID,AD_Column_ID,IsDisplayed,DisplayLength,SeqNo,IsSameLine,IsHeading,IsFieldOnly,IsEncrypted,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,IsReadOnly,IsCentrallyMaintained,EntityType,AD_Field_UU,IsDisplayedGrid,SeqNoGrid,ColumnSpan) VALUES (1132223,'Description','Optional short description of the record','A description is limited to 255 characters.',1120538,1134342,'Y',255,60,'N','N','N','N',0,0,'Y',TO_DATE('2025-02-06 10:00:26','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2025-02-06 10:00:26','YYYY-MM-DD HH24:MI:SS'),100,'N','Y','LBRA','6ce150c2-a20d-4541-bd9d-dbe2ffbd898c','Y',50,5)
;

-- 6 de fev de 2025 10:00:59 BRT
UPDATE AD_Column SET EntityType='LBRA',Updated=TO_DATE('2025-02-06 10:00:59','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1134341
;

-- 6 de fev de 2025 10:01:03 BRT
UPDATE AD_Column SET EntityType='LBRA',Updated=TO_DATE('2025-02-06 10:01:03','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1134340
;

-- 6 de fev de 2025 10:01:13 BRT
INSERT INTO AD_Field (AD_Field_ID,Name,Description,Help,AD_Tab_ID,AD_Column_ID,IsDisplayed,DisplayLength,SeqNo,IsSameLine,IsHeading,IsFieldOnly,IsEncrypted,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,IsReadOnly,IsCentrallyMaintained,EntityType,AD_Field_UU,IsDisplayedGrid,SeqNoGrid,ColumnSpan) VALUES (1132224,'Percentage','Percent of the entire amount','Percentage of an amount (up to 100)',1120538,1134340,'Y',10,70,'N','N','N','N',0,0,'Y',TO_DATE('2025-02-06 10:01:12','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2025-02-06 10:01:12','YYYY-MM-DD HH24:MI:SS'),100,'N','Y','LBRA','4cf9e5a5-8045-454e-ad0d-7011c97a18d9','Y',60,2)
;

-- 6 de fev de 2025 10:01:13 BRT
INSERT INTO AD_Field (AD_Field_ID,Name,Description,Help,AD_Tab_ID,AD_Column_ID,IsDisplayed,DisplayLength,SeqNo,IsSameLine,IsHeading,IsFieldOnly,IsEncrypted,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,IsReadOnly,IsCentrallyMaintained,EntityType,AD_Field_UU,IsDisplayedGrid,SeqNoGrid,ColumnSpan) VALUES (1132225,'Amount','Amount in a defined currency','The Amount indicates the amount for this document line.',1120538,1134341,'Y',22,80,'N','N','N','N',0,0,'Y',TO_DATE('2025-02-06 10:01:13','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2025-02-06 10:01:13','YYYY-MM-DD HH24:MI:SS'),100,'N','Y','LBRA','a1cd93c8-e333-4e51-87e5-75f4e699322e','Y',70,2)
;

-- 6 de fev de 2025 10:01:39 BRT
UPDATE AD_Field SET IsDisplayed='Y', SeqNo=40, AD_Reference_Value_ID=NULL, AD_Val_Rule_ID=NULL, XPosition=5, IsToolbarButton=NULL,Updated=TO_DATE('2025-02-06 10:01:39','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1132222
;

-- 6 de fev de 2025 10:01:39 BRT
UPDATE AD_Field SET SeqNo=50, AD_Reference_Value_ID=NULL, AD_Val_Rule_ID=NULL, IsToolbarButton=NULL,Updated=TO_DATE('2025-02-06 10:01:39','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1132221
;

-- 6 de fev de 2025 10:01:39 BRT
UPDATE AD_Field SET IsDisplayed='Y', SeqNo=60, AD_Reference_Value_ID=NULL, AD_Val_Rule_ID=NULL, XPosition=1, IsToolbarButton=NULL,Updated=TO_DATE('2025-02-06 10:01:39','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1132224
;

-- 6 de fev de 2025 10:01:39 BRT
UPDATE AD_Field SET IsDisplayed='Y', SeqNo=70, AD_Reference_Value_ID=NULL, AD_Val_Rule_ID=NULL, XPosition=4, IsToolbarButton=NULL,Updated=TO_DATE('2025-02-06 10:01:39','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1132225
;

-- 6 de fev de 2025 10:01:39 BRT
UPDATE AD_Field SET SeqNo=80, AD_Reference_Value_ID=NULL, AD_Val_Rule_ID=NULL, NumLines=3, IsToolbarButton=NULL,Updated=TO_DATE('2025-02-06 10:01:39','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1132223
;

-- 6 de fev de 2025 10:01:39 BRT
UPDATE AD_Field SET SeqNo=0, AD_Reference_Value_ID=NULL, AD_Val_Rule_ID=NULL, IsToolbarButton=NULL,Updated=TO_DATE('2025-02-06 10:01:39','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1132219
;

-- 6 de fev de 2025 10:01:55 BRT
UPDATE AD_Tab SET Name='dito P',Updated=TO_DATE('2025-02-06 10:01:55','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=1120538
;

-- 6 de fev de 2025 10:02:37 BRT
UPDATE AD_Tab SET Name='Presumed Credit',Updated=TO_DATE('2025-02-06 10:02:37','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=1120538
;

-- 6 de fev de 2025 10:02:45 BRT
UPDATE AD_Tab SET EntityType='LBRA',Updated=TO_DATE('2025-02-06 10:02:45','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=1120538
;

-- 6 de fev de 2025 10:03:56 BRT
INSERT INTO AD_Tab (AD_Tab_ID,Name,AD_Window_ID,SeqNo,IsSingleRow,AD_Table_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,HasTree,IsInfoTab,IsTranslationTab,IsReadOnly,Processing,ImportFields,TabLevel,IsSortTab,EntityType,IsInsertRecord,IsAdvancedTab,AD_Tab_UU,TreeDisplayedOn) VALUES (1120539,'Presumed Credit',1000019,80,'Y',1120787,0,0,'Y',TO_DATE('2025-02-06 10:03:55','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2025-02-06 10:03:55','YYYY-MM-DD HH24:MI:SS'),100,'N','N','N','N','N','N',2,'N','LBRA','Y','N','bffe63f9-b000-4f7d-b6f3-164bbb5dbd11','B')
;

-- 6 de fev de 2025 10:04:07 BRT
INSERT INTO AD_Field (AD_Field_ID,Name,AD_Tab_ID,AD_Column_ID,IsDisplayed,DisplayLength,SeqNo,IsSameLine,IsHeading,IsFieldOnly,IsEncrypted,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,IsReadOnly,IsCentrallyMaintained,EntityType,AD_Field_UU,IsDisplayedGrid,XPosition,ColumnSpan,NumLines,IsQuickEntry,IsDefaultFocus,IsAdvancedField) VALUES (1132226,'Nota Fiscal Presumed Tax Credit',1120539,1134330,'N',10,0,'N','N','N','N',0,0,'Y',TO_DATE('2025-02-06 10:04:06','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2025-02-06 10:04:06','YYYY-MM-DD HH24:MI:SS'),100,'N','Y','LBRA','631d8ae7-12db-441e-9831-f542c1935d84','N',1,2,1,'N','N','N')
;

-- 6 de fev de 2025 10:04:07 BRT
INSERT INTO AD_Field (AD_Field_ID,Name,Description,Help,AD_Tab_ID,AD_Column_ID,IsDisplayed,DisplayLength,SeqNo,IsSameLine,IsHeading,IsFieldOnly,IsEncrypted,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,IsReadOnly,IsCentrallyMaintained,EntityType,AD_Field_UU,IsDisplayedGrid,XPosition,ColumnSpan,NumLines,IsQuickEntry,IsDefaultFocus,IsAdvancedField) VALUES (1132227,'Client','Client/Tenant for this installation.','A Client is a company or a legal entity. You cannot share data between Clients. Tenant is a synonym for Client.',1120539,1134331,'Y',10,10,'N','N','N','N',0,0,'Y',TO_DATE('2025-02-06 10:04:07','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2025-02-06 10:04:07','YYYY-MM-DD HH24:MI:SS'),100,'N','Y','LBRA','d891252f-345b-430b-9c09-ea942e74ff12','N',1,2,1,'N','N','N')
;
...
There are two reasons for de-activating and not deleting records:
(1) The system requires the record for audit purposes.
(2) The record is referenced by other records. E.g., you cannot delete a Business Partner, if there are invoices for this partner record existing. You de-activate the Business Partner and prevent that this record is used for future entries.',1120540,1134315,'Y',1,90,'N','N','N','N',0,0,'Y',TO_DATE('2025-02-06 13:48:19','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2025-02-06 13:48:19','YYYY-MM-DD HH24:MI:SS'),100,'N','Y','LBRA','0cfd89e4-28d2-46c7-a9b0-311656332559','Y',80,2,2)
;

-- 6 de fev de 2025 13:48:50 BRT
UPDATE AD_Field SET IsDisplayed='Y', SeqNo=40, AD_Reference_Value_ID=NULL, AD_Val_Rule_ID=NULL, XPosition=5, IsToolbarButton=NULL,Updated=TO_DATE('2025-02-06 13:48:50','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1132245
;

-- 6 de fev de 2025 13:48:50 BRT
UPDATE AD_Field SET SeqNo=50, AD_Reference_Value_ID=NULL, AD_Val_Rule_ID=NULL, IsToolbarButton=NULL,Updated=TO_DATE('2025-02-06 13:48:50','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1132240
;

-- 6 de fev de 2025 13:48:50 BRT
UPDATE AD_Field SET SeqNo=60, AD_Reference_Value_ID=NULL, AD_Val_Rule_ID=NULL, IsToolbarButton=NULL,Updated=TO_DATE('2025-02-06 13:48:50','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1132241
;

-- 6 de fev de 2025 13:48:50 BRT
UPDATE AD_Field SET IsDisplayed='Y', SeqNo=70, AD_Reference_Value_ID=NULL, AD_Val_Rule_ID=NULL, XPosition=4, IsToolbarButton=NULL,Updated=TO_DATE('2025-02-06 13:48:50','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1132242
;

-- 6 de fev de 2025 13:48:50 BRT
UPDATE AD_Field SET SeqNo=80, AD_Reference_Value_ID=NULL, AD_Val_Rule_ID=NULL, IsToolbarButton=NULL,Updated=TO_DATE('2025-02-06 13:48:50','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1132243
;

-- 6 de fev de 2025 13:48:50 BRT
UPDATE AD_Field SET IsDisplayed='Y', SeqNo=90, AD_Reference_Value_ID=NULL, AD_Val_Rule_ID=NULL, XPosition=4, IsToolbarButton=NULL,Updated=TO_DATE('2025-02-06 13:48:50','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1132244
;

-- 6 de fev de 2025 13:48:50 BRT
UPDATE AD_Field SET SeqNo=0, AD_Reference_Value_ID=NULL, AD_Val_Rule_ID=NULL, IsToolbarButton=NULL,Updated=TO_DATE('2025-02-06 13:48:50','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1132238
;

-- 6 de fev de 2025 13:48:50 BRT
UPDATE AD_Field SET SeqNo=0, AD_Reference_Value_ID=NULL, AD_Val_Rule_ID=NULL, IsToolbarButton=NULL,Updated=TO_DATE('2025-02-06 13:48:50','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1132237
;

-- 6 de fev de 2025 13:51:08 BRT
UPDATE AD_Column SET FormatPattern='#,##0.0000 %',Updated=TO_DATE('2025-02-06 13:51:08','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1134325
;

-- 6 de fev de 2025 13:51:36 BRT
UPDATE AD_Column SET FormatPattern='#,##0.0000 %',Updated=TO_DATE('2025-02-06 13:51:36','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1134340
;
