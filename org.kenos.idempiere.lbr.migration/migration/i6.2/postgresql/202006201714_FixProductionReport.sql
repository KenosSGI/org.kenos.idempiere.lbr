...
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,DBDataType,SeqNo) VALUES (0,0,1120433,'edeebbc9-1e40-407d-911b-3d89d9fb5a47',TO_TIMESTAMP('2020-06-20 17:08:57','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_TIMESTAMP('2020-06-20 17:08:57','YYYY-MM-DD HH24:MI:SS'),100,1120005,'RV_LBR_Production_ID','p.M_Production_ID','I',260)
;
...
INSERT INTO AD_Element (AD_Element_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,ColumnName,Name,PrintName,EntityType,AD_Element_UU) VALUES (1122998,0,0,'Y',TO_TIMESTAMP('2020-06-20 17:09:58','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2020-06-20 17:09:58','YYYY-MM-DD HH24:MI:SS'),100,'RV_LBR_Production_ID','Production Report','Production Report','LBRA','268e66d3-8f91-49d4-96ed-897dff01230d')
;

-- 20 de jun de 2020 17:12:40 BRT
UPDATE AD_Process SET ShowHelp='S',Updated=TO_TIMESTAMP('2020-06-20 17:12:40','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=1120243
;
