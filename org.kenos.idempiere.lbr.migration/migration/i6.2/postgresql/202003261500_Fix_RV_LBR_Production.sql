...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
-- 26 de mar de 2020 14:14:58 BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120383,'06add766-167c-4318-a3d8-52e0bf9681bb',TO_TIMESTAMP('2020-03-26 14:14:57','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_TIMESTAMP('2020-03-26 14:14:57','YYYY-MM-DD HH24:MI:SS'),100,1120005,'C_BPartner_ID','p.C_BPartner_ID',160)
;

-- 26 de mar de 2020 14:16:04 BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120384,'f883c4d3-516d-4e2e-ae36-849b14298d5c',TO_TIMESTAMP('2020-03-26 14:16:04','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_TIMESTAMP('2020-03-26 14:16:04','YYYY-MM-DD HH24:MI:SS'),100,1120005,'DocStatus','p.DocStatus',170)
;

-- 26 de mar de 2020 14:17:11 BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120385,'0ffc3742-60be-4b6e-a010-f88cc48b3905',TO_TIMESTAMP('2020-03-26 14:17:10','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_TIMESTAMP('2020-03-26 14:17:10','YYYY-MM-DD HH24:MI:SS'),100,1120005,'DateStart','p.DateStart',180)
;

-- 26 de mar de 2020 14:17:25 BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120386,'22cdae9b-bc73-4e90-9b65-c0b9eed2a3b4',TO_TIMESTAMP('2020-03-26 14:17:25','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_TIMESTAMP('2020-03-26 14:17:25','YYYY-MM-DD HH24:MI:SS'),100,1120005,'DatePromised','p.DatePromised',190)
;

-- 26 de mar de 2020 14:18:02 BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120387,'e4b6de13-a484-436a-a2a7-3c4b2f936628',TO_TIMESTAMP('2020-03-26 14:18:02','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_TIMESTAMP('2020-03-26 14:18:02','YYYY-MM-DD HH24:MI:SS'),100,1120005,'Description','p.Description',200)
;

-- 26 de mar de 2020 14:19:03 BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120388,'0ecab515-1996-4f10-b74e-19ef73315234',TO_TIMESTAMP('2020-03-26 14:19:03','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_TIMESTAMP('2020-03-26 14:19:03','YYYY-MM-DD HH24:MI:SS'),100,1120005,'C_OrderLine_ID','p.C_OrderLine_ID',210)
;

-- 26 de mar de 2020 14:19:27 BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120389,'661a9b65-2c55-4b68-ae50-476c0c6ba781',TO_TIMESTAMP('2020-03-26 14:19:27','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_TIMESTAMP('2020-03-26 14:19:27','YYYY-MM-DD HH24:MI:SS'),100,1120005,'M_Locator_ID','p.M_Locator_ID',220)
;

-- 26 de mar de 2020 14:20:37 BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120391,'50678434-db40-401c-b573-5c9bc69858f0',TO_TIMESTAMP('2020-03-26 14:20:37','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_TIMESTAMP('2020-03-26 14:20:37','YYYY-MM-DD HH24:MI:SS'),100,1120005,'Name','p.Name',240)
;

-- 26 de mar de 2020 14:21:42 BRT
INSERT INTO AD_ViewColumn (AD_Client_ID,AD_Org_ID,AD_ViewColumn_ID,AD_ViewColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_ViewComponent_ID,ColumnName,ColumnSQL,SeqNo) VALUES (0,0,1120392,'4db4c956-9b35-4e7c-9866-2c82db852665',TO_TIMESTAMP('2020-03-26 14:21:42','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_TIMESTAMP('2020-03-26 14:21:42','YYYY-MM-DD HH24:MI:SS'),100,1120005,'C_Invoice_ID','p.C_Invoice_ID',250)
;
