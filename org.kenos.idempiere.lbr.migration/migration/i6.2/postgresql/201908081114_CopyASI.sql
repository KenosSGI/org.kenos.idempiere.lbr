...
INSERT INTO AD_Process_Para (AD_Process_Para_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,Name,Description,Help,AD_Process_ID,SeqNo,AD_Reference_ID,IsRange,FieldLength,IsMandatory,DefaultValue,ColumnName,IsCentrallyMaintained,EntityType,AD_Element_ID,AD_Process_Para_UU,IsEncrypted) VALUES (200277,0,0,'Y',TO_TIMESTAMP('2019-08-08 11:11:07','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2019-08-08 11:11:07','YYYY-MM-DD HH24:MI:SS'),100,'Copy Attributes','Copy Attributes Set Instance when copying Order Lines','Check if want the Attribute Set Instance to be copied when copying Order Lines',211,20,20,'N',0,'N','N','LBR_CopyASI','Y','U',203314,'c5f46a56-b492-495e-b500-8fce5961ec33','N')
;
