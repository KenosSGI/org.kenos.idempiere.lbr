...
INSERT INTO AD_Val_Rule (AD_Val_Rule_ID,Name,Type,Code,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,EntityType,AD_Val_Rule_UU) VALUES (1120199,'C_DocType NF (IsSOTrx and Org)','S','C_DocType.DocBaseType=''NFB'' AND C_DocType.IsSOTrx=''@IsSOTrx@'' AND C_DocType.AD_Org_ID IN (0, @AD_Org_ID@)',0,0,'Y',TO_TIMESTAMP('2021-03-24 10:07:50','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2021-03-24 10:07:50','YYYY-MM-DD HH24:MI:SS'),100,'U','f7f63d9b-7647-445f-92b0-c259c8546c27')
;

-- 24 de mar de 2021 10:08:38 BRT
UPDATE AD_Column SET AD_Val_Rule_ID=1120199,Updated=TO_TIMESTAMP('2021-03-24 10:08:38','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1000484
;
