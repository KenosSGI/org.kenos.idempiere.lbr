...
INSERT INTO AD_Column (AD_Column_ID,Version,Name,Description,Help,AD_Table_ID,ColumnName,FieldLength,IsKey,IsParent,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsEncrypted,AD_Reference_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,AD_Element_ID,IsUpdateable,IsSelectionColumn,EntityType,IsSyncDatabase,IsAlwaysUpdateable,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsAllowCopy,SeqNoSelection,IsToolbarButton,IsSecure,IsHtml) VALUES (1132530,0,'Valid from','Valid from including this date (first day)','The Valid From date indicates the first day of a date range',1120694,'ValidFrom',7,'N','N','N','N','N',0,'N',15,0,0,'Y',TO_TIMESTAMP('2020-08-16 19:44:14','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2020-08-16 19:44:14','YYYY-MM-DD HH24:MI:SS'),100,617,'Y','N','LBRA','N','N','N','Y','5b8f2eb5-5c5d-4f2e-86f2-e78a9ea69f71','Y',0,'N','N','N')
;

-- 16 de ago de 2020 19:45:00 BRT
INSERT INTO AD_Column (AD_Column_ID,Version,Name,Description,Help,AD_Table_ID,ColumnName,FieldLength,IsKey,IsParent,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsEncrypted,AD_Reference_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,AD_Element_ID,IsUpdateable,IsSelectionColumn,EntityType,IsSyncDatabase,IsAlwaysUpdateable,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsAllowCopy,SeqNoSelection,IsToolbarButton,IsSecure,IsHtml) VALUES (1132531,0,'Valid to','Valid to including this date (last day)','The Valid To date indicates the last day of a date range',1120694,'ValidTo',7,'N','N','N','N','N',0,'N',15,0,0,'Y',TO_TIMESTAMP('2020-08-16 19:44:59','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2020-08-16 19:44:59','YYYY-MM-DD HH24:MI:SS'),100,618,'Y','N','LBRA','N','N','N','Y','aac72312-500c-4c40-b51e-700e61d19231','Y',0,'N','N','N')
;

-- 16 de ago de 2020 19:46:05 BRT
UPDATE AD_Column SET FKConstraintName='ADClient_LBROrgIEST', FKConstraintType='N',Updated=TO_TIMESTAMP('2020-08-16 19:46:05','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1132515
;

-- 16 de ago de 2020 19:46:05 BRT
UPDATE AD_Column SET FKConstraintName='ADOrg_LBROrgIEST', FKConstraintType='N',Updated=TO_TIMESTAMP('2020-08-16 19:46:05','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1132516
;

-- 16 de ago de 2020 19:46:05 BRT
UPDATE AD_Column SET FKConstraintName='CreatedBy_LBROrgIEST', FKConstraintType='N',Updated=TO_TIMESTAMP('2020-08-16 19:46:05','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1132518
;

-- 16 de ago de 2020 19:46:05 BRT
UPDATE AD_Column SET FKConstraintName='CRegion_LBROrgIEST', FKConstraintType='N',Updated=TO_TIMESTAMP('2020-08-16 19:46:05','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1132528
;

-- 16 de ago de 2020 19:46:05 BRT
UPDATE AD_Column SET FKConstraintName='UpdatedBy_LBROrgIEST', FKConstraintType='N',Updated=TO_TIMESTAMP('2020-08-16 19:46:05','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1132526
;

-- 16 de ago de 2020 19:46:05 BRT
CREATE TABLE LBR_OrgIEST (AD_Client_ID NUMERIC(10) NOT NULL, AD_Org_ID NUMERIC(10) NOT NULL, Created TIMESTAMP DEFAULT statement_timestamp() NOT NULL, CreatedBy NUMERIC(10) NOT NULL, C_Region_ID NUMERIC(10) DEFAULT NULL , Description VARCHAR(255) DEFAULT NULL , IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL, LBR_IEST VARCHAR(30) NOT NULL, LBR_OrgIEST_ID NUMERIC(10) NOT NULL, LBR_OrgIEST_UU VARCHAR(36) DEFAULT NULL , Updated TIMESTAMP DEFAULT statement_timestamp() NOT NULL, UpdatedBy NUMERIC(10) NOT NULL, ValidFrom TIMESTAMP DEFAULT NULL , ValidTo TIMESTAMP DEFAULT NULL , CONSTRAINT LBR_OrgIEST_Key PRIMARY KEY (LBR_OrgIEST_ID), CONSTRAINT LBR_OrgIEST_UU_idx UNIQUE (LBR_OrgIEST_UU))
;
...
There are two reasons for de-activating and not deleting records:
(1) The system requires the record for audit purposes.
(2) The record is referenced by other records. E.g., you cannot delete a Business Partner, if there are invoices for this partner record existing. You de-activate the Business Partner and prevent that this record is used for future entries.',1120401,1132522,'Y',1,80,'N','N','N','N',0,0,'Y',TO_TIMESTAMP('2020-08-16 19:48:57','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2020-08-16 19:48:57','YYYY-MM-DD HH24:MI:SS'),100,'N','Y','LBRA','8e5e1a06-b2ea-41ab-994b-181b80e2b757','Y',70,2,2)
;

-- 16 de ago de 2020 19:49:48 BRT
UPDATE AD_Field SET IsDisplayed='Y', SeqNo=40, AD_Reference_Value_ID=NULL, AD_Val_Rule_ID=NULL, XPosition=1, IsToolbarButton=NULL,Updated=TO_TIMESTAMP('2020-08-16 19:49:48','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1129913
;

-- 16 de ago de 2020 19:49:48 BRT
UPDATE AD_Field SET IsDisplayed='Y', SeqNo=50, AD_Reference_Value_ID=NULL, AD_Val_Rule_ID=NULL, XPosition=4, IsToolbarButton=NULL,Updated=TO_TIMESTAMP('2020-08-16 19:49:48','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1129912
;
...
UPDATE AD_Field SET SeqNo=0, AD_Reference_Value_ID=NULL, AD_Val_Rule_ID=NULL, IsToolbarButton=NULL,Updated=TO_TIMESTAMP('2020-08-16 19:49:49','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1129911
;

-- 16 de ago de 2020 19:50:17 BRT
UPDATE AD_Column SET IsMandatory='Y',Updated=TO_TIMESTAMP('2020-08-16 19:50:17','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1132528
;

-- 16 de ago de 2020 19:50:29 BRT
INSERT INTO t_alter_column values('lbr_orgiest','C_Region_ID','NUMERIC(10)',null,null)
;
