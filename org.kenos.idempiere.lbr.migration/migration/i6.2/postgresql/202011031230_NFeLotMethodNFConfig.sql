...
UPDATE AD_Column SET DefaultValue=NULL, ReadOnlyLogic=NULL,Updated=TO_TIMESTAMP('2020-11-03 12:37:24','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1132766
;

-- 3 de nov de 2020 11:50:13 BRT
ALTER TABLE LBR_NFConfig ADD COLUMN LBR_NFeLotMethod CHAR(1) DEFAULT NULL 
;
