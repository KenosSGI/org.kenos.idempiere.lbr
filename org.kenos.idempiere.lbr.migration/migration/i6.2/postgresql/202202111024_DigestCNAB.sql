...
INSERT INTO AD_Menu (AD_Menu_ID,Name,"action",AD_Window_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,IsSummary,IsSOTrx,IsReadOnly,EntityType,IsCentrallyMaintained,AD_Menu_UU) VALUES (1120401,'Bank Slip Config','W',1120165,0,0,'Y',TO_TIMESTAMP('2022-02-11 10:17:33','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2022-02-11 10:17:33','YYYY-MM-DD HH24:MI:SS'),100,'N','Y','N','LBRA','Y','46318f3f-4247-4a80-8dcc-590ce42a8001')
;

-- 11 de fev de 2022 10:17:34 BRT
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo, AD_TreeNodeMM_UU) SELECT t.AD_Client_ID, 0, 'Y', statement_timestamp(), 100, statement_timestamp(), 100,t.AD_Tree_ID, 1120401, 0, 999, Generate_UUID() FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=1120401)
;
...
-- 11 de fev de 2022 10:18:05 BRT
UPDATE AD_TreeNodeMM SET Parent_ID=1000001, SeqNo=1, Updated=statement_timestamp() WHERE AD_Tree_ID=10 AND Node_ID=1120401
;
