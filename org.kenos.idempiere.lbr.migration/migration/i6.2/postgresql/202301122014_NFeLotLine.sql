...
There are two reasons for de-activating and not deleting records:
(1) The system requires the record for audit purposes.
(2) The record is referenced by other records. E.g., you cannot delete a Business Partner, if there are invoices for this partner record existing. You de-activate the Business Partner and prevent that this record is used for future entries.',1120509,1133794,'Y',1,50,'N','N','N','N',0,0,'Y',TO_TIMESTAMP('2023-01-12 16:57:30','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2023-01-12 16:57:30','YYYY-MM-DD HH24:MI:SS'),100,'N','Y','LBRA','e1e1a1b4-e6ce-4414-86bc-e5d1b037f274','Y',40,2,2)
;

-- 12 de jan de 2023 16:57:45 BRT
UPDATE AD_Field SET IsDisplayed='Y', SeqNo=30, AD_Reference_Value_ID=NULL, AD_Val_Rule_ID=NULL, XPosition=1, IsToolbarButton=NULL,Updated=TO_TIMESTAMP('2023-01-12 16:57:45','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1131737
;

-- 12 de jan de 2023 16:57:45 BRT
UPDATE AD_Field SET IsDisplayed='Y', SeqNo=40, AD_Reference_Value_ID=NULL, AD_Val_Rule_ID=NULL, XPosition=4, IsToolbarButton=NULL,Updated=TO_TIMESTAMP('2023-01-12 16:57:45','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1131734
;

-- 12 de jan de 2023 16:57:45 BRT
UPDATE AD_Field SET SeqNo=0, AD_Reference_Value_ID=NULL, AD_Val_Rule_ID=NULL, IsToolbarButton=NULL,Updated=TO_TIMESTAMP('2023-01-12 16:57:45','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1131736
;

-- 12 de jan de 2023 16:57:45 BRT
UPDATE AD_Field SET SeqNo=0, AD_Reference_Value_ID=NULL, AD_Val_Rule_ID=NULL, IsToolbarButton=NULL,Updated=TO_TIMESTAMP('2023-01-12 16:57:45','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1131735
;

-- 12 de jan de 2023 16:58:08 BRT
UPDATE AD_Field SET SeqNoGrid=0,IsDisplayedGrid='N', Updated=statement_timestamp(), UpdatedBy=100 WHERE AD_Field_ID=1131734
;

-- 12 de jan de 2023 16:58:08 BRT
UPDATE AD_Field SET SeqNoGrid=0,IsDisplayedGrid='N', Updated=statement_timestamp(), UpdatedBy=100 WHERE AD_Field_ID=1131733
;

-- 12 de jan de 2023 16:58:08 BRT
UPDATE AD_Field SET SeqNoGrid=10,IsDisplayedGrid='Y', Updated=statement_timestamp(), UpdatedBy=100 WHERE AD_Field_ID=1131737
;

-- 12 de jan de 2023 16:58:08 BRT
UPDATE AD_Field SET SeqNoGrid=20,IsDisplayedGrid='Y', Updated=statement_timestamp(), UpdatedBy=100 WHERE AD_Field_ID=1131738
;

-- 12 de jan de 2023 17:02:23 BRT
UPDATE AD_Tab SET OrderByClause='LBR_NFeLot.Created DESC',Updated=TO_TIMESTAMP('2023-01-12 17:02:23','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=1100001
;

-- 12 de jan de 2023 17:02:58 BRT
UPDATE AD_Column SET IsAllowCopy='N',Updated=TO_TIMESTAMP('2023-01-12 17:02:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1100075
;

-- 12 de jan de 2023 17:03:01 BRT
UPDATE AD_Column SET IsAllowCopy='N',Updated=TO_TIMESTAMP('2023-01-12 17:03:01','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1100074
;

-- 12 de jan de 2023 17:03:07 BRT
UPDATE AD_Column SET IsAllowCopy='N',Updated=TO_TIMESTAMP('2023-01-12 17:03:07','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1100079
;

-- 12 de jan de 2023 17:03:12 BRT
UPDATE AD_Column SET IsAllowCopy='N',Updated=TO_TIMESTAMP('2023-01-12 17:03:12','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1100066
;

-- 12 de jan de 2023 17:03:16 BRT
UPDATE AD_Column SET IsAllowCopy='N',Updated=TO_TIMESTAMP('2023-01-12 17:03:16','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1100077
;

-- 12 de jan de 2023 17:03:23 BRT
UPDATE AD_Column SET IsAllowCopy='N',Updated=TO_TIMESTAMP('2023-01-12 17:03:23','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1100069
;

-- 12 de jan de 2023 17:04:19 BRT
UPDATE AD_Column SET IsAllowCopy='N',Updated=TO_TIMESTAMP('2023-01-12 17:04:19','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1100067
;

-- 12 de jan de 2023 17:04:22 BRT
UPDATE AD_Column SET IsAllowCopy='N',Updated=TO_TIMESTAMP('2023-01-12 17:04:22','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1100078
;

-- 12 de jan de 2023 21:06:54 BRT
UPDATE AD_Column SET IsUpdateable='N', FKConstraintName='LBRNFeLot_LBRNFeLotLine', FKConstraintType='N',Updated=TO_TIMESTAMP('2023-01-12 21:06:54','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1133781
;

-- 12 de jan de 2023 21:06:54 BRT
UPDATE AD_Column SET FKConstraintName='LBRNotaFiscal_LBRNFeLotLine', FKConstraintType='N',Updated=TO_TIMESTAMP('2023-01-12 21:06:54','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1133799
;

-- 12 de jan de 2023 21:06:54 BRT
CREATE TABLE LBR_NFeLotLine (AD_Client_ID NUMERIC(10) NOT NULL, AD_Org_ID NUMERIC(10) NOT NULL, Created TIMESTAMP DEFAULT statement_timestamp() NOT NULL, CreatedBy NUMERIC(10) NOT NULL, IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL, LBR_NFeLotLine_ID NUMERIC(10) NOT NULL, LBR_NFeLotLine_UU VARCHAR(36) DEFAULT NULL , LBR_NFeLot_ID NUMERIC(10) NOT NULL, LBR_NotaFiscal_ID NUMERIC(10) DEFAULT NULL , Updated TIMESTAMP DEFAULT statement_timestamp() NOT NULL, UpdatedBy NUMERIC(10) NOT NULL, CONSTRAINT LBR_NFeLotLine_Key PRIMARY KEY (LBR_NFeLotLine_ID), CONSTRAINT LBR_NFeLotLine_UU_idx UNIQUE (LBR_NFeLotLine_UU))
;
...
UPDATE AD_Column SET IsUpdateable='N',Updated=TO_TIMESTAMP('2023-01-12 21:07:13','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1133138
;

-- 12 de jan de 2023 21:08:29 BRT
INSERT INTO AD_Message (MsgType,MsgText,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,AD_Message_ID,Value,EntityType,AD_Message_UU) VALUES ('E','The Nota Fiscal is repeated in the same lot',0,0,'Y',TO_TIMESTAMP('2023-01-12 21:08:24','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2023-01-12 21:08:24','YYYY-MM-DD HH24:MI:SS'),100,1120079,'NotaFiscalRepeatedInLot','LBRA','9fbb487e-d749-4e8a-a495-0e3668443a6e')
;

-- 12 de jan de 2023 21:08:52 BRT
INSERT INTO AD_TableIndex (AD_Client_ID,AD_Org_ID,AD_TableIndex_ID,AD_TableIndex_UU,Created,CreatedBy,EntityType,IsActive,Name,Updated,UpdatedBy,AD_Table_ID,IsCreateConstraint,IsUnique,Processing,AD_Message_ID,TableIndexDrop,IsKey) VALUES (0,0,1120016,'a55f68d8-8cc5-444a-9813-d1d18633a06d',TO_TIMESTAMP('2023-01-12 21:08:52','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y','Uniq_LBR_NFeLotLine_LBR_NotaFiscal_ID',TO_TIMESTAMP('2023-01-12 21:08:52','YYYY-MM-DD HH24:MI:SS'),100,1120758,'Y','Y','N',1120079,'N','N')
;

-- 12 de jan de 2023 21:09:12 BRT
INSERT INTO AD_IndexColumn (AD_Client_ID,AD_Org_ID,AD_IndexColumn_ID,AD_IndexColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_Column_ID,AD_TableIndex_ID,SeqNo) VALUES (0,0,1120026,'cd3929cc-5545-46c0-994c-2dfb2b31bbb2',TO_TIMESTAMP('2023-01-12 21:09:07','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_TIMESTAMP('2023-01-12 21:09:07','YYYY-MM-DD HH24:MI:SS'),100,1133781,1120016,1)
;

-- 12 de jan de 2023 21:09:27 BRT
INSERT INTO AD_IndexColumn (AD_Client_ID,AD_Org_ID,AD_IndexColumn_ID,AD_IndexColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_Column_ID,AD_TableIndex_ID,SeqNo) VALUES (0,0,1120027,'10d6a38d-95c9-438f-a979-65b92a2302c0',TO_TIMESTAMP('2023-01-12 21:09:27','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y',TO_TIMESTAMP('2023-01-12 21:09:27','YYYY-MM-DD HH24:MI:SS'),100,1133799,1120016,2)
;
