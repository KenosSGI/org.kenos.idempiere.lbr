...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Field SET IsCentrallyMaintained='N',Updated=TO_TIMESTAMP('2019-09-25 10:20:25','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1128207
;

-- 25/09/2019 10h33min16s BRT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Field_Trl SET IsTranslated='Y',Name='Gerar Estoque Escriturado',Description='Gerar Estoque Escriturado para o Bloco K',Help='Gerar Estoque Escriturado para o Bloco K',Updated=TO_TIMESTAMP('2019-09-25 10:33:16','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1128207 AND AD_Language='pt_BR'
;
