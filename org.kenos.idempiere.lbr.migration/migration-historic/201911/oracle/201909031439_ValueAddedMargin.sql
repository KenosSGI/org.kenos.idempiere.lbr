...
INSERT INTO AD_Element (AD_Client_ID,AD_Element_ID,AD_Org_ID,ColumnName,Created,CreatedBy,Description,EntityType,IsActive,Name,PrintName,Updated,UpdatedBy) VALUES (0,1122884,0,'LBR_VAM',TO_DATE('2019-09-03 14:28:49','YYYY-MM-DD HH24:MI:SS'),100,'VAT (value-added margin)','LBRA','Y','VAM','VAM',TO_DATE('2019-09-03 14:28:49','YYYY-MM-DD HH24:MI:SS'),100)
;
...
UPDATE AD_Column SET EntityType='LBRA',Updated=TO_DATE('2019-09-03 14:30:03','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1131526
;

-- 03/09/2019 14h30min4s BRT
ALTER TABLE LBR_NotaFiscalLine ADD LBR_VAM NUMBER DEFAULT 0 NOT NULL
;

-- 03/09/2019 14h30min36s BRT
UPDATE AD_Element SET Description='VAM (value-added margin)',Updated=TO_DATE('2019-09-03 14:30:36','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=1122884
;
...
UPDATE AD_Element_Trl SET IsTranslated='Y',Name='MVA',PrintName='MVA',Description='MVA (Margem de Valor Agregado)',Updated=TO_DATE('2019-09-03 14:31:59','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=1122884 AND AD_Language='pt_BR'
;

-- 03/09/2019 14h33min43s BRT
UPDATE AD_Field SET DisplayLength=22,Updated=TO_DATE('2019-09-03 14:33:43','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1128204
;
