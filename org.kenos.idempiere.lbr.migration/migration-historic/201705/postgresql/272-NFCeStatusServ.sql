...
UPDATE AD_Process SET Description='Check the status of reception services of NF-e', Help='This process will try to check the condition of SeFaz services regarding NF-e reception', Name='Check the status of NF-e services',Updated=TO_TIMESTAMP('2017-05-18 11:11:42','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=1120000
;
...
UPDATE AD_Menu SET Description='Check the status of reception services of NF-e', IsActive='Y', Name='Check the status of NF-e services',Updated=TO_TIMESTAMP('2017-05-18 11:11:43','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Menu_ID=1120001
;
...
UPDATE AD_Process_Trl SET Description='Testa o status do serviço de recepção da NF-e e NFC-e',Updated=TO_TIMESTAMP('2017-05-18 11:11:56','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=1120000 AND AD_Language='pt_BR'
;

-- 18/05/2017 11h12min10s BRT
UPDATE AD_Process SET Description='Check the status of reception services of NF-e and NFC-e', Help='This process will try to check the condition of SeFaz services regarding NF-e and NFC-e reception',Updated=TO_TIMESTAMP('2017-05-18 11:12:10','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=1120000
;
...
-- 18/05/2017 11h12min10s BRT
UPDATE AD_Menu SET Description='Check the status of reception services of NF-e and NFC-e', IsActive='Y', Name='Check the status of NF-e services',Updated=TO_TIMESTAMP('2017-05-18 11:12:10','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Menu_ID=1120001
;
...
INSERT INTO AD_Ref_List (AD_Client_ID,AD_Org_ID,AD_Ref_List_ID,AD_Reference_ID,Created,CreatedBy,EntityType,IsActive,Name,Updated,UpdatedBy,Value) VALUES (0,0,1121811,1120257,TO_TIMESTAMP('2017-05-18 11:16:45','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y','Nota Fiscal Eletrônica',TO_TIMESTAMP('2017-05-18 11:16:45','YYYY-MM-DD HH24:MI:SS'),100,'55')
;
...
INSERT INTO AD_Ref_List (AD_Client_ID,AD_Org_ID,AD_Ref_List_ID,AD_Reference_ID,Created,CreatedBy,EntityType,IsActive,Name,Updated,UpdatedBy,Value) VALUES (0,0,1121812,1120257,TO_TIMESTAMP('2017-05-18 11:17:02','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y','Nota Fiscal de Consumidor Eletrônica',TO_TIMESTAMP('2017-05-18 11:17:02','YYYY-MM-DD HH24:MI:SS'),100,'65')
;
...
UPDATE AD_Process_Para SET AD_Reference_Value_ID=1120257,Updated=TO_TIMESTAMP('2017-05-18 11:17:27','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=1120353
;
