...
UPDATE AD_Field SET DisplayLogic='@DeliveryViaRule@=S', IsSameLine='N', SeqNo=255,Updated=TO_TIMESTAMP('2016-11-04 09:30:16','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=54716
;

-- 04/11/2016 9h42min25s BRST
