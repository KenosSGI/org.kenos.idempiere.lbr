...
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,113,0,1120192,1120355,19,'AD_Org_ID',TO_DATE('2017-05-22 18:23:38','YYYY-MM-DD HH24:MI:SS'),100,'Organizational entity within client','LBRA',10,'An organization is a unit of your client or legal entity - examples are store, department. You can share data between organizations.','Y','Y','Y','N','Organization',10,TO_DATE('2017-05-22 18:23:38','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- 22/05/2017 19h43min18s BRT
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo) SELECT t.AD_Client_ID, 0, 'Y', SysDate, 100, SysDate, 100,t.AD_Tree_ID, 1120293, 0, 999 FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=1120293)
;
...
-- 22/05/2017 19h43min24s BRT
UPDATE AD_TreeNodeMM SET Parent_ID=1000023, SeqNo=20, Updated=SysDate WHERE AD_Tree_ID=10 AND Node_ID=1120002
;
...
UPDATE AD_Menu_Trl SET IsTranslated='Y',Name='Consultar Protocolo da NFe',Updated=TO_DATE('2017-05-22 19:43:36','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Menu_ID=1120293 AND AD_Language='pt_BR'
;

-- 22/05/2017 19h43min47s BRT
UPDATE AD_Process_Trl SET Name='Consultar Protocolo da NFe',Description='Consulta o protocolo da NFe na SeFaz',Updated=TO_DATE('2017-05-22 19:43:47','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=1120192 AND AD_Language='pt_BR'
;
