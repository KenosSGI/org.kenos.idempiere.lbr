...
INSERT INTO AD_Element (AD_Client_ID,AD_Element_ID,AD_Org_ID,ColumnName,Created,CreatedBy,Description,EntityType,Help,IsActive,Name,PrintName,Updated,UpdatedBy) VALUES (0,1000344,0,'lbr_Ref_C_InvoiceLine_ID',TO_DATE('2009-01-26 11:13:48','YYYY-MM-DD HH24:MI:SS'),100,'Reference Invoice Line','LBRA','Reference Invoice Line','Y','Reference Invoice Line','Reference Invoice Line',TO_DATE('2009-01-26 11:13:48','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- Default comment for updating dictionary
UPDATE AD_Element_Trl SET IsTranslated='Y',Name='Linha da Fatura de referência',PrintName='Linha da Fatura de referência',Description='Linha da Fatura de referência para criação desta linha',Help='Linha da Fatura de referência para criação desta linha',Updated=TO_DATE('2009-01-26 11:14:02','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=1000344 AND AD_Language='pt_BR'
;

-- 26/01/2009 11h14min48s BRST
-- Default comment for updating dictionary
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Table_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,IsAlwaysUpdateable,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,Version) VALUES (0,1001022,1000344,0,18,260,'lbr_Ref_C_InvoiceLine_ID',TO_DATE('2009-01-26 11:14:47','YYYY-MM-DD HH24:MI:SS'),100,'Reference Invoice Line','LBRA',22,'Reference Invoice Line','Y','N','N','N','N','N','N','N','N','N','Y','Reference Invoice Line',0,TO_DATE('2009-01-26 11:14:47','YYYY-MM-DD HH24:MI:SS'),100,0)
;
...
-- Default comment for updating dictionary
UPDATE AD_Element_Trl SET IsTranslated='Y',Name='Tipo de Documento Base LBR',PrintName='Tipo de Documento Base LBR',Description='Tipo de Documento Base LBR',Help='Tipo de Documento Base LBR',Updated=TO_DATE('2009-01-26 11:18:30','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=1000345 AND AD_Language='pt_BR'
;
...
-- Default comment for updating dictionary
UPDATE AD_Element SET ColumnName='lbr_DocBaseType',Updated=TO_DATE('2009-01-26 11:19:13','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=1000345
;
...
-- 26/01/2009 11h19min13s BRST
-- Default comment for updating dictionary
UPDATE AD_PrintFormatItem pi SET PrintName='LBR DocBaseType', Name='LBR DocBaseType' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=1000345)
;
...
-- Default comment for updating dictionary
INSERT INTO AD_Element (AD_Client_ID,AD_Element_ID,AD_Org_ID,ColumnName,Created,CreatedBy,Description,EntityType,Help,IsActive,Name,PrintName,Updated,UpdatedBy) VALUES (0,1000348,0,'lbr_Dest_C_InvoiceLine_ID',TO_DATE('2009-01-26 11:31:03','YYYY-MM-DD HH24:MI:SS'),100,'Destination Invoice Line','LBRA','Destination Invoice Line','Y','Destination Invoice Line','Destination Invoice Line',TO_DATE('2009-01-26 11:31:03','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- Default comment for updating dictionary
UPDATE AD_Element_Trl SET IsTranslated='Y',Name='Linha da Fatura de Destino',PrintName='Linha da Fatura de Destino',Description='Linha da Fatura de Destino',Help='Linha da Fatura de Destino',Updated=TO_DATE('2009-01-26 11:33:05','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=1000348 AND AD_Language='pt_BR'
;

-- 26/01/2009 11h34min57s BRST
-- Default comment for updating dictionary
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Reference_Value_ID,AD_Table_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,IsAlwaysUpdateable,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,Version) VALUES (0,1001025,1000348,0,18,1000042,1000037,'lbr_Dest_C_InvoiceLine_ID',TO_DATE('2009-01-26 11:34:57','YYYY-MM-DD HH24:MI:SS'),100,'Destination Invoice Line','U',22,'Destination Invoice Line','Y','N','N','N','N','N','N','N','N','N','Y','Destination Invoice Line',0,TO_DATE('2009-01-26 11:34:57','YYYY-MM-DD HH24:MI:SS'),100,0)
;
...
-- Default comment for updating dictionary
UPDATE AD_SysConfig SET Value='100-trunk/009-OtherNF_TableChanges.sql',Updated=TO_TIMESTAMP('2008-11-27 15:18:15','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_SysConfig_ID=1100006
;
