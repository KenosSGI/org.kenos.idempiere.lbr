...
-- Default comment for updating dictionary
ALTER TABLE M_PriceList ADD lbr_BrazilianPriceList CHAR(1) DEFAULT 'N' CHECK (lbr_BrazilianPriceList IN ('Y','N')) NOT NULL
;
...
-- Default comment for updating dictionary
CREATE TABLE LBR_TaxIncludedList (LBR_TaxIncludedList_ID NUMBER(10) NOT NULL, CONSTRAINT LBR_TaxIncludedList_Key PRIMARY KEY (LBR_TaxIncludedList_ID))
;
...
-- Default comment for updating dictionary
ALTER TABLE LBR_TaxIncludedList ADD AD_Client_ID NUMBER(10) NOT NULL
;
...
-- 01/12/2008 14h39min16s BRST
-- Default comment for updating dictionary
ALTER TABLE LBR_TaxIncludedList ADD AD_Org_ID NUMBER(10) NOT NULL
;
...
-- Default comment for updating dictionary
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Table_ID,ColumnName,Created,CreatedBy,DefaultValue,Description,EntityType,FieldLength,Help,IsActive,IsAlwaysUpdateable,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,Version) VALUES (0,1001005,348,0,20,1000041,'IsActive',TO_TIMESTAMP('2008-12-01 14:39:52','YYYY-MM-DD HH24:MI:SS'),100,'Y','The record is active in the system','LBRA',1,'There are two methods of making records unavailable in the system: One is to delete the record, the other is to de-activate the record. A de-activated record is not available for selection, but available for reports. There are two reasons for de-activating and not deleting records: (1) The system requires the record for audit purposes. (2) The record is referenced by other records. E.g., you cannot delete a Business Partner, if there are invoices for this partner record existing. You de-activate the Business Partner and prevent that this record is used for future entries.','Y','N','N','N','N','Y','N','N','N','N','Y','Active',0,TO_TIMESTAMP('2008-12-01 14:39:52','YYYY-MM-DD HH24:MI:SS'),100,0)
;
...
-- Default comment for updating dictionary
ALTER TABLE LBR_TaxIncludedList ADD IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL
;
...
-- 01/12/2008 14h40min17s BRST
-- Default comment for updating dictionary
ALTER TABLE LBR_TaxIncludedList ADD Created date NOT NULL
;
...
-- Default comment for updating dictionary
ALTER TABLE LBR_TaxIncludedList ADD CreatedBy NUMBER(10) NOT NULL
;
...
-- Default comment for updating dictionary
ALTER TABLE LBR_TaxIncludedList ADD Updated DATE NOT NULL
;
...
-- 01/12/2008 14h41min25s BRST
-- Default comment for updating dictionary
ALTER TABLE LBR_TaxIncludedList ADD UpdatedBy NUMBER(10) NOT NULL
;
...
-- Default comment for updating dictionary
ALTER TABLE LBR_TaxIncludedList ADD M_PriceList_ID NUMBER(10) NOT NULL
;
...
-- Default comment for updating dictionary
ALTER TABLE LBR_TaxIncludedList ADD C_Tax_ID NUMBER(10) NOT NULL
;
...
-- Default comment for updating dictionary
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,1001005,1000981,0,1000041,TO_TIMESTAMP('2008-12-01 14:47:49','YYYY-MM-DD HH24:MI:SS'),100,'The record is active in the system',1,'LBRA','There are two methods of making records unavailable in the system: One is to delete the record, the other is to de-activate the record. A de-activated record is not available for selection, but available for reports. There are two reasons for de-activating and not deleting records: (1) The system requires the record for audit purposes. (2) The record is referenced by other records. E.g., you cannot delete a Business Partner, if there are invoices for this partner record existing. You de-activate the Business Partner and prevent that this record is used for future entries.','Y','Y','Y','N','N','N','N','N','Active',TO_TIMESTAMP('2008-12-01 14:47:49','YYYY-MM-DD HH24:MI:SS'),100)
;
