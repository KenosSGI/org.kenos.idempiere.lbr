...
-- Default comment for updating dictionary
ALTER TABLE AD_OrgInfo ADD LBR_DocPrint_ID NUMERIC(10)
;
...
INSERT INTO adempiere.ad_field_trl(ad_field_id, ad_language, ad_client_id, ad_org_id, isactive, created, createdby, updated, updatedby, name, description, help, istranslated)
  VALUES(1000975, 'pt_BR', 0, 0, 'Y', sysdate, 100, sysdate, 100, 'Documento Nota Fiscal', 'Define o Documento base para Impressão da Nota Fiscal', 'Define o Documento base para Impressão da Nota Fiscal', 'Y');
