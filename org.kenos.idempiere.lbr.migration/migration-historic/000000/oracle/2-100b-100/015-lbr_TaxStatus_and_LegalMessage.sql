...
-- Default comment for updating dictionary
ALTER TABLE LBR_CFOPLine ADD lbr_TaxStatus CHAR(2)
;
...
-- Default comment for updating dictionary
ALTER TABLE LBR_LegalMessage ADD AD_Client_ID NUMERIC(10) NOT NULL
;
...
-- Default comment for updating dictionary
ALTER TABLE LBR_LegalMessage ADD AD_Org_ID NUMERIC(10) NOT NULL
;
...
-- Default comment for updating dictionary
ALTER TABLE LBR_LegalMessage ADD IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL
;
...
-- Default comment for updating dictionary
ALTER TABLE LBR_LegalMessage ADD Created date NOT NULL
;
...
-- Default comment for updating dictionary
ALTER TABLE LBR_LegalMessage ADD CreatedBy NUMERIC(10) NOT NULL
;
...
-- Default comment for updating dictionary
ALTER TABLE LBR_LegalMessage ADD Updated date NOT NULL
;
...
-- Default comment for updating dictionary
ALTER TABLE LBR_LegalMessage ADD UpdatedBy NUMERIC(10) NOT NULL
;
...
-- Default comment for updating dictionary
ALTER TABLE LBR_LegalMessage ADD TextMsg nvarchar2(255) NOT NULL
;
...
-- Default comment for updating dictionary
ALTER TABLE LBR_CFOPLine ADD LBR_LegalMessage_ID NUMERIC(10)
;
...
-- Default comment for updating dictionary
ALTER TABLE LBR_TaxConfig_BPGroup ADD lbr_TaxStatus CHAR(2)
;
...
-- 11/02/2008 11h2min59s BRST
-- Default comment for updating dictionary
ALTER TABLE LBR_TaxConfig_BPGroup ADD LBR_LegalMessage_ID NUMERIC(10)
;
...
-- Default comment for updating dictionary
ALTER TABLE LBR_TaxConfig_BPartner ADD lbr_TaxStatus CHAR(2)
;
...
-- Default comment for updating dictionary
ALTER TABLE LBR_TaxConfig_BPartner ADD LBR_LegalMessage_ID NUMERIC(10)
;
...
-- Default comment for updating dictionary
ALTER TABLE LBR_TaxConfig_Product ADD lbr_TaxStatus CHAR(2)
;
...
-- Default comment for updating dictionary
ALTER TABLE LBR_TaxConfig_Product ADD LBR_LegalMessage_ID NUMERIC(10)
;
...
-- Default comment for updating dictionary
ALTER TABLE LBR_TaxConfig_ProductGroup ADD lbr_TaxStatus CHAR(2)
;
...
-- Default comment for updating dictionary
ALTER TABLE LBR_TaxConfig_ProductGroup ADD LBR_LegalMessage_ID NUMERIC(10)
;
...
-- Default comment for updating dictionary
ALTER TABLE LBR_TaxConfig_Region ADD lbr_TaxStatus CHAR(2)
;
...
-- Default comment for updating dictionary
ALTER TABLE LBR_TaxConfig_Region ADD LBR_LegalMessage_ID NUMERIC(10)
;
