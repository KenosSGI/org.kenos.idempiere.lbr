...
-- Default comment for updating dictionary
ALTER TABLE C_OrderLine ADD lbr_TaxStatus nvarchar2(3)
;
...
-- Default comment for updating dictionary
ALTER TABLE C_OrderLine ADD LBR_LegalMessage_ID NUMERIC(10)
;
...
-- Default comment for updating dictionary
ALTER TABLE C_InvoiceLine ADD lbr_TaxStatus nvarchar2(3)
;
...
-- Default comment for updating dictionary
ALTER TABLE C_InvoiceLine ADD LBR_LegalMessage_ID NUMERIC(10)
;
