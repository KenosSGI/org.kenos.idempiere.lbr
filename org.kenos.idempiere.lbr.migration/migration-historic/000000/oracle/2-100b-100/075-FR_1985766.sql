...
-- Default comment for updating dictionary
ALTER TABLE LBR_Boleto ADD C_BankAccount_ID NUMERIC(10)
;
...
-- Default comment for updating dictionary
ALTER TABLE LBR_CNAB ADD C_BankAccount_ID NUMERIC(10)
;
...
-- Default comment for updating dictionary
ALTER TABLE LBR_CNAB ADD IsSelected CHAR(1) DEFAULT 'N' CHECK (IsSelected IN ('Y','N')) NOT NULL
;
