...
-- Default comment for updating dictionary
ALTER TABLE C_DocType ADD lbr_HasFiscalDocument CHAR(1) DEFAULT 'Y' CHECK (lbr_HasFiscalDocument IN ('Y','N')) NOT NULL
;
...
-- Default comment for updating dictionary
ALTER TABLE C_DocType ADD lbr_IsOwnDocument CHAR(1) DEFAULT 'Y' CHECK (lbr_IsOwnDocument IN ('Y','N')) NOT NULL
;
