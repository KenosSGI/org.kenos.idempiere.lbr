...
INSERT INTO AD_Element (AD_Client_ID,AD_Element_ID,AD_Org_ID,ColumnName,Created,CreatedBy,Description,EntityType,IsActive,Name,PrintName,Updated,UpdatedBy) VALUES (0,1120002,0,'OSEB_ContatoNFe',TO_TIMESTAMP('2010-09-30 15:02:20','YYYY-MM-DD HH24:MI:SS'),0,'Email do Usuario/Contato que servirá como remetente do XML da NFe enviado automáticamente aos Usuários/Contatos do Parceiro de Negócio.','OSEB','Y','Contato NFe','Contato NFe',TO_TIMESTAMP('2010-09-30 15:02:20','YYYY-MM-DD HH24:MI:SS'),0)
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Reference_Value_ID,AD_Table_ID,AD_Val_Rule_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,IsActive,IsAllowLogging,IsAlwaysUpdateable,IsAutocomplete,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,Version) VALUES (0,1120014,1120002,0,30,110,228,164,'OSEB_ContatoNFe',TO_TIMESTAMP('2010-09-30 15:03:09','YYYY-MM-DD HH24:MI:SS'),0,'Email do Usuario/Contato que servirá como remetente do XML da NFe enviado automáticamente aos Usuários/Contatos do Parceiro de Negócio.','U',10,'Y','Y','Y','N','N','N','N','N','N','N','N','N','Y','Contato NFe',0,TO_TIMESTAMP('2010-09-30 15:03:09','YYYY-MM-DD HH24:MI:SS'),0,0)
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,SeqNo,SortNo,Updated,UpdatedBy) VALUES (0,1120014,1120010,0,170,TO_TIMESTAMP('2010-09-30 15:07:44','YYYY-MM-DD HH24:MI:SS'),0,'Email do Usuario/Contato que servirá como remetente do XML da NFe enviado automáticamente aos Usuários/Contatos do Parceiro de Negócio.',0,'OSEB','Y','Y','Y','N','N','N','N','Y','Contato NFe',320,0,TO_TIMESTAMP('2010-09-30 15:07:44','YYYY-MM-DD HH24:MI:SS'),0)
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
ALTER TABLE AD_OrgInfo ADD COLUMN OSEB_ContatoNFe VARCHAR(10) DEFAULT NULL 
;
