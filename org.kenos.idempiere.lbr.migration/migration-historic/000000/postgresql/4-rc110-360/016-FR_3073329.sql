...
INSERT INTO AD_EntityType (AD_Client_ID,AD_EntityType_ID,AD_Org_ID,Created,CreatedBy,Description,EntityType,Help,IsActive,ModelPackage,Name,Processing,Updated,UpdatedBy,Version) VALUES (0,1120000,0,TO_TIMESTAMP('2010-09-22 10:55:31','YYYY-MM-DD HH24:MI:SS'),100,'OSeB modifications','OSEB','Entity type for OSeB Customizations and custom Extensions.','Y','org.oseb.model','OSeB','N',TO_TIMESTAMP('2010-09-22 10:55:31','YYYY-MM-DD HH24:MI:SS'),100,'1')
;
