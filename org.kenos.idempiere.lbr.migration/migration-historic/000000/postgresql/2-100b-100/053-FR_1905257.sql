...
-- 01/03/2008 10h41min14s BRT
-- Default comment for updating dictionary
INSERT INTO AD_Form_Access (AD_Org_ID,AD_Form_ID,AD_Role_ID,Created,CreatedBy,IsActive,Updated,AD_Client_ID,UpdatedBy) VALUES (0,1000003,0,TO_TIMESTAMP('2008-03-01 10:41:14','YYYY-MM-DD HH24:MI:SS'),100,'Y',TO_TIMESTAMP('2008-03-01 10:41:14','YYYY-MM-DD HH24:MI:SS'),0,100)
;

-- 01/03/2008 10h42min37s BRT
-- Default comment for updating dictionary
INSERT INTO AD_Menu (AD_Org_ID,AD_Form_ID,AD_Menu_ID,"action",Created,CreatedBy,EntityType,IsActive,IsReadOnly,IsSOTrx,IsSummary,Name,Updated,AD_Client_ID,UpdatedBy) VALUES (0,1000003,1000027,'X',TO_TIMESTAMP('2008-03-01 10:42:37','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y','N','N','N','Print Nota Fiscal',TO_TIMESTAMP('2008-03-01 10:42:37','YYYY-MM-DD HH24:MI:SS'),0,100)
;
...
-- 01/03/2008 10h42min37s BRT
-- Default comment for updating dictionary
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo) SELECT t.AD_Client_ID,0, 'Y', CURRENT_TIMESTAMP, 0, CURRENT_TIMESTAMP, 0,t.AD_Tree_ID, 1000027, 0, 999 FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=1000027)
;
...
-- Default comment for updating dictionary
ALTER TABLE LBR_DocPrint ADD COLUMN LBR_MatrixPrinter_ID NUMERIC(10)
;
