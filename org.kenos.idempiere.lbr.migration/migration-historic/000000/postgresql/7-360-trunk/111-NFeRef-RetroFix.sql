...
SELECT NextID (1153243, 'N') AS LBR_NotaFiscalDocRef_ID, AD_Client_ID, AD_Org_ID, NOW() AS Created, CreatedBy, NOW() AS Updated, UpdatedBy, 
...
DELETE FROM AD_Field WHERE AD_Column_ID=1120465
;

--	Apaga do cadastro da tabela
DELETE FROM AD_Column WHERE AD_Column_ID=1120465
;
