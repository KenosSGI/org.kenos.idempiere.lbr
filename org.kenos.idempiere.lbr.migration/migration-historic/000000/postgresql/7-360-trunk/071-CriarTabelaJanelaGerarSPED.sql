...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
CREATE TABLE LBR_TaxAssessmentLine (AD_Client_ID NUMERIC(10) NOT NULL, AD_Org_ID NUMERIC(10) NOT NULL, Amt NUMERIC NOT NULL, Created TIMESTAMP NOT NULL, CreatedBy NUMERIC(10) DEFAULT NULL , Description VARCHAR(255) DEFAULT NULL , IsActive CHAR(1) CHECK (IsActive IN ('Y','N')) NOT NULL, LBR_TaxAssessmentLine_ID NUMERIC(10) NOT NULL, LBR_TaxAssessment_ID NUMERIC(10) NOT NULL, Type VARCHAR(3) DEFAULT NULL , Updated TIMESTAMP NOT NULL, UpdatedBy NUMERIC(10) NOT NULL, CONSTRAINT LBR_TaxAssessmentLine_Key PRIMARY KEY (LBR_TaxAssessmentLine_ID))
;
