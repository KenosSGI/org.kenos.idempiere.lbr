...
-- Default comment for updating dictionary
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Table_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,IsActive,IsAlwaysUpdateable,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,Version) VALUES (0,1001032,2531,0,20,1000040,'IsCancelled',TO_TIMESTAMP('2009-02-11 18:28:59','YYYY-MM-DD HH24:MI:SS'),100,'The transaction was cancelled','LBRA',1,'Y','N','N','N','N','N','N','N','N','N','Y','Cancelled',0,TO_TIMESTAMP('2009-02-11 18:28:59','YYYY-MM-DD HH24:MI:SS'),100,0)
;
...
-- Default comment for updating dictionary
ALTER TABLE LBR_OtherNFLine ADD COLUMN IsCancelled CHAR(1) CHECK (IsCancelled IN ('Y','N'))
;

-- 11/02/2009 18h29min3s BRST
-- Default comment for updating dictionary
UPDATE AD_Column SET IsUpdateable='N',Updated=TO_TIMESTAMP('2009-02-11 18:29:03','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1001032
;

-- 11/02/2009 18h29min22s BRST
-- Default comment for updating dictionary
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,1001032,1001054,0,1000045,TO_TIMESTAMP('2009-02-11 18:29:22','YYYY-MM-DD HH24:MI:SS'),100,'The transaction was cancelled',1,'LBRA','Y','Y','Y','N','N','N','N','N','Cancelled',TO_TIMESTAMP('2009-02-11 18:29:22','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- Default comment for updating dictionary
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_TIMESTAMP('2009-02-11 18:29:33','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1001054
;

-- 11/02/2009 18h29min51s BRST
-- Default comment for updating dictionary
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,1001032,1001055,0,1000043,TO_TIMESTAMP('2009-02-11 18:29:50','YYYY-MM-DD HH24:MI:SS'),100,'The transaction was cancelled',1,'LBRA','Y','Y','Y','N','N','N','N','N','Cancelled',TO_TIMESTAMP('2009-02-11 18:29:50','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- Default comment for updating dictionary
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_TIMESTAMP('2009-02-11 18:29:57','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1001055
;

-- 11/02/2009 18h44min53s BRST
-- Default comment for updating dictionary
UPDATE AD_Column SET DefaultValue='''N''', IsUpdateable='Y',Updated=TO_TIMESTAMP('2009-02-11 18:44:53','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1001032
;

-- 11/02/2009 18h44min54s BRST
-- Default comment for updating dictionary
insert into t_alter_column values('lbr_othernfline','IsCancelled','CHAR(1)',null,'N')
;

-- 11/02/2009 18h45min2s BRST
-- Default comment for updating dictionary
UPDATE AD_Column SET IsUpdateable='N',Updated=TO_TIMESTAMP('2009-02-11 18:45:02','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1001032
;
