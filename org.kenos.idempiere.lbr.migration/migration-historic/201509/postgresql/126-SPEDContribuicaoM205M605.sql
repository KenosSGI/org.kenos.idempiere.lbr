...
INSERT INTO AD_Element (AD_Client_ID,AD_Element_ID,AD_Org_ID,ColumnName,Created,CreatedBy,EntityType,IsActive,Name,PrintName,Updated,UpdatedBy) VALUES (0,1121753,0,'LBR_IsCumulativeRegime',TO_TIMESTAMP('2015-08-03 16:18:02','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y','Cumulative Regime','Cumulative Regime',TO_TIMESTAMP('2015-08-03 16:18:02','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Table_ID,ColumnName,Created,CreatedBy,EntityType,FieldLength,IsActive,IsAllowLogging,IsAlwaysUpdateable,IsAutocomplete,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,Version) VALUES (0,1126615,1121753,0,20,1120331,'LBR_IsCumulativeRegime',TO_TIMESTAMP('2015-08-03 16:22:25','YYYY-MM-DD HH24:MI:SS'),100,'LBRA',1,'Y','Y','N','N','N','N','N','N','N','N','N','N','Y','Cumulative Regime',0,TO_TIMESTAMP('2015-08-03 16:22:25','YYYY-MM-DD HH24:MI:SS'),100,0)
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
ALTER TABLE LBR_TaxAssessment ADD COLUMN LBR_IsCumulativeRegime CHAR(1) DEFAULT NULL CHECK (LBR_IsCumulativeRegime IN ('Y','N'))
;

-- 03/08/2015 16h24min47s BRT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,DisplayLength,EntityType,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,SeqNo,SortNo,Updated,UpdatedBy) VALUES (0,1126615,1125413,0,1120117,TO_TIMESTAMP('2015-08-03 16:24:46','YYYY-MM-DD HH24:MI:SS'),100,22,'LBRA','Y','Y','Y','N','N','N','N','N','Cumulative Regime',250,0,TO_TIMESTAMP('2015-08-03 16:24:46','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Element SET Description='For PIS and COFINS Tax', Help='For PIS and COFINS Tax',Updated=TO_TIMESTAMP('2015-08-03 16:25:27','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=1121753
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Element_Trl SET IsTranslated='Y',Name='Regime Cumulativo',PrintName='Regime Cumulativo',Updated=TO_TIMESTAMP('2015-08-03 16:26:22','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=1121753 AND AD_Language='pt_BR'
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Field SET DisplayLogic='@LBR_TaxName_ID@ = 1106001 | @LBR_TaxName_ID@ = 1106002',AD_FieldGroup_ID=125,Updated=TO_TIMESTAMP('2015-08-03 16:33:21','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1125413
;
