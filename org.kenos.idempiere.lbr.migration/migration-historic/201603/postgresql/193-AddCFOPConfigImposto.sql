...
UPDATE AD_Column SET IsActive='Y',Updated=TO_TIMESTAMP('2016-02-26 17:13:26','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1106048
;

-- 26/02/2016 17h14min16s BRT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_FieldGroup_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsMandatory,IsReadOnly,IsSameLine,Name,SeqNo,Updated,UpdatedBy) VALUES (0,1106048,111,1125717,0,1106002,TO_TIMESTAMP('2016-02-26 17:14:15','YYYY-MM-DD HH24:MI:SS'),100,'Primary key table LBR_CFOP',10,'U','Primary key table LBR_CFOP','Y','Y','Y','N','N','N','Y','N','Y','CFOP',265,TO_TIMESTAMP('2016-02-26 17:14:15','YYYY-MM-DD HH24:MI:SS'),100)
;
