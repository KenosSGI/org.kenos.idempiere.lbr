...
UPDATE AD_Process_Trl SET IsTranslated='Y',Name='Processar Retorno do RPS',Description='Processar Retorno do RPS',Help='Processa o arquivo de retorno do RPS',Updated=TO_TIMESTAMP('2016-02-04 13:54:26','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=1120164 AND AD_Language='pt_BR'
;

-- 04/02/2016 13h55min28s BRST
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,EntityType,FieldLength,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,2295,0,1120164,1120235,39,'FileName',TO_TIMESTAMP('2016-02-04 13:55:27','YYYY-MM-DD HH24:MI:SS'),100,'LBRA',0,'Y','Y','Y','N','FileName',10,TO_TIMESTAMP('2016-02-04 13:55:27','YYYY-MM-DD HH24:MI:SS'),100)
;
...
UPDATE AD_Process_Para_Trl SET IsTranslated='Y',Name='Organização',Updated=TO_TIMESTAMP('2016-02-04 13:56:41','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=1120236 AND AD_Language='pt_BR'
;

-- 04/02/2016 13h56min49s BRST
UPDATE AD_Process_Para_Trl SET IsTranslated='Y',Name='Arquivo',Updated=TO_TIMESTAMP('2016-02-04 13:56:49','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=1120235 AND AD_Language='pt_BR'
;

-- 04/02/2016 13h57min19s BRST
INSERT INTO AD_Menu (AD_Client_ID,AD_Menu_ID,AD_Org_ID,AD_Process_ID,"action",Created,CreatedBy,EntityType,IsActive,IsCentrallyMaintained,IsReadOnly,IsSOTrx,IsSummary,Name,Updated,UpdatedBy) VALUES (0,1120246,0,1120164,'P',TO_TIMESTAMP('2016-02-04 13:57:18','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y','Y','N','N','N','Return RPS',TO_TIMESTAMP('2016-02-04 13:57:18','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- 04/02/2016 13h57min19s BRST
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo) SELECT t.AD_Client_ID, 0, 'Y', CURRENT_TIMESTAMP, 100, CURRENT_TIMESTAMP, 100,t.AD_Tree_ID, 1120246, 0, 999 FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=1120246)
;
