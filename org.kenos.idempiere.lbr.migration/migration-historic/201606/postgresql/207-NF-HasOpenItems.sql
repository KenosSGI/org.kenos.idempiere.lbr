...
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Table_ID,ColumnName,Created,CreatedBy,DefaultValue,Description,EntityType,FieldLength,Help,IsActive,IsAllowLogging,IsAlwaysUpdateable,IsAutocomplete,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,Version) VALUES (0,1128799,1000235,0,20,1000027,'lbr_HasOpenItems',TO_TIMESTAMP('2016-05-25 18:17:37','YYYY-MM-DD HH24:MI:SS'),100,'Y','Identifies if this Document Has Open Items','LBRA',1,'Identifies if this Document Has Open Items','Y','Y','N','N','N','N','N','Y','N','N','N','N','Y','Has Open Items',0,TO_TIMESTAMP('2016-05-25 18:17:37','YYYY-MM-DD HH24:MI:SS'),100,0)
;
...
ALTER TABLE LBR_NotaFiscal ADD COLUMN lbr_HasOpenItems CHAR(1) DEFAULT 'Y' CHECK (lbr_HasOpenItems IN ('Y','N')) NOT NULL
;

-- 25/05/2016 18h19min46s BRT
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,1128799,1125797,0,1000020,TO_TIMESTAMP('2016-05-25 18:19:46','YYYY-MM-DD HH24:MI:SS'),100,'Identifies if this Document Has Open Items',1,'LBRA','Identifies if this Document Has Open Items','Y','Y','Y','N','N','N','N','N','Has Open Items',TO_TIMESTAMP('2016-05-25 18:19:46','YYYY-MM-DD HH24:MI:SS'),100)
;
...
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_TIMESTAMP('2016-05-25 18:27:43','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1125797
;
