...
-- 17/12/2015 12h25min45s BRST
UPDATE AD_Process_Trl SET Description='Export all XML archives in range of dates',Help=NULL,Name='Export NF-e XML',IsTranslated='Y' WHERE AD_Language='en_US' AND AD_Process_ID=1120163
;

-- 17/12/2015 12h26min44s BRST
UPDATE AD_Process_Trl SET IsTranslated='Y',Name='Exportar XML da NF-e',Description='Exporta todos os arquivos XML dentro de um intervalo de datas',Updated=TO_TIMESTAMP('2015-12-17 12:26:44','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=1120163 AND AD_Language='pt_BR'
;

-- 17/12/2015 12h32min59s BRST
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,AD_Reference_Value_ID,AD_Val_Rule_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,197,0,1120163,1120219,18,170,1120092,'C_DocTypeTarget_ID',TO_TIMESTAMP('2015-12-17 12:32:58','YYYY-MM-DD HH24:MI:SS'),100,'Target document type for conversing documents','LBRA',0,'You can convert document types (e.g. from Offer to Order or Invoice).  The conversion is then reflected in the current type.  This processing is initiated by selecting the appropriate Document Action.	','Y','Y','Y','N','Target Document Type',10,TO_TIMESTAMP('2015-12-17 12:32:58','YYYY-MM-DD HH24:MI:SS'),100)
;
...
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,EntityType,FieldLength,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,50022,0,1120163,1120220,38,'File_Directory',TO_TIMESTAMP('2015-12-17 12:35:50','YYYY-MM-DD HH24:MI:SS'),100,'LBRA',0,'Y','Y','N','N','File Directory',20,TO_TIMESTAMP('2015-12-17 12:35:50','YYYY-MM-DD HH24:MI:SS'),100)
;
...
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,265,0,1120163,1120221,15,'DateDoc',TO_TIMESTAMP('2015-12-17 12:37:06','YYYY-MM-DD HH24:MI:SS'),100,'Date of the Document','LBRA',0,'The Document Date indicates the date the document was generated.  It may or may not be the same as the accounting date.	','Y','Y','Y','Y','Document Date',30,TO_TIMESTAMP('2015-12-17 12:37:06','YYYY-MM-DD HH24:MI:SS'),100)
;
...
INSERT INTO AD_Menu ("action",AD_Client_ID,AD_Menu_ID,AD_Org_ID,AD_Process_ID,Created,CreatedBy,EntityType,IsActive,IsCentrallyMaintained,IsReadOnly,IsSOTrx,IsSummary,Name,Updated,UpdatedBy) VALUES ('P',0,1120244,0,1120163,TO_TIMESTAMP('2015-12-17 12:40:18','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y','Y','N','N','N','Exportar XML',TO_TIMESTAMP('2015-12-17 12:40:18','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- 17/12/2015 12h40min19s BRST
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo) SELECT t.AD_Client_ID, 0, 'Y', CURRENT_TIMESTAMP, 100, CURRENT_TIMESTAMP, 100,t.AD_Tree_ID, 1120244, 0, 999 FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=1120244)
;
...
-- 17/12/2015 12h41min35s BRST
UPDATE AD_TreeNodeMM SET Parent_ID=1000023, SeqNo=14, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=1120244
;
...
INSERT INTO AD_Val_Rule (AD_Client_ID,AD_Org_ID,AD_Val_Rule_ID,Code,Created,CreatedBy,EntityType,IsActive,Name,Type,Updated,UpdatedBy) VALUES (0,0,1120122,'C_DocType.DocBaseType=''NFB''',TO_TIMESTAMP('2016-01-11 13:49:43','YYYY-MM-DD HH24:MI:SS'),100,'LBRA','Y','C_DocType NF - Export XML','S',TO_TIMESTAMP('2016-01-11 13:49:43','YYYY-MM-DD HH24:MI:SS'),100)
;

-- 11/01/2016 13h52min46s BRST
UPDATE AD_Process_Para SET AD_Val_Rule_ID=1120122,Updated=TO_TIMESTAMP('2016-01-11 13:52:46','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=1120219
;
...
UPDATE AD_Process_Para SET IsMandatory='N',Updated=TO_TIMESTAMP('2016-01-20 15:30:48','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=1120219
;

-- 20/01/2016 16h34min56s BRST
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,113,0,1120163,1120227,19,'AD_Org_ID',TO_TIMESTAMP('2016-01-20 16:34:54','YYYY-MM-DD HH24:MI:SS'),100,'Organizational entity within client','LBRA',0,'An organization is a unit of your client or legal entity - examples are store, department. You can share data between organizations.','Y','Y','N','N','AD_Org_ID',40,TO_TIMESTAMP('2016-01-20 16:34:54','YYYY-MM-DD HH24:MI:SS'),100)
;
...
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,187,0,1120163,1120228,30,'C_BPartner_ID',TO_TIMESTAMP('2016-01-20 16:36:08','YYYY-MM-DD HH24:MI:SS'),100,'Identifies a Business Partner','LBRA',0,'A Business Partner is anyone with whom you transact.  This can include Vendor, Customer, Employee or Salesperson','Y','Y','N','N','C_BPartner_ID',50,TO_TIMESTAMP('2016-01-20 16:36:08','YYYY-MM-DD HH24:MI:SS'),100)
;
...
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,1383,0,1120163,1120232,19,'C_BP_Group_ID',TO_TIMESTAMP('2016-01-20 17:23:29','YYYY-MM-DD HH24:MI:SS'),100,'Business Partner Group','LBRA',0,'The Business Partner Group provides a method of defining defaults to be used for individual Business Partners.','Y','Y','N','N','C_BP_Group_ID',60,TO_TIMESTAMP('2016-01-20 17:23:29','YYYY-MM-DD HH24:MI:SS'),100)
;
...
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,455,0,1120163,1120233,19,'M_Shipper_ID',TO_TIMESTAMP('2016-01-20 17:24:16','YYYY-MM-DD HH24:MI:SS'),100,'Method or manner of product delivery','LBRA',0,'The Shipper indicates the method of delivering product','Y','Y','N','N','M_Shipper_ID',70,TO_TIMESTAMP('2016-01-20 17:24:16','YYYY-MM-DD HH24:MI:SS'),100)
;
...
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,1000256,0,1120163,1120234,17,'lbr_IsOwnDocument',TO_TIMESTAMP('2016-01-20 17:26:49','YYYY-MM-DD HH24:MI:SS'),100,'Identifies this is an own document','LBRA',0,'Identifies this is an own document','Y','Y','N','N','lbr_IsOwnDocument',80,TO_TIMESTAMP('2016-01-20 17:26:49','YYYY-MM-DD HH24:MI:SS'),100)
;
