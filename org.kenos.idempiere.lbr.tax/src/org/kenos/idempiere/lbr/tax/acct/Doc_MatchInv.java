...
//		MMatchInv matchInv = (MMatchInv)getPO();
		...
		**/
		...
		if (m_matchInv.getReversal_ID() > 0 
				&& m_matchInv.getReversal_ID() < m_matchInv.getM_MatchInv_ID()) 
		{
...
//		if (log.isLoggable(Level.FINE)) log.fine("IPV=" + ipv + "; Balance=" + fact.getSourceBalance());
	 ...
	 * 	Get Commitments
	 *  <br>
	 * 	<br>Use --> {@link Doc_Order#getCommitments} <--
	 *  <br>
	 * 	@param doc document
	 ...
	 *  <br>
	 * 	<br>Use --> {@link Doc_Order#getCommitmentRelease} <--
	 *  <br>
