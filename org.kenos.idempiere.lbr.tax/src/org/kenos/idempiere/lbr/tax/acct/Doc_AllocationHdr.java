...
public class Doc_AllocationHdr extends Doc
{
	...
	public ArrayList<Fact> createFacts (MAcctSchema as)
	{
		...
		for (int i = 0; i < p_lines.length; i++)
		{
			...
			{
				//	Do not proceed with accounting
				I_W_C_DocType dt = POWrapper.create (new MDocType (getCtx(), invoice.getC_DocTypeTarget_ID(), null), I_W_C_DocType.class);
				if (!dt.islbr_HasOpenItems())
					return m_facts;
